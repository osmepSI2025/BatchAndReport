...
{
    public class E_ConReport_CTRModels
    {
        public int CTR_R317_60_ID { get; set; }
        ...
        public string? ConsultExpertise { get; set; }
        public string? ProjectReference { get; set; }
        public DateTime? ProjectStartDate { get; set; }
        public DateTime? ProjectEndDate { get; set; }
        public decimal? ContractTotalAmount { get; set; }
        public decimal? VatAmount { get; set; }
        public int? ContractInstallment { get; set; }
        public string? ContractRef { get; set; }
        public string? ContractBankName { get; set; }
        public string? ContractBankBranch { get; set; }
        public string? ContractBankAccountName { get; set; }
        ...
        public string? PrepaidBankName { get; set; }
        public decimal? PrepaidDeductPercent { get; set; }
        public string? SendWorkMethod { get; set; }
        public int? WorkAmount { get; set; }
        public string? RelateExpertise { get; set; }
        public int? FixDaysAfterNoti { get; set; }
        public int? NotiDaysAfterTerminate { get; set; }
        public string? TerminationReferene { get; set; }
        public string? ConsultScopeRef { get; set; }
