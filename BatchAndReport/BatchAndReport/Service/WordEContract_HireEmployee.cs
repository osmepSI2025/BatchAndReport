...
public class WordEContract_HireEmployee
{
    ...
    public WordEContract_HireEmployee(WordServiceSetting ws)
    {
        _w = ws;
    }
    #region   4.1.3.3. สัญญาจ้างลูกจ้าง
    public byte[] OnGetWordContact_HireEmployee()
    {
        ...
        using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("1.ผู้ว่าจ้างตกลงจ้างลูกจ้างปฏิบัติงานกับผู้ว่าจ้าง โดยให้ปฏิบัติงานภายใต้งาน....................................  ในตำแหน่ง ................................................................... ปฏิบัติหน้าที่ ณ ศูนย์กลุ่มจังหวัดให้บริการ SME ครบวงจร ......................................... " +
                "โดยมีรายละเอียดหน้าที่ความรับผิดชอบปรากฏตามเอกสารแนบท้ายสัญญาจ้าง ตั้งแต่วันที่ ................................ ถึงวันที่ .........................................", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("2.ผู้ว่าจ้างจะจ่ายค่าจ้างให้แก่ลูกจ้างในระหว่างระยะเวลาการปฏิบัติงานของลูกจ้างตามสัญญานี้ในอัตราเดือนละ .........................................บาท (.........................................)" +
            ...
            body.AppendChild(WordServiceSetting.CenteredParagraph("ลงชื่อ....................................................ผู้ว่าจ้าง                    ลงชื่อ ........................................................ลูกจ้าง"));
            body.AppendChild(WordServiceSetting.CenteredParagraph("(............................................................)                                 (.........................................................)"));
            body.AppendChild(WordServiceSetting.CenteredParagraph("ลงชื่อ....................................................ผู้ว่าจ้าง                    ลงชื่อ ........................................................ลูกจ้าง"));
            body.AppendChild(WordServiceSetting.CenteredParagraph("(............................................................)                                 (.........................................................)"));                // next page


            body.AppendChild(new Paragraph(new Run(new Break() { Type = BreakValues.Page })));
            body.AppendChild(WordServiceSetting.CenteredBoldParagraph("เอกสารแนบท้ายสัญญาจ้างลูกจ้าง", "38"));
            body.AppendChild(WordServiceSetting.CenteredBoldParagraph("งานศูนย์ให้บริการ SMEs ครบวงจร", "38"));
