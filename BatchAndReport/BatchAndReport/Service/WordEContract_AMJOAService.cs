...
<P class='t-16 tab4'>1) ลงทะเบียน SME ผู้รับบริการภาครัฐในระบบทะเบียน SME (หากไม่มีเลขทะเบียน SME ผู้รับบริการภาครัฐ) </P>
<P class='t-16 tab4'>2) จัดทำข้อมูลผู้ประกอบการให้สมบูรณ์ตามแบบฟอร์มที่ สสว. กำหนด</P>
 ...
 <P class='t-16 tab4'> - ข้อมูลผู้ประกอบการ โดยใส่รหัสประเภทมาตรฐานอุตสาหกรรม (ประเทศไทย) Thailand Standard Industrial Classification (TSIC) ให้ระบุเป็นจำนวน 5 หลัก  </P>
