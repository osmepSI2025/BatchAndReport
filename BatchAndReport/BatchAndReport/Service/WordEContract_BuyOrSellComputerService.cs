    ...
    public async Task<byte[]> OnGetWordContact_BuyOrSellComputerService_ToPDF(string id)
    {
        ...
        if (listDocAtt != null)
        {
            for (int i = 0; i < listDocAtt.Count; i++)
            {
                ...
                htmlDocAtt += $"<p class='tab3 t-16'> {docItem.DocumentTitle} จำนวน {docItem.PageAmount} หน้า </div>";
...
<div >
    ...
    <p class='tab2 t-16'><b>ข้อ1 คำนิยาม</b></p>
    <p class='tab3 t-16'>
...
</br>รวมเป็นราคาคอมพิวเตอร์และค่าติดตั้งทั้งสิ้น {result.TotalAmount} บาท ({CommonDAO.NumberToThaiText(result.TotalAmount ?? 0)})
    ...
    <p class='tab2 t-16'><b>ข้อ ๒ การรับรองคุณภาพ</b></p>
    <p class='tab3 t-16'>
    ...
    <p class='tab2 t-16'><b>ข้อ ๓ เอกสารอันเป็นส่วนหนึ่งของสัญญา</b></p>
    <p class='tab3 t-16'>
    ...
    <p class='tab2 t-16'><b>ข้อ ๔ การส่งมอบและติดตั้ง</b></p>
    <p class='tab3 t-16'>
    ...
    <p class='tab2 t-16'><b>ข้อ ๕ การตรวจรับ</b></p>
    <p class='tab3 t-16'>
 ...
 <p class='tab3 t-16'>(8) ในกรณีที่ผู้ขายส่งมอบคอมพิวเตอร์ถูกต้องแต่ไม่ครบจำนวน หรือส่งมอบครบจำนวนแต่ไม่ถูกต้องทั้งหมด 
   ...
   <!-- ข้อ ๖ การชำระเงิน -->
<p class='tab2 t-16'><b>ข้อ ๖ การชำระเงิน</b></p>
<p class='tab3 t-16'>
    (9) ผู้ซื้อจะชำระเงินค่าคอมพิวเตอร์ให้แก่ผู้ขาย เมื่อผู้ซื้อได้รับมอบคอมพิวเตอร์ตามข้อ ๕ ไว้โดยครบถ้วนแล้ว</p>
   <p class='tab3 t-16'>(10) ผู้ซื้อตกลงชำระเงินค่าคอมพิวเตอร์ให้แก่ผู้ขาย ดังนี้</p>
 <p class='tab3 t-16'>๖.๑ เงินล่วงหน้า จำนวน {result.AdvancePayment} บาท ({CommonDAO.NumberToThaiText(result.AdvancePayment ?? 0)}) 
...
และผู้ซื้อจะคืนหลักประกันการรับเงินล่วงหน้าให้แก่ผู้ขาย เมื่อผู้ซื้อจ่ายเงินที่เหลือตามข้อ ๖.๒ แล้ว เว้นแต่ในกรณีดังต่อไปนี้ ผู้ขายมีสิทธิขอคืนหลักประกันการรับเงินล่วงหน้าบางส่วนก่อนได้</p>
  <p class='tab3 t-16'>(๑) กรณีผู้ขายได้วางหลักประกันการรับเงินล่วงหน้าไว้ฉบับเดียว หากผู้ซื้อได้หักเงินล่วงหน้าไปแล้ว 
...
โดยผู้ขายจะต้องนำหลักประกันการรับเงินล่วงหน้าฉบับใหม่ที่มีมูลค่าเท่ากับเงินล่วงหน้าที่เหลืออยู่มาวางให้แก่ผู้ซื้อ</p>
  <p class='tab3 t-16'>(๒) กรณีผู้ขายได้วางหลักประกันการรับเงินล่วงหน้าไว้หลายฉบับ ซึ่งแต่ละฉบับมีมูลค่าเท่ากับจำนวนเงินล่วงหน้าที่ผู้ซื้อจะต้องหักไว้ในแต่ละงวด
หากผู้ซื้อได้หักเงินล่วงหน้าในงวดใดแล้วผู้ขายมีสิทธิขอคืนหลักประกันการรับเงินล่วงหน้าในงวดนั้นได้</p>
  <p class='tab3 t-16'>๖.๒ เงินที่เหลือ จำนวน {result.RemainingPaymentAmount} บาท ({CommonDAO.NumberToThaiText(result.RemainingPaymentAmount ?? 0)}) 
จะจ่ายให้เมื่อผู้ซื้อได้รับคอมพิวเตอร์ตามข้อ ๕ ไว้โดยถูกต้องครบถ้วน และผู้ขายได้อบรมเจ้าหน้าที่ของผู้ซื้อตามข้อ ๑๐ เสร็จสิ้นแล้ว</p>
  <p class='tab3 t-16'>(11) การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้ซื้อจะโอนเงินเข้าบัญชีเงินฝากธนาคารของผู้ขาย ชื่อธนาคาร {result.SaleBankName} สาขา {result.SaleBankBranch} 
ชื่อบัญชี {result.SaleBankAccountName} เลขที่บัญชี {result.SaleBankAccountNumber} ทั้งนี้ ผู้ขายตกลงเป็นผู้รับภาระเงินค่าธรรมเนียม หรือค่าบริการอื่นใดเกี่ยวกับการโอน 
...
<p class='tab2 t-16'><b>ข้อ ๗ การรับประกันความชำรุดบกพร่อง</b></p>
<p class='tab3 t-16'>
...
ในช่วงเวลาที่ไม่สามารถใช้คอมพิวเตอร์ได้ในส่วนที่เกินกว่ากำหนดเวลาขัดข้องข้างต้น</p>
   <p class='tab3 t-16'> เกณฑ์การคำนวณเวลาขัดข้องของคอมพิวเตอร์ตามวรรคสอง ให้เป็นดังนี้</p>
   ...
   <p class='tab3 t-16'> - กรณีความเสียหายอันสืบเนื่องมาจากความขัดข้องของคอมพิวเตอร์แตกต่างกัน เวลาที่ใช้ในการคำนวณค่าปรับจะเท่ากับเวลาขัดข้องของคอมพิวเตอร์หน่วยนั้นคูณด้วยตัวถ่วงซึ่งมีค่าต่างๆ ตามเอกสารแนบท้ายสัญญาผนวก ๔</p>
   <p class='tab3 t-16'> การที่ผู้ซื้อทำการนั้นเอง หรือให้ผู้อื่นทำการนั้นแทนผู้ขาย ไม่ทำให้ผู้ขายหลุดพ้นจาก ความรับผิดตามสัญญา หากผู้ขายไม่ชดใช้ค่าใช้จ่ายหรือค่าเสียหายตามที่ผู้ซื้อเรียกร้องผู้ซื้อมีสิทธิบังคับจากหลักประกันการปฏิบัติตามสัญญาได้
</p>
...
<p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'>(16) กรณีผู้ขายใช้หนังสือค้ำประกันมาเป็นหลักประกันการปฏิบัติตามสัญญา หนังสือค้ำประกันดังกล่าวจะต้องออกโดยธนาคารที่ประกอบกิจการในประเทศไทย
หรือโดยบริษัทเงินทุนหรือบริษัทเงินทุนหลักทรัพย์ที่ได้รับอนุญาตให้ประกอบกิจการเงินทุนเพื่อการพาณิชย์และประกอบธุรกิจค้ำประกันตามประกาศของธนาคารแห่งประเทศไทย
ตามรายชื่อบริษัทเงินทุนที่ธนาคารแห่งประเทศไทยแจ้งเวียนให้ทราบตามแบบที่คณะกรรมการนโยบายการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐกำหนด
หรืออาจเป็นหนังสือค้ำประกันอิเล็กทรอนิกส์ตามวิธีการที่กรมบัญชีกลางกำหนดก็ได้และจะต้องมีอายุการค้ำประกันตลอดไปจนกว่าผู้ขายพ้นข้อผูกพันตามสัญญานี้</p>
   <p class='tab3 t-16'> หลักประกันที่ผู้ขายนำมามอบให้ตามวรรคหนึ่ง จะต้องมีอายุครอบคลุมความรับผิดทั้งปวงของผู้ขายตลอดอายุสัญญา
ถ้าหลักประกันที่ผู้ขายนำมามอบให้ดังกล่าวลดลงหรือเสื่อมค่าลง หรือมีอายุไม่ครอบคลุมถึงความรับผิดของผู้ขายตลอดอายุสัญญา </p>
 <p class='tab3 t-16'> ม่ว่าด้วยเหตุใดๆ ก็ตาม รวมถึงกรณีผู้ขายส่งมอบและติดตั้งคอมพิวเตอร์ล่าช้าเป็นเหตุให้ระยะเวลาแล้วเสร็จหรือวันครบกำหนดความรับผิดในความชำรุดบกพร่องตามสัญญาเปลี่ยนแปลงไป 
...
<p class='tab3 t-16'>หลักประกันที่ผู้ขายนำมามอบไว้ตามข้อนี้ ผู้ซื้อจะคืนให้แก่ผู้ขายโดยไม่มีดอกเบี้ยเมื่อผู้ขายพ้นจากข้อผูกพันและความรับผิดทั้งปวงตามสัญญานี้แล้ว
</p>

<!-- ข้อ ๙ การโอนกรรมสิทธิ์ -->
<p class='tab2 t-16'><b>ข้อ ๙ การโอนกรรมสิทธิ์</b></p>
<p class='tab3 t-16'>
    คู่สัญญาตกลงกันว่ากรรมสิทธิ์ในคอมพิวเตอร์ตามสัญญาจะโอนไปยังผู้ซื้อเมื่อผู้ซื้อได้รับมอบคอมพิวเตอร์ดังกล่าวตามข้อ ๕ แล้ว
</p>

<!-- ข้อ ๑๐ การอบรม -->
<p class='tab2 t-16'><b>ข้อ ๑๐ การอบรม</b></p>
<p class='tab3 t-16'>
...
<p class='tab2 t-16'><b>ข้อ ๑๑ คู่มือการใช้คอมพิวเตอร์</b></p>
<p class='tab3 t-16'>
...
<p class='tab2 t-16'><b>ข้อ ๑๒ การรับประกันความเสียหาย</b></p>
<p class='tab3 t-16'>
...
<p class='tab2 t-16'><b>ข้อ ๑๓ การบอกเลิกสัญญา</b></p>
<p class='tab3 t-16'>
...
ผู้ซื้อมีสิทธิบอกเลิกสัญญาทั้งหมดหรือแต่บางส่วนได้ การใช้สิทธิบอกเลิกสัญญานั้นไม่กระทบถึงสิทธิของผู้ซื้อที่จะเรียกร้องค่าเสียหายจากผู้ขาย</p>
 <p class='tab3 t-16'>   ในกรณีที่ผู้ซื้อใช้สิทธิบอกเลิกสัญญา ผู้ซื้อมีสิทธิริบหรือบังคับจากหลักประกันตาม (17) (ข้อ ๖ และ) ข้อ ๘ เป็นจำนวนเงินทั้งหมดหรือแต่บางส่วนก็ได้ แล้วแต่ผู้ซื้อจะเห็นสมควร 
...
นับถัดจากวันบอกเลิกสัญญา ผู้ขายจะต้องชดใช้ราคาที่เพิ่มขึ้นจากราคาที่กำหนดไว้ในสัญญานี้ด้วย รวมทั้งค่าใช้จ่ายใด ๆ ที่ผู้ซื้อต้องใช้จ่ายในการจัดหาผู้ขายรายใหม่ดังกล่าวด้วย</p>
 ...
 <p class='tab3 t-16'> ในกรณีที่ผู้ขายได้ส่งมอบคอมพิวเตอร์ให้แก่ผู้ซื้อและผู้ซื้อบอกเลิกสัญญา ผู้ขายจะต้องนำคอมพิวเตอร์กลับคืนไป และทำสถานที่ที่รื้อถอนคอมพิวเตอร์ออกไปให้มีสภาพดังที่มีอยู่เดิมก่อนทำสัญญานี้ภายใน {result.ReturnDaysIn} วัน 
นับถัดจากวันที่ผู้ซื้อบอกเลิกสัญญา โดยผู้ขายเป็นผู้เสียค่าใช้จ่ายเองทั้งสิ้น</p>
    
 <p class='tab3 t-16'> (19)ถ้าผู้ขายไม่ยอมนำคอมพิวเตอร์กลับคืนไปภายในกำหนดเวลาดังกล่าวตามวรรคสาม ผู้ซื้อจะกำหนดเวลาให้ผู้ขายนำคอมพิวเตอร์กลับคืนไปอีกครั้งหนึ่ง 
...
เงินที่เหลือจากการหักค่าปรับ ค่าใช้จ่าย และค่าเสียหายดังกล่าวแล้วผู้ซื้อจะคืนให้แก่ผู้ขาย</p>
    <p class='tab3 t-16'>  เมื่อผู้ซื้อบอกเลิกสัญญาแล้ว ผู้ซื้อไม่ต้องรับผิดชอบในความเสียหายใด ๆ ทั้งสิ้นอันเกิดแก่คอมพิวเตอร์ซึ่งอยู่ในความครอบครองของผู้ซื้อ
</p>

<!-- ข้อ ๑๔ ค่าปรับ -->
<p class='tab2 t-16'><b>ข้อ ๑๔ ค่าปรับ</b></p>
<p class='tab3 t-16'>
...
นับถัดจากวันครบกำหนดตามสัญญาจนถึงวันที่ผู้ขายได้นำคอมพิวเตอร์มาส่งมอบและติดตั้งให้แก่ผู้ซื้อจนถูกต้องครบถ้วนตามสัญญา</p>
  <p class='tab3 t-16'>  การคิดค่าปรับในกรณีที่คอมพิวเตอร์ที่ตกลงซื้อขายเป็นระบบ ถ้าผู้ขายส่งมอบเพียงบางส่วนหรือขาดส่วนประกอบส่วนหนึ่งส่วนใดไป 
หรือส่งมอบและติดตั้งทั้งหมดแล้วแต่ใช้งานไม่ได้ถูกต้องครบถ้วน ให้ถือว่ายังไม่ได้ส่งมอบคอมพิวเตอร์นั้นเลย และคิดค่าปรับจากราคาคอมพิวเตอร์ทั้งระบบ</p>
    <p class='tab3 t-16'> ในระหว่างที่ผู้ซื้อยังไม่ได้ใช้สิทธิบอกเลิกสัญญานั้น หากผู้ซื้อเห็นว่าผู้ขายไม่อาจปฏิบัติตามสัญญาต่อไปได้ ผู้ซื้อจะใช้สิทธิบอกเลิกสัญญา 
...
<p class='tab2 t-16'><b>ข้อ ๑๕ การบังคับค่าปรับ ค่าเสียหาย และค่าใช้จ่าย</b></p>
<p class='tab3 t-16'>
...
หากผู้ขายไม่ชดใช้ให้ถูกต้องครบถ้วนภายในระยะเวลาดังกล่าวให้ผู้ซื้อมีสิทธิที่จะหักเอาจากค่าคอมพิวเตอร์ที่ต้องชำระ หรือบังคับจากหลักประกันการปฏิบัติตามสัญญาได้ทันที<p/>
     <p class='tab3 t-16'> หากค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายที่บังคับจากค่าคอมพิวเตอร์ที่ต้องชำระหรือหลักประกันการปฏิบัติตามสัญญาแล้วยังไม่เพียงพอ 
ผู้ขายยินยอมชำระส่วนที่เหลือที่ยังขาดอยู่จนครบถ้วนตามจำนวนค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายนั้น ภายในกำหนด {result.OutstandingPeriodDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้ซื้อ<p/>
     <p class='tab3 t-16'> หากมีเงินค่าคอมพิวเตอร์ที่ซื้อขายตามสัญญาที่หักไว้จ่ายเป็นค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายแล้วยังเหลืออยู่อีกเท่าใด ผู้ซื้อจะคืนให้แก่ผู้ขายทั้งหมด
</p>

<!-- ข้อ ๑๖ การงดหรือลดค่าปรับ หรือขยายเวลาในการปฏิบัติตามสัญญา -->
<p class='tab2 t-16'><b>ข้อ ๑๖ การงดหรือลดค่าปรับ หรือขยายเวลาในการปฏิบัติตามสัญญา</b></p>
<p class='tab3 t-16'>
...
นับถัดจากวันที่เหตุนั้นสิ้นสุดลง หรือตามที่กำหนดในกฎกระทรวงดังกล่าว<p/>
    <p class='tab3 t-16'>ถ้าผู้ขายไม่ปฏิบัติให้เป็นไปตามความในวรรคหนึ่ง ให้ถือว่าผู้ขายได้สละสิทธิเรียกร้องในการที่จะของดหรือลดค่าปรับหรือขยายเวลาทำการตามสัญญา 
โดยไม่มีเงื่อนไขใด ๆ ทั้งสิ้น เว้นแต่กรณีเหตุเกิดจากความผิดหรือความบกพร่องของฝ่ายผู้ซื้อซึ่งมีหลักฐานชัดแจ้งหรือผู้ซื้อทราบดีอยู่แล้วตั้งแต่ต้น<p/>
   <p class='tab3 t-16'> การงดหรือลดค่าปรับหรือขยายเวลาทำการตามสัญญาตามวรรคหนึ่ง อยู่ในดุลพินิจของผู้ซื้อที่จะพิจารณาตามที่เห็นสมควร
</p>

<!-- ข้อ ๑๗ การใช้เรือไทย -->
<p class='tab2 t-16'><b>ข้อ ๑๗ การใช้เรือไทย</b></p>
<p class='tab3 t-16'>
...
เว้นแต่จะได้รับอนุญาตจากกรมเจ้าท่าก่อนบรรทุกคอมพิวเตอร์ลงเรืออื่นที่มิใช่เรือไทยหรือเป็นของที่รัฐมนตรีว่าการกระทรวงคมนาคมประกาศยกเว้นให้บรรทุกโดยเรืออื่นได้ ทั้งนี้ ไม่ว่าการสั่งหรือนำเข้าคอมพิวเตอร์จากต่างประเทศจะเป็นแบบใด<p/>
    <p class='tab3 t-16'>ในการส่งมอบคอมพิวเตอร์ให้แก่ผู้ซื้อ ถ้าเป็นกรณีตามวรรคหนึ่งผู้ขายจะต้องส่งมอบใบตราส่ง (Bill of Lading) หรือสำเนาใบตราส่งสำหรับคอมพิวเตอร์นั้น
ซึ่งแสดงว่าได้บรรทุกมาโดยเรือไทย หรือเรือที่มีสิทธิเช่นเดียวกับเรือไทยให้แก่ผู้ซื้อพร้อมกับการส่งมอบคอมพิวเตอร์ด้วย<p/>
    <p class='tab3 t-16'>ในกรณีที่คอมพิวเตอร์ไม่ได้บรรทุกจากต่างประเทศมายังประเทศไทยโดยเรือไทยหรือเรือที่มีสิทธิเช่นเดียวกับเรือไทย 
...
ไทยตามกฎหมายว่าด้วยการส่งเสริมการพาณิชยนาวีแล้วอย่างใดอย่างหนึ่งแก่ผู้ซื้อด้วย<p/>
    <p class='tab3 t-16'>ในกรณีที่ผู้ขายไม่ส่งมอบหลักฐานอย่างใดอย่างหนึ่งดังกล่าวในวรรคสองและวรรคสามให้แก่ผู้ซื้อแต่จะขอส่งมอบคอมพิวเตอร์ให้ผู้ซื้อก่อนโดยยังไม่รับชำระเงินค่าคอมพิวเตอร์
ผู้ซื้อมีสิทธิรับคอมพิวเตอร์ไว้ก่อนและชำระเงินค่าคอมพิวเตอร์เมื่อผู้ขายได้ปฏิบัติถูกต้องครบถ้วนดังกล่าวแล้วได้<p/>
    <p class='tab3 t-16'>สัญญานี้ทำขึ้นสองฉบับ มีข้อความถูกต้องตรงกัน คู่สัญญาได้อ่านและเข้าใจข้อความโดยละเอียดตลอดแล้ว จึงได้ลงลายมือชื่อพร้อมทั้งประทับตรา (ถ้ามี) ไว้เป็นสำคัญต่อหน้าพยานและคู่สัญญาต่างยึดถือไว้ฝ่ายละหนึ่งฉบับ
</p>
</br>
</br>
<!-- 🔹 รายชื่อผู้ลงนาม -->
