    ...
    public byte[] OnGetWordContact_BuyOrSellComputerService()
    {
        ...
        using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้ขายจะต้องแจ้งกำหนดเวลาติดตั้งแล้วเสร็จพร้อมที่จะใช้งานและส่งมอบคอมพิวเตอร์ได้" +
                "โดยทำเป็นหนังสือยื่นต่อผู้ซื้อ ณ ……..…………………………………...…………………………ในวันและเวลาทำการของผู้ซื้อก่อนวันกำหนดส่งมอบไม่น้อยกว่า………..……(…...…....….) วันทำการของผู้ซื้อ", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้ขายมีหน้าที่บำรุงรักษาและซ่อมแซมแก้ไขคอมพิวเตอร์ให้อยู่ในสภาพใช้งานได้ดีอยู่เสมอตลอดระยะเวลาดังกล่าวในวรรคหนึ่งด้วยค่าใช้จ่ายของผู้ขาย โดยให้มีเวลาคอมพิวเตอร์ขัดข้องรวมตามเกณฑ์การคำนวณเวลาขัดข้องไม่เกินเดือนละ………….....…(….…....……...) ชั่วโมง หรือร้อยละ……….……..(………………….) ของเวลาใช้งานทั้งหมดของคอมพิวเตอร์ของเดือนนั้น แล้วแต่ตัวเลขใดจะมากกว่ากัน มิฉะนั้นผู้ขายต้องยอมให้ผู้ซื้อคิดค่าปรับเป็นรายชั่วโมง ในอัตราร้อยละ..............(13)............. (..............................) ของราคาคอมพิวเตอร์ทั้งหมดตามสัญญานี้คิดเป็นเงิน..............บาท (....................) ต่อชั่วโมง ในช่วงเวลาที่ไม่สามารถใช้คอมพิวเตอร์ได้ในส่วนที่เกินกว่ากำหนดเวลาขัดข้องข้างต้น", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ในขณะทำสัญญานี้ผู้ขายได้นำหลักประกันเป็น……….….…... (14).………...................เป็นจำนวนเงิน……………….…….บาท (…………………..…...…....…....) ซึ่งเท่ากับร้อยละ………..….…(15)……...…...(…………………….…….……...........) ของราคาซื้อขายคอมพิวเตอร์ตามข้อ ๑ มามอบให้แก่ผู้ซื้อเพื่อเป็นหลักประกันการปฏิบัติตามสัญญานี้", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ในกรณีที่ผู้ซื้อใช้สิทธิบอกเลิกสัญญา ผู้ซื้อมีสิทธิริบหรือบังคับจากหลักประกันตาม (17) (ข้อ ๖ และ) ข้อ ๘ เป็นจำนวนเงินทั้งหมดหรือแต่บางส่วนก็ได้ แล้วแต่ผู้ซื้อจะเห็นสมควร และถ้าผู้ซื้อจัดซื้อคอมพิวเตอร์รวมถึงการติดตั้งจากบุคคลอื่นเต็มจำนวนหรือเฉพาะจำนวนที่ขาดส่ง แล้วแต่กรณี ภายในกำหนด……... (18) .....…(………....……....) เดือน นับถัดจากวันบอกเลิกสัญญา ผู้ขายจะต้องชดใช้ราคาที่เพิ่มขึ้นจากราคาที่กำหนดไว้ในสัญญานี้ด้วย รวมทั้งค่าใช้จ่ายใด ๆ ที่ผู้ซื้อต้องใช้จ่ายในการจัดหาผู้ขายรายใหม่ดังกล่าวด้วย ในกรณีที่ผู้ขายได้ส่งมอบคอมพิวเตอร์ให้แก่ผู้ซื้อและผู้ซื้อบอกเลิกสัญญา ผู้ขายจะต้องนำคอมพิวเตอร์กลับคืนไป และทำสถานที่ที่รื้อถอนคอมพิวเตอร์ออกไปให้มีสภาพดังที่มีอยู่เดิมก่อนทำสัญญานี้ภายใน…….…....(……………..….….) วัน นับถัดจากวันที่ผู้ซื้อบอกเลิกสัญญา โดยผู้ขายเป็นผู้เสียค่าใช้จ่ายเองทั้งสิ้น", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("(19) ถ้าผู้ขายไม่ยอมนำคอมพิวเตอร์กลับคืนไปภายในกำหนดเวลาดังกล่าวตามวรรคสาม ผู้ซื้อจะกำหนดเวลาให้ผู้ขายนำคอมพิวเตอร์กลับคืนไปอีกครั้งหนึ่ง หากพ้นกำหนดเวลาดังกล่าวแล้ว ผู้ขายยังไม่นำคอมพิวเตอร์กลับคืนไปอีก ผู้ซื้อมีสิทธินำคอมพิวเตอร์ออกขายทอดตลาด เงินที่ได้จากการขายทอดตลาด ผู้ขายยอมให้ผู้ซื้อหักเป็นค่าปรับและหักเป็นค่าใช้จ่ายและค่าเสียหายที่เกิดแก่ผู้ซื้อ ซึ่งรวมถึงค่าใช้จ่ายต่างๆ ที่ผู้ซื้อได้เสียไปในการดำเนินการขายทอดตลาดคอมพิวเตอร์ดังกล่าว ค่าใช้จ่ายในการทำสถานที่ที่รื้อถอนคอมพิวเตอร์ออกไปให้มีสภาพดังที่มีอยู่เดิมก่อนทำสัญญานี้ เงินที่เหลือจากการหักค่าปรับ ค่าใช้จ่าย และค่าเสียหายดังกล่าวแล้วผู้ซื้อจะคืนให้แก่ผู้ขาย ", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ในกรณีที่ผู้ซื้อยังไม่ใช้สิทธิบอกเลิกสัญญาตามข้อ ๑๓ ผู้ขายจะต้องชำระค่าปรับให้ผู้ซื้อเป็นรายวัน ในอัตราร้อยละ..….…(20)...…....(…..………..……) ของราคาคอมพิวเตอร์ที่ยังไม่ได้รับมอบ นับถัดจากวันครบกำหนดตามสัญญาจนถึงวันที่ผู้ขายได้นำคอมพิวเตอร์มาส่งมอบและติดตั้งให้แก่ผู้ซื้อจนถูกต้องครบถ้วนตามสัญญา", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ในกรณีที่ผู้ขายไม่ปฏิบัติตามสัญญาข้อใดข้อหนึ่งด้วยเหตุใด ๆ ก็ตาม จนเป็นเหตุให้เกิดค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายแก่ผู้ซื้อ ผู้ขายต้องชดใช้ค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายดังกล่าวให้แก่ผู้ซื้อ   โดยสิ้นเชิงภายในกำหนด....................(.......................) วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้ซื้อ หากผู้ขายไม่ชดใช้ให้ถูกต้องครบถ้วนภายในระยะเวลาดังกล่าวให้ผู้ซื้อมีสิทธิที่จะหักเอาจากค่าคอมพิวเตอร์ที่ต้องชำระ    หรือบังคับจากหลักประกันการปฏิบัติตามสัญญาได้ทันที", null, "32"));
