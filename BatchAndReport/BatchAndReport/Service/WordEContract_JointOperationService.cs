...
{(purposeList != null && purposeList.Count != 0
    ? $"<div class='t-14 tab2'>{string.Join("<br/>", purposeList.Select(p => p.Detail))}</div>"
    : "")}    
...
<P class='t-14 tab3'><B>ข้อ 1 ขอบเขตหน้าที่ของ “สสว.”</B></P>
    ...
    <P class='t-14 tab3'>สัญญาฉบับนี้ทำขึ้นเป็นสองฉบับ มีข้อความถูกต้องตรงกัน ทั้งสองฝ่ายได้อ่านและเข้าใจข้อ ความโดยละเอียดแล้ว จึงได้ลงลายมือชื่อพร้อมประทับตรา (ถ้ามี) ไว้เป็นสำคัญต่อหน้าพยานและยึดถือ ไว้ฝ่ายละฉบับ</P>
