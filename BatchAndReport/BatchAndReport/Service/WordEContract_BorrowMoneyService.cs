    ...
    public byte[] OnGetWordContact_orrowMoney()
    {
        ...
        using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("4.2 การชำระเงินตามข้อ 4.1  ผู้กู้ตกลงจะนำเงินเข้าบัญชีเงินฝากของผู้กู้ที่เปิดบัญชีไว้กับธนาคารกรุงไทย จำกัด (มหาชน) ตาม" +
             ...
             " เมื่อผู้ให้กู้ได้รับชำระเงินกู้คืนในแต่ละงวดแล้วจะออกใบเสร็จรับเงินให้แก่ผู้กู้ไว้เป็นหลักฐานต่อไป โดยผู้กู้ตกลงยินยอมให้หักเงินค่าธรรมเนียมในการโอนเงินชำระหนี้เงินกู้หรือค่าธรรมเนียมใด ๆ" +
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("5.2 เมื่อผู้กู้ผิดสัญญาแล้วแม้ข้อหนึ่งข้อใด หรือผู้กู้ไม่ชำระหนี้ให้ถูกต้องครบถ้วนตามที่กำหนดในสัญญานี้ไม่ว่าข้อหนึ่งข้อใด หรือผิดนัดชำระหนี้งวดใด ๆให้ถือว่าเป็นการผิดนัดทั้งหมด บรรดาหนี้สินทั้งหลายที่ยังต้องชำระอยู่ตามสัญญานี้ ไม่ว่าจะถึงกำหนดชำระแล้วหรือไม่ ให้ถือว่าเป็นอันถึงกำหนดชำระทั้งหมดทันที ผู้กู้ยินยอมให้ผู้ให้กู้คิดดอกเบี้ยจากเงินต้นที่ค้างชำระในอัตราร้อยละ 15.00 ต่อปี นับตั้งแต่วันที่ผู้กู้ตกเป็นผู้ผิดนัดตามสัญญานี้ จนกว่าจะชำระหนี้ทั้งหมดเสร็จสิ้น  พร้อมด้วยค่าเสียหายและค่าใช้จ่ายทั้งหลายอันเนื่องจากการผิดนัดชำระหนี้ของผู้กู้ รวมทั้งค่าใช้จ่ายในการเตือน เรียกร้อง ทวงถาม ดำเนินคดีและการบังคับชำระหนี้จนเต็มจำนวน"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("ข้าพเจ้า………………………………………………………………………………………………………………………………………….ขอรับรองว่าสถานภาพการสมรสของข้าพเจ้าปัจจุบันมีสถานะ"));
