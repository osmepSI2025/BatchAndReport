    ...
    <div class='sign-single-right'>
        ...
        <div class='t-16 text-center tab1'>{signer?.BU_UNIT}</div>
                ...
                if (installmentList != null && installmentList.ToList().Count > 0)
                {
                    foreach (var item in installmentList)
                    {
                        htmlInstallments += $"<p class='tab3 t-14'>งวดที่ {item.PayRound} เป็นเงิน  {item.TotalAmount} บาท จะจ่ายเมื่อผู้รับจ้างได้ดำเนินการบำรุงรักษาและซ่อมแซมแก้ไขคอมพิวเตอร์เป็นเวลา {item.RepairMonth} เดือน และผู้ว่าจ้างได้ตรวจรับมอบงานตามสัญญาแล้ว</div>";
                    }
                }
...
<div class='contract'>
    ...
    <div class='tab2 t-14 text-right'>สัญญาเลขที่…{result.Contract_Number ?? "xxxxx"}.</div>
    <p class='tab2 t-14'>
...
</br>ฝ่ายหนึ่ง กับ {result.ContractorName}
    </p>
    {(result.ContractorType == "นิติบุคคล"
            ...
            โดย {result.ContractorSignatoryName}
            มีอำนาจลงนามผูกพันนิติบุคคลปรากฏตามหนังสือรับรองของสำนักงานทะเบียนหุ้นส่วนบริษัท ……………
            ลงวันที่ {datestring} (5)(และหนังสือมอบอำนาจลง {datestring}) แนบท้าย
</br>สัญญานี้
        </p>"
                    : $@"<p class='tab2 t-14'>
    ...
    <p class='tab2 t-14'><b>ข้อ ๑ ขอบเขตของงาน</b></p>
   <p class='tab3 t-14'>ผู้ว่าจ้างตกลงจ้างและผู้รับจ้างตกลงรับจ้างให้บริการบำรุงรักษาและซ่อมแซมแก้ไข
   ...
   <p class='tab3 t-14'>ผู้รับจ้างจะจัดหาวัสดุสิ่งของชนิดที่ดีได้มาตรฐาน ใช้เครื่องมือดี และช่างผู้ชำนาญและฝีมือดี
</br>เพื่อใช้ในงานจ้างที่จำเป็นสำหรับการปฏิบัติงานตามสัญญา</p>
    <p class='tab2 t-14'><b>ข้อ ๒ เอกสารอันเป็นส่วนหนึ่งของสัญญา</b></p>
   <p class='tab3 t-14'>เอกสารแนบท้ายสัญญาดังต่อไปนี้ให้ถือว่าเป็นส่วนหนึ่งของสัญญานี้</p>
{htmlDocAtt}
   <p class='tab3 t-14'>และอัตราค่าบำรุงรักษา</p>
...
</br>ผู้ว่าจ้าง คำวินิจฉัยของผู้ว่าจ้างให้ถือเป็นที่สุด และผู้รับจ้างไม่มีสิทธิเรียกร้องค่าจ้าง ค่าเสียหาย หรือค่าใช้จ่าย
</br>ใดๆ เพิ่มเติมจากผู้ว่าจ้างทั้งสิ้น</p>
    <p class='tab2 t-14'><b>ข้อ ๓ ระยะเวลาให้บริการ</b></p>
   <p class='tab3 t-14'>ผู้รับจ้างตกลงให้บริการตามสัญญานี้ ตั้งแต่วันที่ {strServiceStartDate} ถึง {strServiceEndDate} รวมเป็นเวลาทั้งสิ้น {result.ServiceTotalYears} ปี {result.ServiceTotalMonths} เดือน {result.ServiceTotalDays} วัน</p>
    <p class='tab2 t-14'><b>ข้อ ๔ ค่าจ้างและการจ่ายเงิน</b></p>
   <p class='tab3 t-14'>ผู้ว่าจ้างตกลงชำระค่าจ้างบริการบำรุงรักษาและซ่อมแซมแก้ไขคอมพิวเตอร์เป็นเงินทั้งสิ้น {result.ServiceFee?.ToString("N2") ?? "0.00"}
 บาท ({strServiceFee}) ซึ่งได้รวมภาษีมูลค่าเพิ่มจำนวน {result.VatAmount?.ToString("N2") ?? "0.00"}
 บาท ({strVatAmount}) ตลอดจนค่าแรงงานค่าสิ่งของตลอดอายุสัญญา 
</br>ภาษีอากรอื่น และค่าใช้จ่ายทั้งปวงไว้ด้วยแล้ว โดยผู้ว่าจ้างจะแบ่งจ่ายให้แก่ผู้รับจ้างเป็นงวดๆ รวม {result.PaymentInstallment} งวด ดังนี้</p>
    {htmlInstallments}
<!-- ข้อ 5 การรับประกันผลงาน -->
<p class='tab2 t-14'><b>ข้อ ๕ การรับประกันผลงาน</b></p>
<p class='tab3 t-14'>
...
</br>มิฉะนั้นผู้รับจ้างต้องยอมให้ผู้ว่าจ้างคิดค่าปรับเป็นรายชั่วโมง ในอัตราชั่วโมงละ {result.PenaltyPerHours?.ToString("N2") ?? "0.00"}
 บาท 
</br>({strPenaltyPerHours}) ในช่วงเวลาที่ไม่สามารถใช้คอมพิวเตอร์ได้ในส่วนที่เกินกว่ากำหนดเวลา
</br>ขัดข้องข้างต้น
</p>
<p class='tab3 t-14'>เกณฑ์การคำนวณเวลาขัดข้องของคอมพิวเตอร์ตามวรรคหนึ่งให้เป็นไปดังนี้</p>
<p class='tab3 t-14'>- กรณีที่คอมพิวเตอร์เกิดขัดข้องพร้อมกันหลายหน่วย ให้นับเวลาขัดข้องของหน่วยที่มีตัวถ่วงมากที่สุดเพียงหน่วยเดียว</p>
<p class='tab3 t-14'>- กรณีความเสียหายอันสืบเนื่องมาจากความขัดข้องของคอมพิวเตอร์แตกต่างกัน เวลาที่ใช้ในการคำนวณค่าปรับจะเท่ากับเวลาขัดข้องของคอมพิวเตอร์หน่วยนั้นคูณด้วยตัวถ่วงซึ่งมีค่าต่างๆ ตามเอกสาร
</br>แนบท้ายสัญญาผนวก ๒</p>

<!-- ข้อ 6 การให้บริการ -->
<p class='tab2 t-14'><b>ข้อ ๖ การให้บริการ</b></p>
<p class='tab3 t-14'>
...
</br>ได้รับมอบหมายจากผู้รับจ้างทราบทางวาจา ทางโทรสาร หรือทางไปรษณีย์อิเล็กทรอนิกส์(e-mail) หรือทาง
</br>โทรศัพท์ ไม่ว่าวิธีใดวิธีหนึ่งให้ถือเป็นการแจ้งโดยชอบตามสัญญานี้แล้ว และผู้รับจ้างจะต้องซ่อมแซมแก้ไข 
</br>เปลี่ยนสิ่งที่จำเป็นให้เสร็จเรียบร้อยภายใน {result.ServiceTimeIn}({result.ServiceTimeUnit}) วัน/ชั่วโมง นับแต่เวลาที่ได้รับแจ้งจากผู้ว่าจ้าง
</br>ดังกล่าว
</p>
<p class='tab3 t-14'>
...
</br>ทั้งนี้ หากผู้รับจ้างไม่ดำเนินการดังกล่าว ผู้ว่าจ้างมีสิทธิจ้างบุคคลภายนอกทำการซ่อมแซมแก้ไข โดยผู้รับ
</br>จ้างจะต้องออกค่าใช้จ่ายในการจ้างบุคคลภายนอกซ่อมแซมแก้ไขแทนผู้ว่าจ้างทั้งสิ้น
</p>
<p class='tab3 t-14'>
    การจ้างบริการบำรุงรักษาและซ่อมแซมแก้ไขคอมพิวเตอร์ตามสัญญานี้ ไม่รวมถึงการเปลี่ยน
</br>แปลงลักษณะเฉพาะของคอมพิวเตอร์หรือส่วนประกอบที่ติดตั้งเพิ่มเติมภายหลังที่สัญญานี้มีผลบังคับและ
</br>ความเสียหายของคอมพิวเตอร์ซึ่งเกิดจากเหตุสุดวิสัยหรือเกิดจากความผิดของผู้ว่าจ้าง
</p>

<!-- ข้อ 7 ความรับผิดของผู้รับจ้าง -->
<p class='tab2 t-14'><b>ข้อ ๗ ความรับผิดของผู้รับจ้าง</b></p>
<p class='tab3 t-14'>
    ผู้รับจ้างจะต้องรับผิดต่อผู้ว่าจ้างในกรณีที่ผู้รับจ้าง ผู้แทน ช่าง หรือลูกจ้างของผู้รับจ้างจงใจ
</br>หรือประมาทเลินเล่อ หรือไม่มีความรู้ความชำนาญพอ กระทำหรืองดเว้นการกระทำใดๆ เป็นเหตุให้จัดหา
</br>คอมพิวเตอร์ของผู้ว่าจ้างเสียหายหรือไม่อยู่ในสภาพที่ใช้การได้ดี โดยไม่อาจแก้ไขได้ โดยผู้รับจ้างจะต้อง
</br>คอมพิวเตอร์ ที่มีคุณภาพ ประสิทธิภาพ และความสามารถในการใช้งานไม่ต่ำกว่าของเดิมชดใช้แทนหรือ 
</br>ชดใช้ราคาคอมพิวเตอร์ในขณะที่เกิดความเสียหายในกรณีที่ไม่อาจจัดหาคอมพิวเตอร์ดังกล่าวชดใช้แทนได้ 
...
</br>ของค่าจ้างตามสัญญานี้ซึ่งคิดเป็นเงิน {result.ContPenaltyPerDays} บาท ({strContPenalty}) ต่อวัน จน
</br>กว่าผู้ว่าจ้างบอกเลิกสัญญาตามสัญญาข้อ ๑๐ และหากผู้ว่าจ้างต้องใช้คอมพิวเตอร์ที่อื่นประมวลผลผู้รับจ้าง
</br>ยินยอมชดใช้ค่าใช้จ่ายเพื่อการดังกล่าวทั้งสิ้นแทนผู้ว่าจ้างอีกด้วย
</p>
<p class='tab3 t-14'>
...
<p class='tab3 t-14'>
    ในขณะทำสัญญานี้ ผู้รับจ้างได้นำหลักประกันเป็น {result.GuaranteeType} เป็นจำนวนเงิน {result.GuaranteeAmount?.ToString("N2") ?? "0.00"}
 บาท 
</br>({strGuaranteeAmount}) ซึ่งเท่ากับร้อยละ {result.GuaranteePercent} ของราคา
</p>
<p class='tab3 t-14'>
...
</br>ของผู้รับจ้างตลอดอายุสัญญา ถ้าหลักประกันที่ผู้รับจ้างนำมามอบให้ดังกล่าวลดลงหรือเสื่อมค่าลง หรือ 
</br>มีอายุไม่ครอบคลุมถึงความรับผิดของผู้รับจ้างตลอดอายุสัญญา ไม่ว่าด้วยเหตุใดๆ ก็ตาม ผู้รับจ้างจะต้อง
</br>หาหลักประกันมาเปลี่ยนให้ใหม่หรือหลักประกันเพิ่มเติมให้มีจำนวนครบถ้วนตามวรรคหนึ่งมามอบให้แก่
</br>ผู้ว่าจ้างภายใน {result.EnforcementOfFineDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้ว่าจ้าง
...
<!-- ข้อ 9 การจ้างช่วง -->
<p class='tab2 t-14'><b>ข้อ ๙ การจ้างช่วง</b></p>
<p class='tab3 t-14'>
...
</br>แต่บางส่วนดังกล่าวนั้น ไม่เป็นเหตุให้ผู้รับจ้างหลุดพ้นจากความรับผิดหรือพันธะหน้าที่ตามสัญญานี้ และผู้รับ 
</br>จ้างจะยังคงต้องรับผิดในความผิดและความประมาทเลินเล่อของผู้รับจ้างช่วง หรือของตัวแทนหรือลูกจ้าง
...
<p class='tab2 t-14'><b>ข้อ ๑๐ การบอกเลิกสัญญา</b></p>
<p class='tab3 t-14'>
...
</br>หายต่างๆ ที่เกิดขึ้น รวมทั้งค่าใช้จ่ายที่เพิ่มขึ้นในการทำงานนั้นต่อให้แล้วเสร็จตามสัญญาซึ่งผู้ว่าจ้างจะหักเอา
</br>จากจำนวนเงินใดๆ ที่จะจ่ายให้แก่ผู้รับจ้างก็ได้
</p>
<p class='tab3 t-14'>
...
</br>ปรับ ค่าเสียหาย หรือค่าใช้จ่ายแก่ผู้ว่าจ้าง ผู้รับจ้างต้องชดใช้ค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายดังกล่าวให้แก่ผู้ว่าจ้างโดยสิ้นเชิงภายในกำหนด {result.EnforcementOfFineDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้ว่าจ้าง หากผู้รับจ้างไม่ชดใช้
</br>ให้ถูกต้องครบถ้วนภายในระยะเวลาดังกล่าวให้ผู้ว่าจ้างมีสิทธิที่จะหักเอาจากจำนวนเงินค่าจ้างที่ต้องชำระ
...
<p class='tab2 t-14'><b>ข้อ ๑๒ การงดหรือลดค่าปรับ หรือการขยายเวลาในการปฏิบัติตามสัญญา</b></p>
<p class='tab3 t-14'>
...
<p class='tab3 t-14'>
    ถ้าผู้รับจ้างไม่ปฏิบัติให้เป็นไปตามความในวรรคหนึ่ง ให้ถือว่าผู้รับจ้างได้สละสิทธิเรียกร้องใน
</br>การที่จะของดหรือลดค่าปรับ หรือขยายเวลาทำการตามสัญญาโดยไม่มีเงื่อนไขใดๆทั้งสิ้น เว้นแต่กรณีเหตุเกิด
</br>จากความผิดหรือความบกพร่องของฝ่ายผู้ว่าจ้างซึ่งมีหลักฐานชัดแจ้งหรือผู้ว่าจ้างทราบดีอยู่แล้วตั้งแต่ต้น
</p>
<p class='tab3 t-14'>
...
<p class='tab2 t-16'>(๗) ให้กำหนดในอัตราระหว่างร้อยละ ๐.๐๒๕ – ๐.๐๓๕ ของราคาตามสัญญาต่อชั่วโมง</p>
<p class='tab2 t-16'>(๘) อัตราค่าปรับตามสัญญาข้อ ๗ ให้กำหนดเป็นรายวันในอัตราระหว่างร้อยละ ๐.๐๑-๐.๑๐ ตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. ๒๕๖๐ ข้อ ๑๖๒ ส่วนกรณีจะปรับร้อยละเท่าใด ให้อยู่ในดุลพินิจของหน่วยงานของรัฐผู้ว่าจ้างที่จะพิจารณา โดยคำนึงถึงราคาและลักษณะของพัสดุที่จ้าง ซึ่งอาจมีผลกระทบต่อการที่ผู้รับจ้างจะหลีกเลี่ยงไม่ปฏิบัติตามสัญญา แต่ทั้งนี้การที่จะกำหนดค่าปรับเป็นร้อยละเท่าใดจะต้องกำหนดไว้ในเอกสารเชิญชวนด้วย</p>
<p class='tab2 t-16'>(๙) “หลักประกัน” หมายถึง หลักประกันที่ผู้รับจ้างนำมามอบไว้แก่หน่วยงานของรัฐ เมื่อลงนามในสัญญา เพื่อเป็นการประกันความเสียหายที่อาจจะเกิดขึ้นจากการปฏิบัติตามสัญญา ดังนี้</p>
...
<p class='tab2 t-16'>(๑๐) ให้กำหนดจำนวนเงินหลักประกันการปฏิบัติตามสัญญาตามระเบียบการะทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. ๒๕๖๐ ข้อ ๑๖๘</p>
<p class='tab2 t-16'>(๑๑) เป็นข้อความหรือเงื่อนไขเพิ่มเติม ซึ่งหน่วยงานของรัฐผู้ทำสัญญาอาจเลือกใช้หรือตัดออกได้ตามข้อเท็จจริง</p>
<p class='tab2 t-16'>(๑๒) อัตราค่าปรับตามสัญญาข้อ ๙ กรณีผู้รับจ้างไปจ้างช่วงบางส่วนโดยไม่ได้รับอนุญาตจากผู้ว่าจ้างต้องกำหนดค่าปรับเป็นจำนวนเงินไม่น้อยกว่าร้อยละสิบของวงเงินของงานที่จ้างช่วงตามสัญญา</p>
</div>
";
