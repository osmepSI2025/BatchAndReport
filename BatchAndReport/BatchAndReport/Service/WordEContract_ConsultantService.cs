...
<div class='contract'>
    ...
    <p class='tab3 t-16'>
        1.1 ผู้ว่าจ้างตกลงจ้างและที่ปรึกษาตกลงรับจ้างปฏิบัติงานตามโครงการ {result.ProjectName}: {result.ProjectDesc} {result.ProjectReference} ตามข้อกำหนดและเงื่อนไขแห่งสัญญานี้รวมทั้งเอกสารแนบท้ายสัญญาผนวก .......
ทั้งนี้ ที่ปรึกษาจะต้อง
    ...
    <p class='tab3 t-16'>
        1.2 ที่ปรึกษาจะต้องเริ่มลงมือทำงานภายใน {ToThaiDate(result.ProjectStartDate)} และ
...
{htmlDocAtt}
...
</br>ในสัญญานี้บังคับ และในกรณีที่เอกสารแนบท้ายสัญญาขัดแย้งกันเอง ที่ปรึกษาจะต้องปฏิบัติตามคำวินิจฉัยของ 
</br>ผู้ว่าจ้าง คำวินิจฉัยของผู้ว่าจ้างให้ถือเป็นที่สุด และที่ปรึกษาไม่มีสิทธิเรียกร้องค่าจ้าง ค่าเสียหาย หรือค่าใช้จ่ายใดๆ เพิ่มเติมจากผู้ว่าจ้างทั้งสิ้น
    </p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'><b>ข้อ 3 ค่าจ้างและการจ่ายเงิน</b></p>
    <p class='tab3 t-16'>
        ผู้ว่าจ้างและที่ปรึกษาได้ตกลงราคาค่าจ้างตามสัญญานี้ เป็นจำนวนเงินทั้งสิ้น {result.ContractTotalAmount} บาท ({ToThaiNumberText(result.ContractTotalAmount)}) ซึ่งได้รวมภาษีมูลค่าเพิ่ม 
เป็นเงินจำนวน{result.VatAmount}บาท ({ToThaiNumberText(result.VatAmount)}) ตลอดจนภาษีอากรอื่นๆ และค่าใช้จ่ายทั้งปวงด้วยแล้ว
    </p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'>
        (7)การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้ว่าจ้างจะโอนเงินเข้าบัญชีเงินฝากธนาคารของ 
    ...
    <p class='tab3 t-16'><b>(8)ข้อ 4 เงินค่าจ้างล่วงหน้า</b></p>
    <p class='tab3 t-16'>
        ผู้ว่าจ้างตกลงจ่ายเงินค่าจ้างล่วงหน้าให้แก่ที่ปรึกษา เป็นจำนวนเงิน {result.PrepaidAmount} บาท 
</br>({ToThaiNumberText(result.PrepaidAmount)}) ซึ่งเท่ากับร้อยละ {result.PrepaidPercents} ของค่าจ้างตามสัญญา
    </p>
    <p class='tab3 t-16'>
        เงินค่าจ้างล่วงหน้าดังกล่าวจะจ่ายให้ภายหลังจากที่ที่ปรึกษาได้วางหลักประกันการรับเงินค่าจ้างล่วงหน้าเป็น {result.GuaranteeType} (หนังสือค้ำประกันหรือหนังสือค้ำประกันอิเล็กทรอนิกส์ของธนาคารภายในประเทศ {result.PrepaidBankName}เต็มตามจำนวนเงินค่าจ้างล่วงหน้านั้นให้แก่ผู้ว่าจ้าง ที่ปรึกษาจะต้องออกใบเสร็จรับเงินค่าจ้างล่วงหน้าตามแบบที่ผู้ว่าจ้างกำหนดให้และที่ปรึกษาตกลงที่จะกระทำตามเงื่อนไขอันเกี่ยวกับการใช้จ่ายและการใช้คืนเงินค่าจ้างล่วงหน้านั้น ดังต่อไปนี้
    </p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'>
        4.2.เมื่อผู้ว่าจ้างเรียกร้อง ที่ปรึกษาต้องแสดงหลักฐานการใช้จ่ายเงินค่าจ้างล่วงหน้า 
</br>เพื่อพิสูจน์ว่าได้เป็นไปตามข้อ ๔.๑ ภายในกำหนด 15 (สิบห้า)วัน นับถัดจากวันได้รับแจ้งจากผู้ว่าจ้าง หาก
</br>ที่ปรึกษาไม่อาจแสดงหลักฐานดังกล่าว ภายในกำหนด 15 (สิบห้า)วัน ผู้ว่าจ้างอาจเรียกเงินค่าจ้างล่วงหน้า
</br>คืนจากที่ปรึกษาหรือบังคับเอาจากหลักประกันการรับเงินค่าจ้างล่วงหน้าได้ทันที
    </p>
    <p class='tab3 t-16'>
        4.3.ในการจ่ายเงินค่าจ้างให้แก่ที่ปรึกษาตามข้อ 3 ผู้ว่าจ้างจะหักชดใช้คืนเงินค่าจ้างล่วงหน้า
</br>ในแต่ละงวดไว้จำนวนร้อยละ {result.PrepaidDeductPercent} ของจำนวนเงินค่าจ้างในแต่ละงวดจนกว่าจำนวนเงินที่หักไว้จะครบตาม
</br>จำนวนเงินที่หักค่าจ้างล่วงหน้าที่ที่ปรึกษาได้รับไปแล้ว ยกเว้นค่าจ้างงวดสุดท้ายจะหักไว้เป็นจำนวนเท่ากับจำนวนเงินค่าจ้างล่วงหน้าที่เหลือทั้งหมด
    </p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'>
        4.5.ในกรณีที่มีการบอกเลิกสัญญา หากเงินค่าจ้างล่วงหน้าที่เหลือเกินกว่าจำนวนเงินที่ 
</br>ที่ปรึกษาจะได้รับหลังจากหักชดใช้ในกรณีอื่นแล้ว ที่ปรึกษาจะต้องจ่ายคืนเงินจำนวนที่เหลือนั้นให้แก่ผู้ว่าจ้าง 
</br>ภายใน 7 (เจ็ด)วัน นับถัดจากวันได้รับแจ้งเป็นหนังสือจากผู้ว่าจ้าง
    </p>
    <p class='tab3 t-16'>
        4.6.ผู้ว่าจ้างจะคืนหลักประกันเงินค่าจ้างล่วงหน้าให้แก่ที่ปรึกษาต่อเมื่อผู้ว่าจ้างได้หักเงิน
</br>ค่าจ้างไว้จนครบจำนวนเงินค่าจ้างล่วงหน้าตามข้อ ๔.๓ แล้ว
    </p>
   <p class='tab3 t-16'><b>ข้อ 5 ความรับผิดชอบของที่ปรึกษา</b></p>
    <p class='tab3 t-16'>
...
</br>กฎหมายที่เกี่ยวข้องที่ปรึกษาต้องรีบทำการแก้ไขให้เป็นที่เรียบร้อย โดยไม่คิดค่าจ้าง ค่าเสียหาย 
</br>หรือค่าใช้จ่ายใดๆ จากผู้ว่าจ้างอีก ถ้าที่ปรึกษาหลีกเลี่ยงหรือไม่รีบจัดการแก้ไขให้เป็นที่เรียบร้อยใน
</br>กำหนดเวลาที่ผู้ว่าจ้างแจ้งเป็นหนังสือผู้ว่าจ้างมีสิทธิจ้างที่ปรึกษารายอื่นทำการแทน โดยที่ปรึกษาจะ
</br>ต้องรับผิดชอบจ่ายเงินค่าจ้างในการนี้แทนผู้ว่าจ้างโดยสิ้นเชิง
    </p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'>
        5.3.บุคลากรหลักของที่ปรึกษา ต้องมีระยะเวลาปฏิบัติงานตามสัญญานี้ไม่ซ้ำซ้อนกับงานใน
    ...
    <p class='tab3 t-16'><b>ข้อ 6 การระงับการทำงานชั่วคราวและการบอกเลิกสัญญา</b></p>
    <p class='tab3 t-16'>
...
</br>ข้อหนึ่งในกรณีเช่นนี้ผู้ว่าจ้างจะบอกกล่าวให้ที่ปรึกษาทราบถึงเหตุผลที่จะบอกเลิกสัญญา ถ้าที่ปรึกษา
</br>มิได้ดำเนินการแก้ไขให้ผู้ว่าจ้างพอใจภายในระยะเวลา {result.FixDaysAfterNoti} วัน นับถัดจากวันที่ได้รับคำบอกกล่าว 
</br>ผู้ว่าจ้างมีสิทธิบอกเลิกสัญญาโดยการส่งคำบอกกล่าวแก่ที่ปรึกษา เมื่อที่ปรึกษาได้รับหนังสือบอกกล่าวนั้นแล้ว 
</br>ที่ปรึกษาต้องหยุดปฏิบัติงานทันที และดำเนินการทุกวิถีทางเพื่อลดค่าใช้จ่ายใดๆ ที่อาจมีในระหว่างการ
</br>หยุดปฏิบัติงานนั้นให้น้อยที่สุด
    </p>
    <p class='tab3 t-16'>
        (ข)หากที่ปรึกษามิได้ลงมือทำงานภายในกำหนดเวลา หรือไม่สามารถทำงานให้แล้วเสร็จ
</br>ตามกำหนดเวลา หรือมีเหตุให้ผู้ว่าจ้างเชื่อได้ว่าที่ปรึกษาไม่สามารถทำงานให้แล้วเสร็จภายในกำหนดเวลา 
</br>หรือล่วงเลยกำหนดเวลาแล้วเสร็จไปแล้ว หรือตกเป็นผู้ล้มละลาย ผู้ว่าจ้างมีสิทธิบอกเลิกสัญญาได้ทันที
    </p>
    <p class='tab3 t-16'>
        การบอกเลิกสัญญาตามข้อ ๖.๑ ผู้ว่าจ้างมีสิทธิริบหรือบังคับจากหลักประกันเงินค่าจ้างล่วง
</br>หน้า หลักประกันการปฏิบัติตามสัญญาและเงินประกันผลงานทั้งหมดหรือแต่บางส่วน และมีสิทธิเรียกค่าเสียหายอื่น (ถ้ามี)จากที่ปรึกษาด้วย
    </p>
    <p class='tab3 t-16'>
        6.2.ผู้ว่าจ้างอาจมีหนังสือบอกกล่าวให้ที่ปรึกษาทราบล่วงหน้าเมื่อใดก็ได้ว่าผู้ว่าจ้างมีเจตนา
...
</br>ที่กำหนดในเอกสารแนบท้ายสัญญาผนวก ......ให้แก่ที่ปรึกษา โดยคำนวณตั้งแต่วันเริ่มปฏิบัติงานจนถึง
</br>วันบอกเลิกสัญญา นอกจากนี้ผู้ว่าจ้างจะคืนหลักประกันการปฏิบัติตามสัญญาหรือเงินประกันผลงาน 
</br>รวมทั้งเงินชดเชยค่าเดินทางและเงินค่าใช้จ่ายที่ได้ทดรองจ่ายไปตามสมควรและตามความเป็นจริง 
</br>ซึ่งผู้ว่าจ้างยังมิได้ชำระให้แก่ที่ปรึกษาด้วย อย่างไรก็ตาม เงินชดเชยและเงินที่ได้ชำระไปแล้วทั้งหมดจะต้อง
</br>ไม่เกินราคาค่าจ้างตามข้อ ๓
    </p>
    <p class='tab3 t-16'><b>ข้อ 7 สิทธิและหน้าที่ของที่ปรึกษา</b></p>
    <p class='tab3 t-16'>
        7.1.ที่ปรึกษาจะต้องใช้ความชำนาญ ความระมัดระวัง และความขยันหมั่นเพียร ในการ
    ...
    <p class='tab3 t-16'>
        7.2.ค่าจ้างซึ่งผู้ว่าจ้างจะชำระแก่ที่ปรึกษาตามข้อ ๓ เป็นค่าตอบแทนเพียงอย่างเดียวเท่านั้น
    ...
    <p class='tab3 t-16'>
        7.3.ที่ปรึกษาจะต้องไม่มีผลประโยชน์ใดๆ ไม่ว่าโดยตรงหรือโดยอ้อมในเงินค่าสิทธิ 
    ...
    <p class='tab3 t-16'>
        7.4.บรรดางานและเอกสารที่ที่ปรึกษาได้จัดทำขึ้นเกี่ยวกับสัญญานี้ให้ถือเป็นความลับและ
    ...
    <p class='tab3 t-16'>
        7.5.ผู้ว่าจ้างเป็นเจ้าของลิขสิทธิ์หรือสิทธิในทรัพย์สินทางปัญญา รวมถึงสิทธิใดๆ ในผลงานที่
    ...
    <p class='tab3 t-16'>
        7.6.บรรดาเครื่องมือ เครื่องใช้ และวัสดุอุปกรณ์ทั้งหลาย ซึ่งผู้ว่าจ้างได้จัดให้ที่ปรึกษาใช้หรือ
    ...
    <p class='tab3 t-16'>
        7.7.ที่ปรึกษาจะจัดให้มีบุคลากรที่มีความรู้และความชำนาญงานมาปฏิบัติงานให้เหมาะสมกับสภาพการปฏิบัติงานตามสัญญานี้และให้สอดคล้องกับขอบเขตของงานของที่ปรึกษาตามที่ปรากฏ ในเอกสาร
</br>แนบท้ายสัญญาผนวก …..การเปลี่ยนแปลงบุคลากรดังกล่าวจะต้องได้รับความยินยอมเป็นหนังสือจากผู้ว่าจ้าง
</br>ก่อน
    </p>
    <p class='tab3 t-16'>
        7.8.ในกรณีที่ผู้ว่าจ้างพิจารณาเห็นว่า การดำเนินงานของบุคลากรที่ที่ปรึกษาจัดหามาจะก่อ
    ...
    <p class='tab3 t-16'><b>ข้อ 8 ความรับผิดชอบของที่ปรึกษาต่อบุคคลภายนอก</b></p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'>
        8.2.ที่ปรึกษาจะต้องรับผิดชอบต่อการละเมิดบทบัญญัติแห่งกฎหมาย หรือการละเมิดลิขสิทธิ์ หรือสิทธิในทรัพย์สินทางปัญญาอื่น รวมถึงสิทธิใดๆ ต่อบุคคลภายนอกเนื่องจากการปฏิบัติงานตามสัญญานี้ 
</br>โดยสิ้นเชิง
    </p>
    <p class='tab3 t-16'>
        (9)8.3.ที่ปรึกษาจะต้องจัดการประกันภัยกับบริษัทประกันภัยที่ผู้ว่าจ้างเห็นชอบเพื่อความ
    ...
    <p class='tab3 t-16'><b>ข้อ 9 พันธะหน้าที่ของผู้ว่าจ้าง</b></p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'><b>ข้อ 10 ค่าปรับ</b></p>
    <p class='tab3 t-16'>
...
</br>ไม่ชดใช้ให้ถูกต้องครบถ้วนภายในระยะเวลาดังกล่าว ให้ผู้ว่าจ้างมีสิทธิที่จะหักเอาจากจำนวนเงินค่าจ้างของที่ปรึกษา
</br>ที่ต้องชำระ หรือบังคับจากหลักประกันการปฏิบัติตามสัญญาหรือเงินประกันผลงานได้ทันที
    </p>
    <p class='tab3 t-16'>
...
</br>จนครบถ้วนตามจำนวนค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายนั้น ภายในกำหนด {result.OutstandingPeriodDays}วันนับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้ว่าจ้าง
    </p>
    <p class='tab3 t-16'>
    ...
    <p class='tab3 t-16'><b>(11)ข้อ 12 (ก)เงินประกันผลงาน</b></p>
    <p class='tab3 t-16'>
        ในการจ่ายเงินให้แก่ที่ปรึกษาแต่ละงวด ผู้ว่าจ้างจะหักเงินจำนวนร้อยละ{result.RetentionRatePercent}ของเงินที่ต้อง
</br>จ่ายในงวดนั้นเพื่อเป็นประกันผลงาน หรือที่ปรึกษาอาจนำหนังสือค้ำประกันของธนาคารหรือ
</br>หนังสือค้ำประกันอิเล็กทรอนิกส์ของธนาคารภายในประเทศซึ่งมีอายุการค้ำประกันตลอดอายุสัญญามามอบให้ผู้ว่าจ้าง 
</br>ทั้งนี้เพื่อเป็นหลักประกันแทนก็ได้
    </p>
    <p class='tab3 t-16'>
...
</br>({ToThaiNumberText(result.GuaranteeAmount)})ซึ่งเท่ากับร้อยละ {result.GuaranteePercent} ของราคาค่าจ้างตามสัญญา มามอบไว้แก่ผู้ว่าจ้างเพื่อเป็นหลักประกันการปฏิบัติตามสัญญานี้
    </p>
    <p class='tab3 t-16'>
        (15)กรณีที่ปรึกษาใช้หนังสือค้ำประกันมาเป็นหลักประกันการปฏิบัติตามสัญญา หนังสือค้ำ
...
</br>โดยอนุโลมให้ใช้ตามตัวอย่างหนังสือค้ำประกันของธนาคารที่คณะกรรมการนโยบายกำหนด หรืออาจ
</br>เป็นหนังสือค้ำประกันอิเล็กทรอนิกส์ตามวิธีการที่กรมบัญชีกลางกำหนดก็ได้ และจะต้องมีอายุการค้ำประกัน
...
</br>แต่บางส่วนดังกล่าวนั้น ไม่เป็นเหตุให้ที่ปรึกษาหลุดพ้นจากความรับผิดหรือพันธะหน้าที่ตามสัญญานี้และ
</br>ที่ปรึกษาจะยังคงต้องรับผิดในความผิดและความประมาทเลินเล่อของผู้รับช่วงงาน หรือของตัวแทนหรือ
</br>ลูกจ้างของผู้รับช่วงงานนั้นทุกประการ
...
</br>พร้อมหลักฐานเป็นหนังสือให้ผู้ว่าจ้างทราบ เพื่อของดหรือลดค่าปรับหรือขยายเวลาทำงานออกไป
</br>ภายใน ๑๕ (สิบห้า)วัน นับถัดจากวันที่เหตุนั้นสิ้นสุดลง หรือตามที่กำหนดในกฎกระทรวงดังกล่าว แล้วแต่กรณี
    </p>
    <p class='tab3 t-16'>
        ถ้าที่ปรึกษาไม่ปฏิบัติให้เป็นไปตามความในวรรคหนึ่ง ให้ถือว่าที่ปรึกษาได้สละสิทธิเรียกร้อง 
</br>ในการที่จะของดหรือลดค่าปรับ หรือขยายเวลาทำงานออกไปโดยไม่มีเงื่อนไขใดๆ ทั้งสิ้น 
</br>เว้นแต่กรณีเหตุเกิดจากความผิดหรือความบกพร่องของฝ่ายผู้ว่าจ้างซึ่งมีหลักฐานชัดแจ้งหรือผู้ว่าจ้างทราบดีอยู่แล้วตั้งแต่ต้น
    </p>
    <p class='tab3 t-16'>
        การงดหรือลดค่าปรับ หรือขยายกำหนดเวลาทำงานตามวรรคหนึ่ง อยู่ในดุลพินิจของผู้ว่าจ้างที่จะพิจารณาตามที่เห็นสมควร
    </p>
...
<div style='page-break-before: always;'></div>
   ...
   <p class='tab3 t-16'>ข.กรณีบุคคลธรรมดา ให้ระบุชื่อและที่อยู่</p>
    ...
    <p class='tab2 t-16'>(7)หน่วยงานของรัฐอาจกำหนดเงื่อนไขการจ่ายค่าเช่าให้แตกต่างไปจากแบบสัญญาที่กำหนดได้ตามความเหมาะสมและจำเป็นและไม่ทำให้หน่วยงานของรัฐเสียเปรียบ หากหน่วยงานของรัฐเห็นว่าจะมีปัญหาในทางเสียเปรียบหรือไม่รัดกุมพอ ก็ให้ส่งร่างสัญญานั้นไปให้สำนักงานอัยการสูงสุดพิจารณาให้ความเห็นชอบก่อน</p>
    <p class='tab2 t-16'>(8)เป็นข้อความหรือเงื่อนไขเพิ่มเติม ซึ่งหน่วยงานของรัฐผู้ทำสัญญาอาจเลือกใช้หรือตัดออกได้ตามข้อเท็จจริง</p>
    <p class='tab2 t-16'>(9)ชื่อสถานที่หน่วยงานของรัฐ</p>
    <p class='tab2 t-16'>(10)ให้พิจารณาถึงความจำเป็นและเหมาะสมของการใช้งาน</p>
    <p class='tab2 t-16'>(11)อัตราค่าปรับตามสัญญาข้อ 9 ให้กำหนดเป็นรายวันในอัตราระหว่างร้อยละ 0.01 – 0.20 ตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ.2560 ข้อ 162 ส่วนกรณีจะปรับร้อยละเท่าใด ให้อยู่ในดุลยพินิจของหน่วยงานของรัฐผู้เช่าที่จะพิจารณา โดยคำนึงถึงราคาและลักษณะของพัสดุที่เช่า ซึ่งอาจมีผลกระทบต่อการที่ผู้ให้เช่าจะหลีกเลี่ยงไม่ปฏิบัติตามสัญญา แต่ทั้งนี้การที่จะกำหนดค่าปรับเป็นร้อยละเท่าใดจะต้องกำหนดไว้ในเอกสารเชิญชวนด้วย</p>
    <p class='tab2 t-16'>(12)“หลักประกัน” หมายถึง หลักประกันที่ผู้ให้เช่านำมามอบไว้แก่หน่วยงานของรัฐ เมื่อลงนามในสัญญา เพื่อเป็นการประกันความเสียหายที่อาจจะเกิดขึ้นจากการปฏิบัติตามสัญญา ดังนี้</p>
   ...
   <p class='tab3 t-16'>(๕)พันธบัตรรัฐบาลไทย</p>
    <p class='tab2 t-16'>(13)ให้กำหนดจำนวนเงินหลักประกันการปฏิบัติตามสัญญาตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ.2560 ข้อ 168</p>
    <p class='tab2 t-16'>(14)เป็นข้อความหรือเงื่อนไขเพิ่มเติม ซึ่งหน่วยงานของรัฐผู้ทำสัญญาอาจเลือกใช้หรือตัดออกได้ตามข้อเท็จจริง</p>
    <p class='tab2 t-16'>(15)กำหนดระยะเวลาตามความเหมาะสม เช่น 3 เดือน</p>
   <p class='tab3 t-16'>(16)อัตราค่าปรับตามสัญญาข้อ 12 ให้กำหนดเป็นรายวันในอัตราระหว่างร้อยละ 0.01 – 0.20 ตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ.2560 ข้อ 162 ส่วนกรณีจะปรับร้อยละเท่าใด ให้อยู่ในดุลยพินิจของหน่วยงานของรัฐผู้เช่าที่จะพิจารณา โดยคำนึงถึงราคาและลักษณะของพัสดุที่เช่า ซึ่งอาจมีผลกระทบต่อการที่ผู้ให้เช่าจะหลีกเลี่ยงไม่ปฏิบัติตามสัญญา แต่ทั้งนี้การที่จะกำหนดค่าปรับเป็นร้อยละเท่าใดจะต้องกำหนดไว้ในเอกสารเชิญชวนด้วย</p>
