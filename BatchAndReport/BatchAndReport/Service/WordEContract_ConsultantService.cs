...
public class WordEContract_ConsultantService
{
 ...
 public byte[] OnGetWordContact_ConsultantService()
 {
...
"สัญญานี้เรียกว่า “ที่ปรึกษา” อีกฝ่ายหนึ่ง","32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("1.1 ผู้ว่าจ้างตกลงจ้างและที่ปรึกษาตกลงรับจ้างปฏิบัติงานตามโครงการ.......................................................................................(ชื่อโครงการและรายละเอียดที่สำคัญทุกรายการ)……………………..…………………… ……………………………………………….……………………………………………………………………………………………………………….…………………………………………..…………………………………………………………………….………………………………………………ตามข้อกำหนดและเงื่อนไขแห่งสัญญานี้รวมทั้งเอกสารแนบท้ายสัญญาผนวก .......ทั้งนี้ ที่ปรึกษาจะต้องปฏิบัติงานให้เป็นไปตามหลักวิชาการและมาตรฐานวิชาชีพทางด้าน.............................................และบทบัญญัติแห่งกฎหมาย ที่เกี่ยวข้อง", null,"32"));
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("1.2 ที่ปรึกษาจะต้องเริ่มลงมือทำงานภายในวันที่ …… เดือน …..................…….…..พ.ศ.….… และจะต้องดำเนินการตามสัญญานี้ให้แล้วเสร็จภายในวันที่……เดือน …..................…….…..พ.ศ.….…", null,"32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้ว่าจ้างและที่ปรึกษาได้ตกลงราคาค่าจ้างตามสัญญานี้ เป็นจำนวนเงินทั้งสิ้น.................บาท (………….......…….…....…..)ซึ่งได้รวมภาษีมูลค่าเพิ่ม เป็นเงินจำนวน…………...…….……..บาท (………..………………….…)ตลอดจนภาษีอากรอื่นๆ และค่าใช้จ่ายทั้งปวงด้วยแล้ว", null,"32"));
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ค่าจ้างจะแบ่งออกเป็น………….….(.......................)งวด ซึ่งแต่ละงวดจะจ่ายให้เมื่อที่ปรึกษาได้ปฏิบัติงานตามที่กำหนดในเอกสารแนบท้ายสัญญาผนวก .......และคณะกรรมการตรวจรับพัสดุได้พิจารณาแล้วเห็นว่าครบถ้วนถูกต้องและตรวจรับเรียบร้อยแล้ว", null,"32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("(7)การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้ว่าจ้างจะโอนเงินเข้าบัญชีเงินฝากธนาคารของ ที่ปรึกษา ชื่อธนาคาร……………………...............…สาขา………....………………………ชื่อบัญชี……..…………..…….…………….เลขที่บัญชี.....……..…………………… ทั้งนี้ ที่ปรึกษาตกลงเป็นผู้รับภาระเงินค่าธรรมเนียมหรือค่าบริการอื่นใดเกี่ยวกับการโอน รวมทั้งค่าใช้จ่ายอื่นใด (ถ้ามี)ที่ธนาคารเรียกเก็บและยินยอมให้มีการหักเงินดังกล่าวจากจำนวนเงินโอนในงวดนั้นๆ (ความในวรรคนี้ใช้สำหรับกรณีที่หน่วยงานของรัฐจะจ่ายเงินตรงให้แก่ที่ปรึกษา (ระบบ Direct Payment)โดยการโอนเงินเข้าบัญชีเงินฝากธนาคารของที่ปรึกษา ตามแนวทางที่กระทรวงการคลังหรือหน่วยงานของรัฐเจ้าของงบประมาณเป็นผู้กำหนด แล้วแต่กรณี)", null,"32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้ว่าจ้างตกลงจ่ายเงินค่าจ้างล่วงหน้าให้แก่ที่ปรึกษา เป็นจำนวนเงิน…………………...…..…บาท(……………………....….…)ซึ่งเท่ากับร้อยละ……....…(……….……....)ของค่าจ้างตามสัญญา", null,"32"));
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("เงินค่าจ้างล่วงหน้าดังกล่าวจะจ่ายให้ภายหลังจากที่ที่ปรึกษาได้วางหลักประกันการรับเงินค่าจ้างล่วงหน้าเป็น...............................................(หนังสือค้ำประกันหรือหนังสือค้ำประกันอิเล็กทรอนิกส์ของธนาคารภายในประเทศ …………………………....เต็มตามจำนวนเงินค่าจ้างล่วงหน้านั้นให้แก่ผู้ว่าจ้าง ที่ปรึกษาจะต้องออกใบเสร็จรับเงินค่าจ้างล่วงหน้าตามแบบที่ผู้ว่าจ้างกำหนดให้และที่ปรึกษาตกลงที่จะกระทำตามเงื่อนไขอันเกี่ยวกับการใช้จ่ายและการใช้คืนเงินค่าจ้างล่วงหน้านั้น ดังต่อไปนี้", null,"32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("4.3.ในการจ่ายเงินค่าจ้างให้แก่ที่ปรึกษาตามข้อ 3 ผู้ว่าจ้างจะหักชดใช้คืนเงินค่าจ้างล่วงหน้าในแต่ละงวดไว้จำนวนร้อยละ.............................(....................................)ของจำนวนเงินค่าจ้างในแต่ละงวดจนกว่าจำนวนเงินที่หักไว้จะครบตามจำนวนเงินที่หักค่าจ้างล่วงหน้าที่ที่ปรึกษาได้รับไปแล้ว ยกเว้นค่าจ้างงวดสุดท้ายจะหักไว้เป็นจำนวนเท่ากับจำนวนเงินค่าจ้างล่วงหน้าที่เหลือทั้งหมด", null,"32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("(ก)หากผู้ว่าจ้างเห็นว่าที่ปรึกษามิได้ปฏิบัติงานด้วยความชำนาญหรือด้วยความเอาใจใส่ในวิชาชีพของที่ปรึกษาเท่าที่พึงคาดหมายได้จากที่ปรึกษาในระดับเดียวกัน หรือมิได้ปฏิบัติตามสัญญาข้อใดข้อหนึ่ง ในกรณีเช่นนี้ผู้ว่าจ้างจะบอกกล่าวให้ที่ปรึกษาทราบถึงเหตุผลที่จะบอกเลิกสัญญา ถ้าที่ปรึกษามิได้ดำเนินการแก้ไขให้ผู้ว่าจ้างพอใจภายในระยะเวลา..................(…..............….)วัน นับถัดจากวันที่ได้รับคำบอกกล่าว ผู้ว่าจ้างมีสิทธิบอกเลิกสัญญาโดยการส่งคำบอกกล่าวแก่ที่ปรึกษา เมื่อที่ปรึกษาได้รับหนังสือบอกกล่าวนั้นแล้ว ที่ปรึกษาต้องหยุดปฏิบัติงานทันที และดำเนินการทุกวิถีทางเพื่อลดค่าใช้จ่ายใดๆ ที่อาจมีในระหว่างการหยุดปฏิบัติงานนั้นให้น้อยที่สุด", null,"32"));
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("(ข)หากที่ปรึกษามิได้ลงมือทำงานภายในกำหนดเวลา หรือไม่สามารถทำงานให้แล้วเสร็จตามกำหนดเวลา หรือมีเหตุให้ผู้ว่าจ้างเชื่อได้ว่าที่ปรึกษาไม่สามารถทำงานให้แล้วเสร็จภายในกำหนดเวลา หรือล่วงเลยกำหนดเวลาแล้วเสร็จไปแล้ว หรือตกเป็นผู้ล้มละลาย ผู้ว่าจ้างมีสิทธิบอกเลิกสัญญาได้ทันที", null,"32"));
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("การบอกเลิกสัญญาตามข้อ ๖.๑ ผู้ว่าจ้างมีสิทธิริบหรือบังคับจากหลักประกันเงินค่าจ้างล่วงหน้า หลักประกันการปฏิบัติตามสัญญาและเงินประกันผลงานทั้งหมดหรือแต่บางส่วน และมีสิทธิเรียกค่าเสียหายอื่น (ถ้ามี)จากที่ปรึกษาด้วย", null,"32"));
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("6.2.ผู้ว่าจ้างอาจมีหนังสือบอกกล่าวให้ที่ปรึกษาทราบล่วงหน้าเมื่อใดก็ได้ว่าผู้ว่าจ้างมีเจตนาที่จะระงับการทำงานของที่ปรึกษาไว้ชั่วคราวไม่ว่าทั้งหมดหรือแต่บางส่วน หรือจะบอกเลิกสัญญา ในกรณีที่ผู้ว่าจ้าง จะบอกเลิกสัญญา การบอกเลิกสัญญาดังกล่าวจะมีผลในเวลาไม่น้อยกว่า...................(....................)วัน นับถัดจากวันที่ที่ปรึกษาได้รับหนังสือบอกกล่าวนั้น หรืออาจเร็วกว่าหรือช้ากว่ากำหนดเวลานั้นก็ได้แล้วแต่คู่สัญญาจะทำความตกลงกัน เมื่อที่ปรึกษาได้รับหนังสือบอกกล่าวนั้นแล้ว ที่ปรึกษาต้องหยุดปฏิบัติงานทันที ทั้งนี้ ที่ปรึกษาไม่มีสิทธิได้รับค่าจ้างในระหว่างระงับการทำงานไว้ชั่วคราว และที่ปรึกษาจะต้องดำเนินการทุกวิถีทางเพื่อลดค่าใช้จ่ายใดๆ ที่อาจมีในระหว่างการหยุดปฏิบัติงานนั้นให้น้อยที่สุด", null,"32"));
 ...
 body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("กรณีที่ที่ปรึกษาทำงานไม่แล้วเสร็จตามเวลาที่กำหนดในข้อ 1 ที่ปรึกษาจะต้องเสียค่าปรับให้แก่ผู้ว่าจ้างเป็นรายวัน ในอัตราร้อยละ.......(10).......(.........................)ของวงเงินค่าจ้างตามข้อ 3 นับถัดจาก วันครบกำหนดในข้อ 1 จนถึงวันที่ที่ปรึกษาปฏิบัติตามสัญญาถูกต้องครบถ้วน และผู้ว่าจ้างได้ตรวจรับงานแล้ว", null,"32"));

 body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("ข้อ 11การบังคับค่าปรับ ค่าเสียหาย และค่าใช้จ่าย", null,"32", true));
