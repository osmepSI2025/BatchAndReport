...
</br>จ้างล่วงหน้าเป็น {result.GuaranteeType} (หนังสือค้ำประกันหรือหนังสือค้ำประกันอิเล็กทรอนิกส์ของธนาคารภายในประเทศ {result.PrepaidBankName} เต็มตามจำนวนเงินค่าจ้างล่วงหน้านั้นให้แก่ผู้ว่าจ้าง ที่ปรึกษาจะต้องออกใบเสร็จ
</br>รับเงินค่าจ้างล่วงหน้าตามแบบที่ผู้ว่าจ้างกำหนดให้และที่ปรึกษาตกลงที่จะกระทำตามเงื่อนไขอันเกี่ยวกับการ
</br>ใช้จ่ายและการใช้คืนเงินค่าจ้างล่วงหน้านั้น ดังต่อไปนี้
    </p>
    <p class='tab3 t-16'>
...
</br>จำนวนเงินที่หักค่าจ้างล่วงหน้าที่ที่ปรึกษาได้รับไปแล้ว ยกเว้นค่าจ้างงวดสุดท้ายจะหักไว้เป็นจำนวนเท่ากับจำนวน
</br>เงินค่าจ้างล่วงหน้าที่เหลือทั้งหมด
    </p>
    <p class='tab3 t-16'>
...
</br>จ่ายในงวดนั้นเพื่อเป็นประกันผลงาน หรือที่ปรึกษาอาจนำหนังสือค้ำประกันของธนาคารหรือหนังสือ
</br>ค้ำประกันอิเล็กทรอนิกส์ของธนาคารภายในประเทศซึ่งมีอายุการค้ำประกันตลอดอายุสัญญามามอบให้ 
</br>ผู้ว่าจ้างทั้งนี้เพื่อเป็นหลักประกันแทนก็ได้
    </p>
    <p class='tab3 t-16'>
