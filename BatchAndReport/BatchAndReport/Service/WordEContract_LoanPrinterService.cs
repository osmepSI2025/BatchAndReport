...
<p class='tab3 t-16'>คู่สัญญาได้ตกลงกันมีข้อความดังต่อไปนี้</p>  
    <p class='tab3 t-16'><b>ข้อ 1 ข้อตกลงเช่า</b></p>
    ...
    <p class='tab3 t-16'>การเช่าเครื่องถ่ายเอกสารที่เช่าตามวรรคหนึ่งมีกำหนดระยะเวลา {result.RentalYears} ปี {result.RentalMonths} เดือน ตั้งแต่ {strStartDate} ถึง {strEndDate}</p>
    ...
    <p class='tab3 t-16'><b>ข้อ 2 ค่าเช่าเครื่องถ่ายเอกสาร</b></p>
    <p class='tab3 t-16'>ผู้เช่าตกลงชำระค่าเช่าแก่ผู้ให้เช่าเป็นรายเดือนตามเดือนปฏิทินในอัตราค่าเช่าเดือนละ {result.RatePerUnit} บาท ({strPerUnit}) 
</br>ต่อเครื่องถ่ายเอกสารหนึ่งเครื่อง รวมเป็นค่าเช่าทั้งสิ้นเดือนละ {result.RateTotal} บาท ({strRateTotal}) โดยประเมิน
</br>จากจำนวนสำเนาเอกสารที่ถ่ายทั้งสิ้นเดือนละ {result.EstCopiesPerMonth} แผ่น</p>
    <p class='tab3 t-16'>หากเดือนใดจำนวนสำเนาเอกสารที่ผู้เช่าได้ถ่ายจากเครื่องถ่ายเอกสารที่เช่ามีจำนวนทั้งสิ้นไม่ถึง {result.IfNotCopiesAmount} แผ่น การชำระค่าเช่าในเดือนนั้นให้เปลี่ยนเป็นคิดคำนวณจากจำนวนสำเนาเอกสารที่ถ่ายในเดือนนั้นๆ ในอัตราสำเนาแผ่นละ {result.CopiesRate} บาท</p>
    <p class='tab3 t-16'>ค่าเช่าตามวรรคหนึ่งและวรรคสองได้รวมภาษีมูลค่าเพิ่ม ค่าใช้จ่ายในการบำรุงรักษาและซ่อมแซม ค่าตรวจสภาพ ค่าอะไหล่ ค่าวัสดุสิ้นเปลือง (ยกเว้นค่ากระดาษถ่ายเอกสาร) ไว้ด้วยแล้ว</p>
    <p class='tab3 t-16'>ในการชำระค่าเช่า ผู้ให้เช่าต้องส่งใบแจ้งหนี้เรียกเก็บค่าเช่าเมื่อสิ้นเดือนแต่ละเดือน โดยผู้เช่าจะชำระค่าเช่าหลังจากที่ได้ตรวจสอบแล้วว่าถูกต้อง</p>
    <p class='tab3 t-16'>การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้เช่าจะโอนเงินเข้าบัญชีเงินฝากธนาคารของผู้ให้เช่า ชื่อธนาคาร {result.SaleBankName} สาขา {result.SaleBankBranch} ชื่อบัญชี {result.SaleBankAccountName} เลขที่บัญชี {result.SaleBankAccountNumber} ทั้งนี้ ผู้ให้เช่าตกลงเป็นผู้รับภาระเงินค่าธรรมเนียม หรือค่าบริการอื่นใดเกี่ยวกับการโอน รวมทั้งค่าใช้จ่ายอื่นใด (ถ้ามี) ที่ธนาคารเรียกเก็บ และยินยอมให้มีการหักเงินดังกล่าวจากจำนวนเงินโอนในงวดนั้นๆ</p>
    <p class='tab3 t-16'>ข้อ 3 เอกสารอันเป็นส่วนหนึ่งของสัญญา</p>
...
{htmlDocAtt}
...
</br>สัญญานี้บังคับ และในกรณีที่เอกสารแนบท้ายสัญญาขัดแย้งกันเอง ผู้ให้เช่าจะต้องปฏิบัติตามคำวินิจฉัยของผู้เช่า
</br>คำวินิจฉัยของผู้เช่าให้ถือเป็นที่สุด และผู้ให้เช่าไม่มีสิทธิเรียกร้องค่าเช่า ค่าเสียหาย หรือค่าใช้จ่ายใดๆ 
</br>เพิ่มเติมจากผู้เช่าทั้งสิ้น</p>
    <p class='tab3 t-16'><b>ข้อ 4 การส่งมอบ</b></p>
    <p class='tab3 t-16'>ผู้ให้เช่าต้องส่งมอบและติดตั้งเครื่องถ่ายเอกสารที่เช่าตามสัญญานี้ ให้ถูกต้องครบถ้วนตาม
</br>สัญญานี้ ในลักษณะพร้อมใช้งานได้ตามที่กำหนด ณ {result.DeliveryLocation} ภายในวันที่ {CommonDAO.ToThaiDateStringCovert(result.DeliveryDate ?? DateTime.Now)} ซึ่งผู้ให้เช่าเป็นผู้จัดหาอุปกรณ์ประกอบ 
</br>พร้อมทั้งเครื่องมือที่จำเป็นในการติดตั้งและใช้งาน โดยผู้ให้เช่าเป็นผู้ออกค่าใช้จ่ายเองทั้งสิ้น</p>
    ...
    <p class='tab3 t-16'>ในการส่งมอบตามวรรคหนึ่ง ผู้ให้เช่าต้องส่งพนักงานมาดำเนินการทดสอบประสิทธิภาพ
</br>และแนะนำวิธีการใช้เครื่องให้คณะกรรมการตรวจรับพัสดุได้พิจารณาตามรายละเอียดคุณลักษณะเฉพาะที่ระบุ
</br>ไว้ในข้อ 1 และสำเนาที่ถ่ายจะต้องมีความชัดเจนสะอาด ไม่มีรอยหมึกเปื้อนตามส่วนต่างๆ โดยในการนี้
</br>ผู้ให้เช่าไม่คิดค่าใช้จ่ายใดๆ จากผู้เช่าทั้งสิ้น</p>
   

<p class='tab3 t-16'><b>ข้อ 5 การตรวจรับ</b></p>
...
ใช้งานได้อย่างครบถ้วนและมีประสิทธิภาพตามสัญญา ผู้เช่าทรงไว้ซึ่งสิทธิที่จะไม่รับเครื่องถ่ายเอกสารนั้น
</br>ในกรณีเช่นว่านี้ ผู้ให้เช่าต้องรีบนำเครื่องถ่ายเอกสารนั้นกลับคืนไปทันที และต้องนำเครื่องถ่ายเอกสารเครื่อง
</br>ใหม่ที่มีคุณสมบัติเดียวกัน หรือไม่ต่ำกว่าเครื่องถ่ายเอกสารที่กำหนดไว้ในสัญญานี้ มาส่งมอบให้ใหม่ 
</br>ภายใน {result.TotalDay} วันด้วยค่าใช้จ่ายของผู้ให้เช่าเองทั้งสิ้น และระยะเวลาที่เสียไปเพราะเหตุดังกล่าว
</br>ผู้ให้เช่าจะนำมาอ้างเป็นเหตุของดหรือลดค่าปรับหรือขยายเวลาส่งมอบไม่ได้</p>
    <p class='tab3 t-16'>หากผู้ให้เช่าไม่นำเครื่องถ่ายเอกสารที่ส่งมอบไม่ถูกต้องกลับคืนไปในทันทีดังกล่าวในวรรคสอง และเกิดความเสียหายแก่เครื่องถ่ายเอกสารนั้น ผู้เช่าไม่ต้องรับผิดชอบในความเสียหายดังกล่าว</p>
    <p class='tab3 t-16'>ในกรณีที่ผู้ให้เช่าส่งมอบเครื่องถ่ายเอกสารที่เช่าถูกต้องแต่ไม่ครบจำนวน หรือส่งมอบครบจำนวนแต่ไม่ถูกต้องทั้งหมด ผู้เช่ามีสิทธิจะรับมอบเฉพาะส่วนที่ถูกต้อง โดยออกหลักฐานการรับมอบเฉพาะส่วนนั้นก็ได้ ในกรณีเช่นนี้ผู้เช่าจะชำระค่าเช่าเฉพาะเครื่องถ่ายเอกสารที่เช่าที่รับมอบไว้</p>
    

<p class='tab3 t-16'><b>ข้อ 6 การงดหรือลดค่าปรับ หรือขยายเวลาในการปฏิบัติตามสัญญา</b></p>
...
</br>ที่เช่าภายในระยะเวลาตามข้อ 8.2 และผู้ให้เช่าไม่จัดหาเครื่องถ่ายเอกสารให้ผู้เช่าใช้แทนตามข้อ 8.3 อันเนื่อง
</br>มาจากเหตุสุดวิสัย หรือเหตุใดๆ อันเนื่องมาจากความผิดหรือความบกพร่องของฝ่ายผู้เช่าหรือจากพฤติการณ์
</br>อันหนึ่งอันใดที่ผู้ให้เช่าไม่ต้องรับผิดตามกฎหมาย หรือเหตุอื่นตามที่กำหนดในกฎกระทรวง ซึ่งออกตาม
</br>ความในกฎหมายว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ ผู้ให้เช่ามีสิทธิของดหรือลดค่าปรับ
</br>หรือขยายกำหนดเวลาทำการตามสัญญาดังกล่าวโดยจะต้องแจ้งเหตุหรือพฤติการณ์ดังกล่าวพร้อมหลักฐาน
</br>เป็นหนังสือให้ผู้เช่าทราบภายใน 15 วันนับถัดจากวันที่เหตุนั้นสิ้นสุดลงหรือตามที่กำหนดในกฎกระทรวง
</br>ดังกล่าว แล้วแต่กรณี</p>
...
<p class='tab3 t-16'><b>ข้อ 7 การบำรุงรักษาตรวจสภาพและซ่อมแซมเครื่องถ่ายเอกสารที่เช่า</b></p>
    <p class='tab3 t-16'>ผู้ให้เช่ามีหน้าที่บำรุงรักษาเครื่องถ่ายเอกสารที่เช่าให้อยู่ในสภาพใช้งานได้ดีอยู่เสมอด้วยค่าใช้
</br>จ่ายของผู้ให้เช่า โดยต้องจัดหาช่างผู้มีความรู้ ความชำนาญ และฝีมือดีมาตรวจสอบ บำรุงรักษาและ
</br>ซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าตลอดอายุสัญญาเช่านี้ อย่างน้อยเดือนละ {result.MaintenancePermonth} ครั้ง โดยให้มีระยะ
</br>เวลาห่างกันไม่น้อยกว่า {result.MaintenanceInterval} วัน</p>
    <p class='tab3 t-16'>สิ่งของที่ใช้สิ้นเปลืองทุกชนิดรวมทั้งอะไหล่ ยกเว้นกระดาษสำหรับถ่ายเอกสาร ผู้ให้เช่าจะเป็นผู้จัดส่งให้โดยไม่คิดมูลค่า โดยที่ผู้ให้เช่าจะจัดให้มีไว้ในความครอบครองของผู้เช่าให้เพียงพออยู่เสมอ อุปกรณ์สิ้นเปลืองดังกล่าว เช่น ลูกโม่ถ่ายภาพ ผงหมึก ผงประจุภาพ หมึกพิมพ์ วัสดุที่ใช้ทำความสะอาดถุงกรอง แปรง น้ำมันหล่อลื่น และอุปกรณ์อื่นๆ ที่จำเป็นเพื่อให้เครื่องถ่ายเอกสารใช้งานได้ตามปกติตลอดเวลา</p>
  
<p class='tab3 t-16'><b>ข้อ 8 หน้าที่ของผู้ให้เช่า</b></p>
    <p class='tab3 t-16'>8.1 ผู้ให้เช่ามีหน้าที่ฝึกอบรมวิธีใช้เครื่องถ่ายเอกสารที่เช่าให้แก่เจ้าหน้าที่ของผู้เช่า จน
    ...
    <p class='tab3 t-16'>8.3 ในกรณีที่เครื่องถ่ายเอกสารที่เช่ามีความชำรุดบกพร่องหรือขัดข้องใช้งานไม่ได้ตามปกติ 
</br>และการซ่อมแซมต้องใช้เวลาเกินกว่า {result.ReplaceFixDays} ชั่วโมง ตามที่กำหนดในข้อ 8.2 หรือไม่อาจซ่อมแซมแก้ไข
</br>ให้ดีได้ดังเดิม ผู้ให้เช่าต้องจัดหาเครื่องถ่ายเอกสารที่มีคุณสมบัติ คุณภาพ ความสามารถ และประสิทธิภาพใน
</br>การใช้งานไม่ต่ำกว่าของเครื่องเดิมมาให้ผู้เช่าใช้แทนทันที</p>
    <p class='tab3 t-16'><b>ข้อ 9 ค่าปรับกรณีความชำรุดบกพร่องของเครื่องถ่ายเอกสาร</b></p>
    <p class='tab3 t-16'>ถ้าผู้ให้เช่าไม่ดำเนินการหรือไม่สามารถซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าภายในระยะ
</br>เวลาตามข้อ 8.2 และผู้ให้เช่าไม่จัดหาเครื่องถ่ายเอกสารให้ผู้เช่าใช้แทนตามข้อ 8.3 ผู้ให้เช่ายินยอม
</br>ให้ผู้เช่าปรับเป็นรายวัน ในอัตราวันละ {result.FinePerDays} บาท ({strFinePerDays}) ต่อเครื่อง ตั้งแต่พ้นกำหนดระยะเวลา
</br>ตามข้อ 8.2 จนถึงวันที่ผู้ให้เช่าซ่อมแซมแก้ไขให้อยู่ในสภาพใช้งานได้ดีตามปกติ หรือผู้ให้เช่าจัดหาเครื่องถ่าย
...
</br>ออกจากค่าเช่าตามข้อ 2 หรือบังคับเอาจากหลักประกันตามข้อ 10 ก็ได้</p>

    <p class='tab3 t-16'><b>ข้อ 10 หลักประกันการปฏิบัติตามสัญญา</b></p>
    <p class='tab3 t-16'>ในขณะทำสัญญานี้ผู้ให้เช่าได้นำหลักประกันเป็น {result.GuaranteeType} เป็นจำนวนเงิน {result.GuaranteeAmount} บาท ({strGuaranteeAmount}) ซึ่งเท่ากับร้อยละ {result.GuaranteePercent} ของค่าเช่าทั้งหมดตามสัญญา มามอบให้แก่ผู้เช่าเพื่อเป็นหลักประกันการปฏิบัติตามสัญญานี้</p>
    <p class='tab3 t-16'>กรณีผู้ให้เช่าใช้หนังสือค้ำประกันมาเป็นหลักประกันการปฏิบัติตามสัญญา หนังสือค้ำประกันดังกล่าวจะต้องออกโดยธนาคารที่ประกอบกิจการในประเทศไทย 
หรือโดยบริษัทเงินทุนหรือบริษัทเงินทุนหลักทรัพย์ที่ได้รับอนุญาตให้ประกอบกิจการเงินทุนเพื่อการพาณิชย์และประกอบธุรกิจค้ำประกันตามประกาศของธนาคารแห่งประเทศไทย 
ตามรายชื่อบริษัทเงินทุนที่ธนาคารแห่งประเทศไทยแจ้งเวียนให้ทราบตามแบบที่คณะกรรมการนโยบายการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐกำหนด 
หรืออาจเป็นหนังสือค้ำประกัน</br>อิเล็กทรอนิกส์ตามวิธีการที่กรมบัญชีกลางกำหนดก็ได้ 
และจะต้องมีอายุการค้ำประกันตลอดไปจนกว่า</br>ผู้ให้เช่าพ้นข้อผูกพันตามสัญญานี้</p>
    <p class='tab3 t-16'>หลักประกันที่ผู้ให้เช่านำมามอบให้ตามวรรคหนึ่ง จะต้องมีอายุครอบคลุมความรับผิดทั้งปวงของผู้ให้เช่าตลอดอายุสัญญา ถ้าหลักประกันที่ผู้ให้เช่านำมามอบให้ดังกล่าวลดลงหรือเสื่อมค่าลง หรือมีอายุไม่ครอบคลุมถึงความรับผิดของผู้ให้เช่าตลอดอายุสัญญา ไม่ว่าด้วยเหตุใดๆ ก็ตาม รวมถึงกรณีผู้ให้เช่าส่งมอบและติดตั้งเครื่องถ่ายเอกสารล่าช้าเป็นเหตุให้ระยะเวลาการเช่าตามสัญญาเปลี่ยนแปลงไป ผู้ให้เช่าต้องหาหลักประกันใหม่หรือหลักประกันเพิ่มเติมให้มีจำนวนครบถ้วนตามวรรคหนึ่งมามอบให้แก่ผู้เช่าภายใน {result.NewGuaranteeDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้เช่า</p>
    <p class='tab3 t-16'>หลักประกันที่ผู้ให้เช่านำมามอบไว้ตามข้อนี้ ผู้เช่าจะคืนให้แก่ผู้ให้เช่าโดยไม่มีดอกเบี้ยเมื่อผู้ให้เช่าพ้นจากข้อผูกพันและความรับผิดทั้งปวงตามสัญญานี้แล้ว</p>
    <p class='tab3 t-16'><b>ข้อ 11 การบอกเลิกสัญญา</b></p>
    ...
    <p class='tab3 t-16'>ในกรณีที่ผู้เช่าใช้สิทธิบอกเลิกสัญญา ผู้เช่ามีสิทธิริบหรือบังคับจากหลักประกัน ตามข้อ 10 
    ...
    <p class='tab3 t-16'>ในกรณีมีความจำเป็น ผู้เช่ามีสิทธิที่จะบอกเลิกสัญญาเช่านี้ก่อนครบกำหนดระยะเวลาการเช่าได้ โดยแจ้งเป็นหนังสือให้ผู้ให้เช่าทราบล่วงหน้าไม่น้อยกว่า 30 วัน โดยผู้ให้เช่าจะไม่มีสิทธิเรียกร้องค่าเสียหายใดๆ จากผู้เช่า</p>
    
<p class='tab3 t-16'><b>ข้อ 12 ค่าปรับกรณีส่งมอบล่าช้า</b></p>
    <p class='tab3 t-16'>ในกรณีที่ผู้ให้เช่าส่งมอบเครื่องถ่ายเอกสารที่เช่าล่วงเลยกำหนดส่งมอบตามข้อ 4 และผู้เช่า
</br>มิได้ใช้สิทธิบอกเลิกสัญญาตามข้อ 11 วรรคหนึ่ง ผู้ให้เช่าจะต้องชำระค่าปรับให้ผู้เช่าเป็นรายวัน สำหรับ
</br>เครื่องถ่ายเอกสารที่ยังไม่ได้ส่งมอบตามสัญญา ในอัตราวันละ {result.LateFinePerDays} บาท ({strLate}) ต่อเครื่อง นับถัดจาก
...
</br>สัญญาต่อไปได้ ผู้เช่าจะใช้สิทธิบอกเลิกสัญญา และบังคับจากหลักประกันการปฏิบัติตามสัญญาตามข้อ 10 
</br>กับเรียกร้องให้ชดใช้ค่าเช่าที่เพิ่มขึ้นตามที่กำหนดไว้ในข้อ 11 วรรคสองก็ได้ และถ้าผู้เช่าได้แจ้งข้อเรียกร้อง
</br>ให้ชำระค่าปรับไปยังผู้ให้เช่าเมื่อครบกำหนดส่งมอบดังกล่าวแล้ว ผู้เช่ามีสิทธิที่จะปรับผู้ให้เช่าจนถึงวันบอกเลิกสัญญาได้อีกด้วย</p>

    <p class='tab3 t-16'><b>ข้อ 13 การบังคับค่าปรับ ค่าเสียหาย และค่าใช้จ่าย</b></p>
...
</br>ปฏิบัติตามสัญญาแล้วยังไม่เพียงพอ ผู้ให้เช่ายินยอมชำระส่วนที่เหลือที่ยังขาดอยู่จนครบถ้วนตามจำนวนค่าปรับ
</br>ค่าเสียหาย หรือค่าใช้จ่ายนั้น ภายในกำหนด {result.OutstandingPeriodDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้เช่า</p>
    <p class='tab3 t-16'><b>ข้อ 14 การโอนสิทธิของผู้ให้เช่า</b></p>
    ...
    <p class='tab3 t-16'><b>ข้อ 15 การนำเครื่องถ่ายเอกสารที่เช่ากลับคืนเมื่อสัญญาสิ้นสุดลง</b></p>
    ...
    <p class='tab3 t-16'><b>ข้อ 16 ข้อจำกัดความรับผิดของผู้เช่า</b></p>
...
</br>ละเอียดตลอดแล้ว จึงได้ลงลายมือชื่อ พร้อมประทับตรา (ถ้ามี) ไว้เป็นสำคัญต่อหน้าพยาน และคู่สัญญาต่างยึดถือไว้คนละหนึ่งฉบับ</p>
...
{signatoryHtml}
    ...
    <p class='tab3 t-16'>(๒) เช็คหรือดราฟท์ ที่ธนาคารเซ็นสั่งจ่าย ซึ่งเป็นเช็คหรือดราฟท์ลงวันที่ที่ใช้เช็คหรือดราฟท์นั้นชำระต่อเจ้าหน้าที่ หรือก่อนวันนั้นไม่เกิน 3 วันทำการ</p>
