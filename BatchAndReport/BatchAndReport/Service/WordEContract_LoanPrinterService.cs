...
public class WordEContract_LoanPrinterService
{
    ...
    public byte[] OnGetWordContact_LoanPrinter()
    {
        ...
        using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("(8)การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้เช่าจะโอนเงินเข้าบัญชีเงินฝากธนาคารของผู้ให้เช่า ชื่อธนาคาร………………..………………..สาขา………………………………..ชื่อบัญชี………………………......……...... เลขที่บัญชี……....……...……………………. ทั้งนี้ ผู้ให้เช่าตกลงเป็นผู้รับภาระเงินค่าธรรมเนียม หรือค่าบริการอื่นใดเกี่ยวกับการโอน รวมทั้งค่าใช้จ่ายอื่นใด (ถ้ามี) ที่ธนาคารเรียกเก็บ และยินยอมให้มีการหักเงินดังกล่าวจากจำนวนเงินโอนในงวดนั้นๆ (ความในวรรคนี้ใช้สำหรับกรณีที่หน่วยงานของรัฐจะจ่ายเงินตรงให้แก่ผู้ให้เช่า (ระบบ Direct Payment) โดยการโอนเงินเข้าบัญชีเงินฝากธนาคารของผู้ให้เช่าตามแนวทางที่กระทรวงการคลังหรือหน่วยงานของรัฐเจ้าของงบประมาณเป็นผู้กำหนด แล้วแต่กรณี)", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้ให้เช่าต้องส่งมอบและติดตั้งเครื่องถ่ายเอกสารที่เช่าตามสัญญานี้ ให้ถูกต้องครบถ้วนตามสัญญานี้ ในลักษณะพร้อมใช้งานได้ตามที่กำหนด ณ ........................ ภายในวันที่.......................... ซึ่งผู้ให้เช่าเป็นผู้จัดหาอุปกรณ์ประกอบ พร้อมทั้งเครื่องมือที่จำเป็นในการติดตั้งและใช้งาน โดยผู้ให้เช่าเป็นผู้ออกค่าใช้จ่ายเองทั้งสิ้น", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ทั้งนี้ ผู้ให้เช่าต้องแจ้งเวลาติดตั้งแล้วเสร็จพร้อมที่จะใช้งานและส่งมอบเครื่องได้เป็นหนังสือต่อผู้เช่า ณ.........................(9)........................ในวันและเวลาทำการของผู้เช่าก่อนวันกำหนดส่งมอบตามวรรคหนึ่งไม่น้อยกว่า...................(.......................)วันทำการของผู้เช่า", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้ให้เช่ามีหน้าที่บำรุงรักษาเครื่องถ่ายเอกสารที่เช่าให้อยู่ในสภาพใช้งานได้ดีอยู่เสมอด้วยค่าใช้จ่ายของผู้ให้เช่า โดยต้องจัดหาช่างผู้มีความรู้ ความชำนาญ และฝีมือดีมาตรวจสอบ บำรุงรักษาและซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าตลอดอายุสัญญาเช่านี้ อย่างน้อยเดือนละ...................(...................) ครั้ง โดยให้มีระยะเวลาห่างกันไม่น้อยกว่า................(...................) วัน", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ถ้าผู้ให้เช่าไม่ดำเนินการหรือไม่สามารถซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าภายในระยะเวลาตามข้อ 8.2 และผู้ให้เช่าไม่จัดหาเครื่องถ่ายเอกสารให้ผู้เช่าใช้แทนตามข้อ 8.3 ผู้ให้เช่ายินยอมให้ผู้เช่าปรับเป็นรายวัน ในอัตราวันละ........(11)........ บาท (............................) ต่อเครื่อง ตั้งแต่พ้นกำหนดระยะเวลาตามข้อ 8.2 จนถึงวันที่ผู้ให้เช่าซ่อมแซมแก้ไขให้อยู่ในสภาพใช้งานได้ดีตามปกติ หรือผู้ให้เช่าจัดหาเครื่องถ่ายเอกสารมาให้ผู้เช่าใช้งานแทน หรือจนกว่าผู้เช่าจะใช้สิทธิบอกเลิกสัญญา ทั้งนี้ ผู้เช่าไม่ต้องจ่าย  ค่าเช่าในระหว่างเวลาที่ผู้เช่าไม่สามารถใช้เครื่องถ่ายเอกสารที่เช่าตามสัญญานี้ โดยยินยอมให้ผู้เช่าหักค่าปรับดังกล่าวออกจากค่าเช่าตามข้อ 2 หรือบังคับเอาจากหลักประกันตามข้อ 10 ก็ได้", null, "32"));

            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("ข้อ 10หลักประกันการปฏิบัติตามสัญญา", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ในขณะทำสัญญานี้ผู้ให้เช่าได้นำหลักประกันเป็น……………..….(12)……………..………..เป็นจำนวนเงิน…………..……......บาท (………………………….) ซึ่งเท่ากับร้อยละ……..(13)…..…(….…..…………...) ของค่าเช่าทั้งหมดตามสัญญา มามอบให้แก่ผู้เช่าเพื่อเป็นหลักประกันการปฏิบัติตามสัญญานี้ ", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("เมื่อครบกำหนดส่งมอบเครื่องถ่ายเอกสารที่เช่าตามสัญญาแล้ว ถ้าผู้ให้เช่าไม่ส่งมอบเครื่องถ่ายเอกสารที่เช่า หรือส่งมอบแต่เพียงบางส่วนให้แก่ผู้เช่า หรือส่งมอบเครื่องถ่ายเอกสารที่เช่าไม่ตรงตามสัญญาหรือมีคุณลักษณะเฉพาะไม่ถูกต้องตามสัญญา หรือส่งมอบแล้วเสร็จภายในกำหนดแต่ไม่สามารถใช้งานได้อย่างมีประสิทธิภาพหรือใช้งานได้ไม่ครบถ้วนตามสัญญา หรือผู้ให้เช่าไม่ปฏิบัติตามสัญญาข้อใดข้อหนึ่ง ผู้เช่ามีสิทธิบอกเลิกสัญญาทั้งหมดหรือแต่บางส่วนได้ การใช้สิทธิบอกเลิกสัญญานั้นไม่กระทบสิทธิของผู้เช่าที่จะเรียกร้องค่าเสียหายจากผู้ให้เช่า", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ในกรณีที่ผู้ให้เช่าไม่ปฏิบัติตามสัญญาข้อใดข้อหนึ่งด้วยเหตุใดๆ ก็ตาม จนเป็นเหตุให้เกิดค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายแก่ผู้เช่า ผู้ให้เช่าต้องชดใช้ค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายดังกล่าวให้แก่ผู้เช่าโดยสิ้นเชิงภายในกำหนด....................(.........................) วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้เช่า หากผู้ให้เช่าไม่ชดใช้ให้ถูกต้องครบถ้วนภายในระยะเวลาดังกล่าวให้ผู้เช่ามีสิทธิที่จะหักเอาจากค่าเช่าที่ต้องชำระหรือบังคับจากหลักประกันการปฏิบัติตามสัญญาได้ทันที", null, "32"));
