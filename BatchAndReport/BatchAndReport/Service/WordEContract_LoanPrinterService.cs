...
public class WordEContract_LoanPrinterService
{
    ...
    public WordEContract_LoanPrinterService(WordServiceSetting ws, Econtract_Report_PMLDAO pml, IConverter pdfConverter, E_ContractReportDAO eContractReportDAO)
    {
        _w = ws;
        _pml = pml;
...
<body>
  ...
  <div class='tab3 t-16'>สัญญาฉบับนี้ทำขึ้น ณ สำนักงานส่งเสริมวิสาหกิจขนาดกลางและขนาดย่อม (สสว.)  ตำบล/แขวง ทุ่งสองห้อง อำเภอ/เขต หลักสี่ จังหวัด กรุงเทพ เมื่อ {datestring} ระหว่าง {result.Contract_Organization} โดย {result.SignatoryName} ตำแหน่ง {result.SignatoryPosition} ซึ่งต่อไปในสัญญานี้เรียกว่า “ผู้เช่า” ฝ่ายหนึ่ง กับ {result.ContractorName}</div>
    {(result.ContractorType == "นิติบุคคล"
                ? $"<div class='t-16'>ซึ่งจดทะเบียนเป็นนิติบุคคล ณ {result.ContractorCompany} มีสำนักงานใหญ่อยู่เลขที่ {result.ContractorAddressNo} ถนน {result.ContractorStreet} ตำบล/แขวง {result.ContractorSubDistrict} อำเภอ/เขต {result.ContractorDistrict} จังหวัด {result.ContractorProvince} รหัสไปรษณีย์ {result.ContractorZipcode} โดย {result.ContractorSignatoryName} ตำแหน่ง {result.ContractorSignatoryPosition} มีอำนาจลงนามผูกพันนิติบุคคลปรากฏตามหนังสือรับรองของสำนักงานทะเบียนหุ้นส่วนบริษัท ลงวันที่ {strContractorAuthDate} (และหนังสือมอบอำนาจเลขที่ {result.ContractorAuthNumber}) แนบท้ายสัญญานี้</div>"
                : $"<div class='t-16'>ในกรณีที่ผู้รับจ้างเป็นบุคคลธรรมดา กับ {result.ContractorName} อยู่บ้านเลขที่ {result.ContractorAddressNo} ถนน {result.ContractorStreet} ตำบล/แขวง {result.ContractorSubDistrict} อำเภอ/เขต {result.ContractorDistrict} จังหวัด {result.ContractorProvince} รหัสไปรษณีย์ {result.ContractorZipcode} ผู้ถือบัตรประจำตัวประชาชนเลขที่ {result.CitizenId} ซึ่งต่อไปในสัญญานี้เรียกว่า “ผู้ให้เช่า” อีกฝ่ายหนึ่ง</div>")}
    <div class='tab3 t-16'>คู่สัญญาได้ตกลงกันมีข้อความดังต่อไปนี้</div>  
    <div class='tab3 t-16'>ข้อ 1 ข้อตกลงเช่า</div>
    <div class='tab3 t-16'>ผู้เช่าตกลงเช่าและผู้ให้เช่าตกลงให้เช่าเครื่องถ่ายเอกสาร ยี่ห้อ {result.RentalCopierBrand} รุ่น {result.RentalCopierModel} หมายเลขเครื่อง {result.RentalCopierNumber} จำนวน {result.RentalCopierAmount} เครื่อง ซึ่งต่อไปในสัญญานี้เรียกว่า “เครื่องถ่ายเอกสารที่เช่า” เพื่อใช้ในกิจการของผู้เช่าตามเอกสารแนบท้ายสัญญา</div>
    <div class='tab3 t-16'>การเช่าเครื่องถ่ายเอกสารที่เช่าตามวรรคหนึ่งมีกำหนดระยะเวลา {result.RentalYears} ปี {result.RentalMonths} เดือน ตั้งแต่ {strStartDate} ถึง {strEndDate}</div>
    <div class='tab3 t-16'>ผู้ให้เช่ารับรองว่าเครื่องถ่ายเอกสารที่เช่าตามสัญญานี้เป็นเครื่องถ่ายเอกสารใหม่ที่ไม่เคยใช้งานมาก่อน ผู้ให้เช่าได้ชำระภาษี อากร ค่าธรรมเนียมต่างๆ ครบถ้วนถูกต้องตามกฎหมายแล้ว ผู้ให้เช่ามีสิทธินำมาให้เช่าโดยปราศจากการรอนสิทธิ ทั้งรับรองว่าเครื่องถ่ายเอกสารที่เช่ามีคุณสมบัติ คุณภาพ และคุณลักษณะไม่ต่ำกว่าที่กำหนดไว้ในเอกสารแนบท้ายสัญญาผนวก และผู้ให้เช่าได้ตรวจสอบแล้วว่าเครื่องถ่ายเอกสารที่เช่าตลอดจนอุปกรณ์ทั้งปวงปราศจากความชำรุดบกพร่อง</div>
    <div class='tab3 t-16'>ข้อ 2 ค่าเช่าเครื่องถ่ายเอกสาร</div>
    <div class='tab3 t-16'>ผู้เช่าตกลงชำระค่าเช่าแก่ผู้ให้เช่าเป็นรายเดือนตามเดือนปฏิทินในอัตราค่าเช่าเดือนละ {result.RatePerUnit} บาท ({strPerUnit}) ต่อเครื่องถ่ายเอกสารหนึ่งเครื่อง รวมเป็นค่าเช่าทั้งสิ้นเดือนละ {result.RateTotal} บาท ({strRateTotal}) โดยประเมินจากจำนวนสำเนาเอกสารที่ถ่ายทั้งสิ้นเดือนละ {result.EstCopiesPerMonth} แผ่น</div>
    <div class='tab3 t-16'>หากเดือนใดจำนวนสำเนาเอกสารที่ผู้เช่าได้ถ่ายจากเครื่องถ่ายเอกสารที่เช่ามีจำนวนทั้งสิ้นไม่ถึง {result.IfNotCopiesAmount} แผ่น การชำระค่าเช่าในเดือนนั้นให้เปลี่ยนเป็นคิดคำนวณจากจำนวนสำเนาเอกสารที่ถ่ายในเดือนนั้นๆ ในอัตราสำเนาแผ่นละ {result.CopiesRate} บาท</div>
    <div class='tab3 t-16'>ค่าเช่าตามวรรคหนึ่งและวรรคสองได้รวมภาษีมูลค่าเพิ่ม ค่าใช้จ่ายในการบำรุงรักษาและซ่อมแซม ค่าตรวจสภาพ ค่าอะไหล่ ค่าวัสดุสิ้นเปลือง (ยกเว้นค่ากระดาษถ่ายเอกสาร) ไว้ด้วยแล้ว</div>
    <div class='tab3 t-16'>ในการชำระค่าเช่า ผู้ให้เช่าต้องส่งใบแจ้งหนี้เรียกเก็บค่าเช่าเมื่อสิ้นเดือนแต่ละเดือน โดยผู้เช่าจะชำระค่าเช่าหลังจากที่ได้ตรวจสอบแล้วว่าถูกต้อง</div>
    <div class='tab3 t-16'>การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้เช่าจะโอนเงินเข้าบัญชีเงินฝากธนาคารของผู้ให้เช่า ชื่อธนาคาร {result.SaleBankName} สาขา {result.SaleBankBranch} ชื่อบัญชี {result.SaleBankAccountName} เลขที่บัญชี {result.SaleBankAccountNumber} ทั้งนี้ ผู้ให้เช่าตกลงเป็นผู้รับภาระเงินค่าธรรมเนียม หรือค่าบริการอื่นใดเกี่ยวกับการโอน รวมทั้งค่าใช้จ่ายอื่นใด (ถ้ามี) ที่ธนาคารเรียกเก็บ และยินยอมให้มีการหักเงินดังกล่าวจากจำนวนเงินโอนในงวดนั้นๆ</div>
    <div class='tab3 t-16'>ข้อ 3 เอกสารอันเป็นส่วนหนึ่งของสัญญา</div>
    <div class='tab3 t-16'>เอกสารแนบท้ายสัญญาดังต่อไปนี้ให้ถือเป็นส่วนหนึ่งของสัญญานี้</div>
    <div class='tab3 t-16'>3.1 ผนวก 1 (ใบเสนอราคา) จำนวน ... หน้า</div>
    <div class='tab3 t-16'>3.2 ผนวก 2 (แค็ตตาล็อก คุณลักษณะและรายละเอียดของเครื่องถ่ายเอกสารที่เช่า) จำนวน ... หน้า</div>
    <div class='tab3 t-16'>3.3 ผนวก 3 (กำหนดการบำรุงรักษา) จำนวน ... หน้า</div>
    <div class='tab3 t-16'>ความใดในเอกสารแนบท้ายสัญญาที่ขัดหรือแย้งกับข้อความในสัญญานี้ ให้ใช้ข้อความในสัญญานี้บังคับ และในกรณีที่เอกสารแนบท้ายสัญญาขัดแย้งกันเอง ผู้ให้เช่าจะต้องปฏิบัติตามคำวินิจฉัยของผู้เช่า คำวินิจฉัยของผู้เช่าให้ถือเป็นที่สุด และผู้ให้เช่าไม่มีสิทธิเรียกร้องค่าเช่า ค่าเสียหาย หรือค่าใช้จ่ายใดๆ เพิ่มเติมจากผู้เช่าทั้งสิ้น</div>
    <div class='tab3 t-16'>ข้อ 4 การส่งมอบ</div>
    <div class='tab3 t-16'>ผู้ให้เช่าต้องส่งมอบและติดตั้งเครื่องถ่ายเอกสารที่เช่าตามสัญญานี้ ให้ถูกต้องครบถ้วนตามสัญญานี้ ในลักษณะพร้อมใช้งานได้ตามที่กำหนด ณ {result.DeliveryLocation} ภายในวันที่ {CommonDAO.ToThaiDateStringCovert(result.DeliveryDate ?? DateTime.Now)} ซึ่งผู้ให้เช่าเป็นผู้จัดหาอุปกรณ์ประกอบ พร้อมทั้งเครื่องมือที่จำเป็นในการติดตั้งและใช้งาน โดยผู้ให้เช่าเป็นผู้ออกค่าใช้จ่ายเองทั้งสิ้น</div>
    <div class='tab3 t-16'>ผู้ให้เช่าต้องแจ้งเวลาติดตั้งแล้วเสร็จพร้อมที่จะใช้งานและส่งมอบเครื่องได้เป็นหนังสือ ต่อผู้เช่า ณ {result.DeliveryLocation} ในวันและเวลาทำการของผู้เช่าก่อนวันกำหนดส่งมอบตามวรรคหนึ่งไม่น้อยกว่า {result.DeliveryType} วันทำการของผู้เช่า</div>
    <div class='tab3 t-16'>ในการส่งมอบตามวรรคหนึ่ง ผู้ให้เช่าต้องส่งพนักงานมาดำเนินการทดสอบประสิทธิภาพและแนะนำวิธีการใช้เครื่องให้คณะกรรมการตรวจรับพัสดุได้พิจารณาตามรายละเอียดคุณลักษณะเฉพาะที่ระบุไว้ในข้อ 1 และสำเนาที่ถ่ายจะต้องมีความชัดเจนสะอาด ไม่มีรอยหมึกเปื้อนตามส่วนต่างๆ โดยในการนี้ผู้ให้เช่าไม่คิดค่าใช้จ่ายใดๆ จากผู้เช่าทั้งสิ้น</div>
    <div class='tab3 t-16'>ข้อ 5 การตรวจรับ</div>
    <div class='tab3 t-16'>เมื่อผู้เช่าได้ตรวจรับเครื่องถ่ายเอกสารที่ส่งมอบตามข้อ 4 และเห็นว่าถูกต้องครบถ้วนตามสัญญานี้แล้ว ผู้เช่าจะออกหลักฐานการรับมอบเครื่องถ่ายเอกสารที่เช่าไว้เป็นหนังสือ เพื่อผู้ให้เช่านำมาใช้เป็นหลักฐานประกอบการขอรับเงินค่าเช่า</div>
    <div class='tab3 t-16'>ในการตรวจรับเครื่องถ่ายเอกสารที่ส่งมอบตามวรรคหนึ่ง ถ้าปรากฏว่าเครื่องถ่ายเอกสารซึ่งผู้ให้เช่าส่งมอบไม่ถูกต้องครบถ้วนตามสัญญา หรือติดตั้งและส่งมอบถูกต้องครบถ้วนภายในกำหนดแต่ไม่สามารถใช้งานได้อย่างครบถ้วนและมีประสิทธิภาพตามสัญญา ผู้เช่าทรงไว้ซึ่งสิทธิที่จะไม่รับเครื่องถ่ายเอกสารนั้น ในกรณีเช่นว่านี้ ผู้ให้เช่าต้องรีบนำเครื่องถ่ายเอกสารนั้นกลับคืนไปทันที และต้องนำเครื่องถ่ายเอกสารเครื่องใหม่ที่มีคุณสมบัติเดียวกัน หรือไม่ต่ำกว่าเครื่องถ่ายเอกสารที่กำหนดไว้ในสัญญานี้ มาส่งมอบให้ใหม่ ภายใน {result.TotalDay} วัน ด้วยค่าใช้จ่ายของผู้ให้เช่าเองทั้งสิ้น และระยะเวลาที่เสียไปเพราะเหตุดังกล่าว ผู้ให้เช่าจะนำมาอ้างเป็นเหตุของดหรือลดค่าปรับหรือขยายเวลาส่งมอบไม่ได้</div>
    <div class='tab3 t-16'>หากผู้ให้เช่าไม่นำเครื่องถ่ายเอกสารที่ส่งมอบไม่ถูกต้องกลับคืนไปในทันทีดังกล่าวในวรรคสอง และเกิดความเสียหายแก่เครื่องถ่ายเอกสารนั้น ผู้เช่าไม่ต้องรับผิดชอบในความเสียหายดังกล่าว</div>
    <div class='tab3 t-16'>ในกรณีที่ผู้ให้เช่าส่งมอบเครื่องถ่ายเอกสารที่เช่าถูกต้องแต่ไม่ครบจำนวน หรือส่งมอบครบจำนวนแต่ไม่ถูกต้องทั้งหมด ผู้เช่ามีสิทธิจะรับมอบเฉพาะส่วนที่ถูกต้อง โดยออกหลักฐานการรับมอบเฉพาะส่วนนั้นก็ได้ ในกรณีเช่นนี้ผู้เช่าจะชำระค่าเช่าเฉพาะเครื่องถ่ายเอกสารที่เช่าที่รับมอบไว้</div>
    <div class='tab3 t-16'>ข้อ 6 การงดหรือลดค่าปรับ หรือขยายเวลาในการปฏิบัติตามสัญญา</div>
    <div class='tab3 t-16'>ในกรณีที่ผู้ให้เช่าไม่สามารถส่งมอบเครื่องถ่ายเอกสารที่เช่าให้แก่ผู้เช่าได้โดยครบถ้วนถูกต้องภายในกำหนดเวลาตามสัญญา หรือถ้าผู้ให้เช่าไม่ดำเนินการหรือไม่สามารถซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าภายในระยะเวลาตามข้อ 8.2 และผู้ให้เช่าไม่จัดหาเครื่องถ่ายเอกสารให้ผู้เช่าใช้แทนตามข้อ 8.3 อันเนื่องมาจากเหตุสุดวิสัย หรือเหตุใดๆ อันเนื่องมาจากความผิดหรือความบกพร่องของฝ่ายผู้เช่าหรือจากพฤติการณ์อันหนึ่งอันใดที่ผู้ให้เช่าไม่ต้องรับผิดตามกฎหมาย หรือเหตุอื่นตามที่กำหนดในกฎกระทรวง ซึ่งออกตามความในกฎหมายว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ ผู้ให้เช่ามีสิทธิของดหรือลดค่าปรับหรือขยายกำหนดเวลาทำการตามสัญญาดังกล่าว โดยจะต้องแจ้งเหตุหรือพฤติการณ์ดังกล่าวพร้อมหลักฐานเป็นหนังสือให้ผู้เช่าทราบภายใน 15 วัน นับถัดจากวันที่เหตุนั้นสิ้นสุดลงหรือตามที่กำหนดในกฎกระทรวงดังกล่าว แล้วแต่กรณี</div>
    <div class='tab3 t-16'>ถ้าผู้ให้เช่าไม่ปฏิบัติให้เป็นไปตามความในวรรคหนึ่ง ให้ถือว่าผู้ให้เช่าได้สละสิทธิเรียกร้องในการที่จะของดหรือลดค่าปรับหรือขยายเวลาทำการตามสัญญาโดยไม่มีเงื่อนไขใดๆ ทั้งสิ้น เว้นแต่กรณีเหตุเกิดจากความผิดหรือความบกพร่องของฝ่ายผู้เช่าซึ่งมีหลักฐานชัดแจ้ง หรือผู้เช่าทราบดีอยู่แล้วตั้งแต่ต้น</div>
    <div class='tab3 t-16'>การงดหรือลดค่าปรับหรือขยายกำหนดเวลาทำการตามสัญญาตามวรรคหนึ่ง อยู่ในดุลพินิจของผู้เช่าที่จะพิจารณาตามที่เห็นสมควร</div>
    <div class='tab3 t-16'>ข้อ 7 การบำรุงรักษาตรวจสภาพและซ่อมแซมเครื่องถ่ายเอกสารที่เช่า</div>
    <div class='tab3 t-16'>ผู้ให้เช่ามีหน้าที่บำรุงรักษาเครื่องถ่ายเอกสารที่เช่าให้อยู่ในสภาพใช้งานได้ดีอยู่เสมอด้วยค่าใช้จ่ายของผู้ให้เช่า โดยต้องจัดหาช่างผู้มีความรู้ ความชำนาญ และฝีมือดีมาตรวจสอบ บำรุงรักษาและซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าตลอดอายุสัญญาเช่านี้ อย่างน้อยเดือนละ {result.MaintenancePermonth} ครั้ง โดยให้มีระยะเวลาห่างกันไม่น้อยกว่า {result.MaintenanceInterval} วัน</div>
    <div class='tab3 t-16'>สิ่งของที่ใช้สิ้นเปลืองทุกชนิดรวมทั้งอะไหล่ ยกเว้นกระดาษสำหรับถ่ายเอกสาร ผู้ให้เช่าจะเป็นผู้จัดส่งให้โดยไม่คิดมูลค่า โดยที่ผู้ให้เช่าจะจัดให้มีไว้ในความครอบครองของผู้เช่าให้เพียงพออยู่เสมอ อุปกรณ์สิ้นเปลืองดังกล่าว เช่น ลูกโม่ถ่ายภาพ ผงหมึก ผงประจุภาพ หมึกพิมพ์ วัสดุที่ใช้ทำความสะอาดถุงกรอง แปรง น้ำมันหล่อลื่น และอุปกรณ์อื่นๆ ที่จำเป็นเพื่อให้เครื่องถ่ายเอกสารใช้งานได้ตามปกติตลอดเวลา</div>
    <div class='tab3 t-16'>ข้อ 8 หน้าที่ของผู้ให้เช่า</div>
    <div class='tab3 t-16'>8.1 ผู้ให้เช่ามีหน้าที่ฝึกอบรมวิธีใช้เครื่องถ่ายเอกสารที่เช่าให้แก่เจ้าหน้าที่ของผู้เช่า จนสามารถใช้งานเครื่องถ่ายเอกสารได้ และผู้ให้เช่าตกลงจะฝึกอบรมวิธีการใช้เครื่องถ่ายเอกสารที่เช่าให้แก่เจ้าหน้าที่ของผู้เช่าทุกครั้ง หากผู้เช่าร้องขอโดยเหตุที่มีการเปลี่ยนแปลงโยกย้ายเจ้าหน้าที่ของผู้เช่าและเจ้าหน้าที่คนนั้นยังไม่เคยได้รับการฝึกอบรมมาก่อนโดยผู้ให้เช่าเป็นผู้รับผิดชอบค่าใช้จ่ายในการฝึกอบรมทั้งสิ้น</div>
    <div class='tab3 t-16'>8.2 ในกรณีเครื่องถ่ายเอกสารที่เช่าชำรุดบกพร่องหรือขัดข้องใช้งานไม่ได้ตามปกติ ผู้ให้เช่าจะต้องจัดให้ช่างที่มีความรู้ความชำนาญและฝีมือดีมาจัดการซ่อมแซมแก้ไขให้อยู่ในสภาพใช้งานได้ดีตามปกติ โดยผู้ให้เช่าจะต้องเริ่มจัดการซ่อมแซมแก้ไขในทันทีที่ได้รับแจ้งจากผู้เช่าหรือผู้ที่ได้รับมอบหมายจากผู้เช่าแล้ว และให้แล้วเสร็จใช้งานได้ดีดังเดิมอย่างช้าต้องไม่เกิน {result.CopierFixDays} ชั่วโมง ตั้งแต่เวลาที่ได้รับแจ้ง</div>
    <div class='tab3 t-16'>8.3 ในกรณีที่เครื่องถ่ายเอกสารที่เช่ามีความชำรุดบกพร่องหรือขัดข้องใช้งานไม่ได้ตามปกติ และการซ่อมแซมต้องใช้เวลาเกินกว่า {result.ReplaceFixDays} ชั่วโมง ตามที่กำหนดในข้อ 8.2 หรือไม่อาจซ่อมแซมแก้ไขให้ดีได้ดังเดิม ผู้ให้เช่าต้องจัดหาเครื่องถ่ายเอกสารที่มีคุณสมบัติ คุณภาพ ความสามารถ และประสิทธิภาพในการใช้งานไม่ต่ำกว่าของเครื่องเดิมมาให้ผู้เช่าใช้แทนทันที</div>
    <div class='tab3 t-16'>ข้อ 9 ค่าปรับกรณีความชำรุดบกพร่องของเครื่องถ่ายเอกสาร</div>
    <div class='tab3 t-16'>ถ้าผู้ให้เช่าไม่ดำเนินการหรือไม่สามารถซ่อมแซมแก้ไขเครื่องถ่ายเอกสารที่เช่าภายในระยะเวลาตามข้อ 8.2 และผู้ให้เช่าไม่จัดหาเครื่องถ่ายเอกสารให้ผู้เช่าใช้แทนตามข้อ 8.3 ผู้ให้เช่ายินยอมให้ผู้เช่าปรับเป็นรายวัน ในอัตราวันละ {result.FinePerDays} บาท ({strFinePerDays}) ต่อเครื่อง ตั้งแต่พ้นกำหนดระยะเวลาตามข้อ 8.2 จนถึงวันที่ผู้ให้เช่าซ่อมแซมแก้ไขให้อยู่ในสภาพใช้งานได้ดีตามปกติ หรือผู้ให้เช่าจัดหาเครื่องถ่ายเอกสารมาให้ผู้เช่าใช้งานแทน หรือจนกว่าผู้เช่าจะใช้สิทธิบอกเลิกสัญญา ทั้งนี้ ผู้เช่าไม่ต้องจ่ายค่าเช่าในระหว่างเวลาที่ผู้เช่าไม่สามารถใช้เครื่องถ่ายเอกสารที่เช่าตามสัญญานี้ โดยยินยอมให้ผู้เช่าหักค่าปรับดังกล่าวออกจากค่าเช่าตามข้อ 2 หรือบังคับเอาจากหลักประกันตามข้อ 10 ก็ได้</div>
    <div class='tab3 t-16'>ข้อ 10 หลักประกันการปฏิบัติตามสัญญา</div>
    <div class='tab3 t-16'>ในขณะทำสัญญานี้ผู้ให้เช่าได้นำหลักประกันเป็น {result.GuaranteeType} เป็นจำนวนเงิน {result.GuaranteeAmount} บาท ({strGuaranteeAmount}) ซึ่งเท่ากับร้อยละ {result.GuaranteePercent} ของค่าเช่าทั้งหมดตามสัญญา มามอบให้แก่ผู้เช่าเพื่อเป็นหลักประกันการปฏิบัติตามสัญญานี้</div>
    <div class='tab3 t-16'>กรณีผู้ให้เช่าใช้หนังสือค้ำประกันมาเป็นหลักประกันการปฏิบัติตามสัญญา หนังสือค้ำประกันดังกล่าวจะต้องออกโดยธนาคารที่ประกอบกิจการในประเทศไทย หรือโดยบริษัทเงินทุนหรือบริษัทเงินทุนหลักทรัพย์ที่ได้รับอนุญาตให้ประกอบกิจการเงินทุนเพื่อการพาณิชย์และประกอบธุรกิจค้ำประกันตามประกาศของธนาคารแห่งประเทศไทย ตามรายชื่อบริษัทเงินทุนที่ธนาคารแห่งประเทศไทยแจ้งเวียนให้ทราบตามแบบที่คณะกรรมการนโยบายการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐกำหนด หรืออาจเป็นหนังสือค้ำประกันอิเล็กทรอนิกส์ตามวิธีการที่กรมบัญชีกลางกำหนดก็ได้ และจะต้องมีอายุการค้ำประกันตลอดไปจนกว่าผู้ให้เช่าพ้นข้อผูกพันตามสัญญานี้</div>
    <div class='tab3 t-16'>หลักประกันที่ผู้ให้เช่านำมามอบให้ตามวรรคหนึ่ง จะต้องมีอายุครอบคลุมความรับผิดทั้งปวงของผู้ให้เช่าตลอดอายุสัญญา ถ้าหลักประกันที่ผู้ให้เช่านำมามอบให้ดังกล่าวลดลงหรือเสื่อมค่าลง หรือมีอายุไม่ครอบคลุมถึงความรับผิดของผู้ให้เช่าตลอดอายุสัญญา ไม่ว่าด้วยเหตุใดๆ ก็ตาม รวมถึงกรณีผู้ให้เช่าส่งมอบและติดตั้งเครื่องถ่ายเอกสารล่าช้าเป็นเหตุให้ระยะเวลาการเช่าตามสัญญาเปลี่ยนแปลงไป ผู้ให้เช่าต้องหาหลักประกันใหม่หรือหลักประกันเพิ่มเติมให้มีจำนวนครบถ้วนตามวรรคหนึ่งมามอบให้แก่ผู้เช่าภายใน {result.NewGuaranteeDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้เช่า</div>
    <div class='tab3 t-16'>หลักประกันที่ผู้ให้เช่านำมามอบไว้ตามข้อนี้ ผู้เช่าจะคืนให้แก่ผู้ให้เช่าโดยไม่มีดอกเบี้ยเมื่อผู้ให้เช่าพ้นจากข้อผูกพันและความรับผิดทั้งปวงตามสัญญานี้แล้ว</div>
    <div class='tab3 t-16'>ข้อ 11 การบอกเลิกสัญญา</div>
    <div class='tab3 t-16'>เมื่อครบกำหนดส่งมอบเครื่องถ่ายเอกสารที่เช่าตามสัญญาแล้ว ถ้าผู้ให้เช่าไม่ส่งมอบเครื่องถ่ายเอกสารที่เช่า หรือส่งมอบแต่เพียงบางส่วนให้แก่ผู้เช่า หรือส่งมอบเครื่องถ่ายเอกสารที่เช่าไม่ตรงตามสัญญาหรือมีคุณลักษณะเฉพาะไม่ถูกต้องตามสัญญา หรือส่งมอบแล้วเสร็จภายในกำหนดแต่ไม่สามารถใช้งานได้อย่างมีประสิทธิภาพหรือใช้งานได้ไม่ครบถ้วนตามสัญญา หรือผู้ให้เช่าไม่ปฏิบัติตามสัญญาข้อใดข้อหนึ่ง ผู้เช่ามีสิทธิบอกเลิกสัญญาทั้งหมดหรือแต่บางส่วนได้ การใช้สิทธิบอกเลิกสัญญานั้นไม่กระทบสิทธิของผู้เช่าที่จะเรียกร้องค่าเสียหายจากผู้ให้เช่า</div>
    <div class='tab3 t-16'>ในกรณีที่ผู้เช่าใช้สิทธิบอกเลิกสัญญา ผู้เช่ามีสิทธิริบหรือบังคับจากหลักประกัน ตามข้อ 10 เป็นจำนวนเงินทั้งหมดหรือแต่บางส่วนก็ได้แล้วแต่ผู้เช่าจะเห็นสมควร และถ้าผู้เช่าต้องเช่าเครื่องถ่ายเอกสารจากบุคคลอื่นทั้งหมดหรือแต่บางส่วนภายในกำหนด {result.TeminationReplaceDays} เดือน นับถัดจากวันบอกเลิกสัญญา ผู้ให้เช่ายอมรับผิดชดใช้ค่าเช่าที่เพิ่มขึ้นจากค่าเช่าที่กำหนดไว้ในสัญญานี้ รวมทั้งค่าใช้จ่ายใดๆ ที่ผู้เช่าต้องใช้จ่ายในการจัดหาผู้ให้เช่าเครื่องถ่ายเอกสารที่เช่ารายใหม่ดังกล่าวด้วย</div>
    <div class='tab3 t-16'>ในกรณีมีความจำเป็น ผู้เช่ามีสิทธิที่จะบอกเลิกสัญญาเช่านี้ก่อนครบกำหนดระยะเวลาการเช่าได้ โดยแจ้งเป็นหนังสือให้ผู้ให้เช่าทราบล่วงหน้าไม่น้อยกว่า 30 วัน โดยผู้ให้เช่าจะไม่มีสิทธิเรียกร้องค่าเสียหายใดๆ จากผู้เช่า</div>
    <div class='tab3 t-16'>ข้อ 12 ค่าปรับกรณีส่งมอบล่าช้า</div>
    <div class='tab3 t-16'>ในกรณีที่ผู้ให้เช่าส่งมอบเครื่องถ่ายเอกสารที่เช่าล่วงเลยกำหนดส่งมอบตามข้อ 4 และผู้เช่ามิได้ใช้สิทธิบอกเลิกสัญญาตามข้อ 11 วรรคหนึ่ง ผู้ให้เช่าจะต้องชำระค่าปรับให้ผู้เช่าเป็นรายวัน สำหรับเครื่องถ่ายเอกสารที่ยังไม่ได้ส่งมอบตามสัญญา ในอัตราวันละ {result.LateFinePerDays} บาท ({strLate}) ต่อเครื่อง นับถัดจากวันที่ครบกำหนดส่งมอบตามสัญญาจนถึงวันที่ผู้ให้เช่าได้นำเครื่องถ่ายเอกสารที่เช่ามาส่งมอบให้แก่ผู้เช่าจนถูกต้องครบถ้วน</div>
    <div class='tab3 t-16'>ในระหว่างที่ผู้เช่ายังมิได้ใช้สิทธิบอกเลิกสัญญานั้น หากผู้เช่าเห็นว่าผู้ให้เช่าไม่อาจปฏิบัติตามสัญญาต่อไปได้ ผู้เช่าจะใช้สิทธิบอกเลิกสัญญา และบังคับจากหลักประกันการปฏิบัติตามสัญญาตามข้อ 10 กับเรียกร้องให้ชดใช้ค่าเช่าที่เพิ่มขึ้นตามที่กำหนดไว้ในข้อ 11 วรรคสองก็ได้ และถ้าผู้เช่าได้แจ้งข้อเรียกร้องให้ชำระค่าปรับไปยังผู้ให้เช่าเมื่อครบกำหนดส่งมอบดังกล่าวแล้ว ผู้เช่ามีสิทธิที่จะปรับผู้ให้เช่าจนถึงวันบอกเลิกสัญญาได้อีกด้วย</div>
    <div class='tab3 t-16'>ข้อ 13 การบังคับค่าปรับ ค่าเสียหาย และค่าใช้จ่าย</div>
    <div class='tab3 t-16'>ในกรณีที่ผู้ให้เช่าไม่ปฏิบัติตามสัญญาข้อใดข้อหนึ่งด้วยเหตุใดๆ ก็ตาม จนเป็นเหตุให้เกิดค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายแก่ผู้เช่า ผู้ให้เช่าต้องชดใช้ค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายดังกล่าวให้แก่ผู้เช่าโดยสิ้นเชิงภายในกำหนด {result.EnforcementOfFineDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้เช่า หากผู้ให้เช่าไม่ชดใช้ให้ถูกต้องครบถ้วนภายในระยะเวลาดังกล่าวให้ผู้เช่ามีสิทธิที่จะหักเอาจากค่าเช่าที่ต้องชำระหรือบังคับจากหลักประกันการปฏิบัติตามสัญญาได้ทันที</div>
    <div class='tab3 t-16'>หากค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายที่บังคับจากค่าเช่าที่ต้องชำระ หรือหลักประกันการปฏิบัติตามสัญญาแล้วยังไม่เพียงพอ ผู้ให้เช่ายินยอมชำระส่วนที่เหลือที่ยังขาดอยู่จนครบถ้วนตามจำนวนค่าปรับ ค่าเสียหาย หรือค่าใช้จ่ายนั้น ภายในกำหนด {result.OutstandingPeriodDays} วัน นับถัดจากวันที่ได้รับแจ้งเป็นหนังสือจากผู้เช่า</div>
    <div class='tab3 t-16'>ข้อ 14 การโอนสิทธิของผู้ให้เช่า</div>
    <div class='tab3 t-16'>ในระหว่างอายุสัญญาเช่า ห้ามผู้ให้เช่าโอนสิทธิหน้าที่ตามสัญญาหรือกรรมสิทธิ์ในเครื่องถ่ายเอกสารที่เช่าแก่บุคคลอื่น เว้นแต่จะได้รับความยินยอมเป็นหนังสือจากผู้เช่าก่อน</div>
    <div class='tab3 t-16'>ข้อ 15 การนำเครื่องถ่ายเอกสารที่เช่ากลับคืนเมื่อสัญญาสิ้นสุดลง</div>
    <div class='tab3 t-16'>เมื่อสัญญาสิ้นสุดลงไม่ว่าจะเป็นการบอกเลิกสัญญาหรือครบกำหนดเวลาตามสัญญา ผู้ให้เช่าต้องนำเครื่องถ่ายเอกสารที่เช่ากลับคืนไปภายใน {result.CopierSendBackDays} วัน โดยผู้ให้เช่าเป็นผู้เสียค่าใช้จ่ายเองทั้งสิ้น</div>
    <div class='tab3 t-16'>ถ้าผู้ให้เช่าไม่นำเครื่องถ่ายเอกสารที่เช่ากลับคืนไปภายในกำหนดเวลาตามวรรคหนึ่ง ผู้เช่าไม่ต้องรับผิดชอบในความเสียหายใดๆ ทั้งสิ้นที่เกิดแก่เครื่องถ่ายเอกสารที่เช่าอันมิใช่ความผิดของผู้เช่า</div>
    <div class='tab3 t-16'>ข้อ 16 ข้อจำกัดความรับผิดของผู้เช่า</div>
    <div class='tab3 t-16'>ผู้เช่าไม่ต้องรับผิดในความเสียหายหรือสูญหายเมื่อเกิดอัคคีภัยหรือภัยพิบัติใดๆ หรือการโจรกรรมเครื่องถ่ายเอกสารที่เช่าตลอดจนการสูญหายหรือความเสียหายใดๆ ที่เกิดขึ้นแก่เครื่องถ่ายเอกสารที่เช่าอันไม่ใช่เกิดจากความผิดของผู้เช่าตลอดระยะเวลาที่เครื่องถ่ายเอกสารอยู่ในความครอบครองของผู้เช่า</div>
    <div class='tab3 t-16'>สัญญานี้ทำขึ้นสองฉบับมีข้อความถูกต้องตรงกัน คู่สัญญาได้อ่านและเข้าใจข้อความโดยละเอียดตลอดแล้ว จึงได้ลงลายมือชื่อ พร้อมประทับตรา (ถ้ามี) ไว้เป็นสำคัญต่อหน้าพยาน และคู่สัญญาต่างยึดถือไว้คนละหนึ่งฉบับ</div>
...
{signatoryHtml}
    ...
    <div style='page-break-before: always;'></div>
     <div class='tab2 t-16'>วิธีปฏิบัติเกี่ยวกับสัญญาเช่าเครื่องถ่ายเอกสาร</div>
     ...
     <div class='tab2 t-16'>(4) ให้ระบุชื่อผู้ให้เช่า</div>
    ...
    <div class='tab3 t-16'>ข. กรณีบุคคลธรรมดา ให้ระบุชื่อและที่อยู่</div>
     ...
     <div class='tab2 t-16'>(7) หน่วยงานของรัฐอาจกำหนดเงื่อนไขการจ่ายค่าเช่าให้แตกต่างไปจากแบบสัญญาที่กำหนดได้ตามความเหมาะสมและจำเป็นและไม่ทำให้หน่วยงานของรัฐเสียเปรียบ หากหน่วยงานของรัฐเห็นว่าจะมีปัญหาในทางเสียเปรียบหรือไม่รัดกุมพอ ก็ให้ส่งร่างสัญญานั้นไปให้สำนักงานอัยการสูงสุดพิจารณาให้ความเห็นชอบก่อน</div>
     <div class='tab2 t-16'>(8) เป็นข้อความหรือเงื่อนไขเพิ่มเติม ซึ่งหน่วยงานของรัฐผู้ทำสัญญาอาจเลือกใช้หรือตัดออกได้ตามข้อเท็จจริง</div>
     <div class='tab2 t-16'>(9) ชื่อสถานที่หน่วยงานของรัฐ</div>
     <div class='tab2 t-16'>(10) ให้พิจารณาถึงความจำเป็นและเหมาะสมของการใช้งาน</div>
     <div class='tab2 t-16'>(11) อัตราค่าปรับตามสัญญาข้อ 9 ให้กำหนดเป็นรายวันในอัตราระหว่างร้อยละ 0.01 – 0.20 ตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. 2560 ข้อ 162 ส่วนกรณีจะปรับร้อยละเท่าใด ให้อยู่ในดุลยพินิจของหน่วยงานของรัฐผู้เช่าที่จะพิจารณา โดยคำนึงถึงราคาและลักษณะของพัสดุที่เช่า ซึ่งอาจมีผลกระทบต่อการที่ผู้ให้เช่าจะหลีกเลี่ยงไม่ปฏิบัติตามสัญญา แต่ทั้งนี้การที่จะกำหนดค่าปรับเป็นร้อยละเท่าใดจะต้องกำหนดไว้ในเอกสารเชิญชวนด้วย</div>
     <div class='tab2 t-16'>(12) “หลักประกัน” หมายถึง หลักประกันที่ผู้ให้เช่านำมามอบไว้แก่หน่วยงานของรัฐ เมื่อลงนามในสัญญา เพื่อเป็นการประกันความเสียหายที่อาจจะเกิดขึ้นจากการปฏิบัติตามสัญญา ดังนี้</div>
    <div class='tab3 t-16'>(๑) เงินสด</div>
    <div class='tab3 t-16'>(๒) เช็คหรือดราฟท์ ที่ธนาคารเซ็นสั่งจ่าย ซึ่งเป็นเช็คหรือดราฟท์ลงวันที่ที่ใช้เช็คหรือดราฟท์นั้นชำระต่อเจ้าหน้าที่ หรือก่อนวันนั้นไม่เกิน 3 วันทำการ</div>
    <div class='tab3 t-16'>(๓) หนังสือคํ้าประกันของธนาคารภายในประเทศตามตัวอย่างที่คณะกรรมการนโยบายกำหนด โดยอาจเป็นหนังสือค้ำประกันอิเล็กทรอนิกส์ตามวิธีการที่กรมบัญชีกลางกำหนดก็ได้</div>
    ...
    <div class='tab3 t-16'>(๕) พันธบัตรรัฐบาลไทย</div>
     <div class='tab2 t-16'>(13) ให้กำหนดจำนวนเงินหลักประกันการปฏิบัติตามสัญญาตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. 2560 ข้อ 168</div>
     <div class='tab2 t-16'>(14) เป็นข้อความหรือเงื่อนไขเพิ่มเติม ซึ่งหน่วยงานของรัฐผู้ทำสัญญาอาจเลือกใช้หรือตัดออกได้ตามข้อเท็จจริง</div>
     <div class='tab2 t-16'>(15) กำหนดระยะเวลาตามความเหมาะสม เช่น 3 เดือน</div>
    <div class='tab3 t-16'>(16) อัตราค่าปรับตามสัญญาข้อ 12 ให้กำหนดเป็นรายวันในอัตราระหว่างร้อยละ 0.01 – 0.20 ตามระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. 2560 ข้อ 162 ส่วนกรณีจะปรับร้อยละเท่าใด ให้อยู่ในดุลยพินิจของหน่วยงานของรัฐผู้เช่าที่จะพิจารณา โดยคำนึงถึงราคาและลักษณะของพัสดุที่เช่า ซึ่งอาจมีผลกระทบต่อการที่ผู้ให้เช่าจะหลีกเลี่ยงไม่ปฏิบัติตามสัญญา แต่ทั้งนี้การที่จะกำหนดค่าปรับเป็นร้อยละเท่าใดจะต้องกำหนดไว้ในเอกสารเชิญชวนด้วย</div>
</body>
</html>
";
