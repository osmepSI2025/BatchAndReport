...
{(conPurpose != null && conPurpose.Count > 0
    ? string.Join("", conPurpose.Select(p => $"<div class='tab4 t-16'>{p.Objective_Description}</div>"))
    : "<div class='tab3 t-16'>- ไม่มีข้อมูลวัตถุประสงค์ -</div>")}

<div class='tab3 t-16'>ข้อตกลง</div>
{(conAgreement != null && conAgreement.Count > 0
    ? string.Join("", conAgreement.Select(a => $"<div class='tab4 t-16'>{a.PD_Detail}</div>"))
    : "<div class='tab3 t-16'>- ไม่มีข้อมูลข้อตกลง -</div>")}
<div class='tab3 t-16'>
