...
<head>
    ...
    <div class='t-16 text-center'><b>บันทึกข้อตกลงเลขที่ {dataResult.Contract_Number}</b></div>
...
<p class='t-16 tab3'><b>ข้อ ๑.ข้อตกลงว่าจ้าง</b></p>
  <P class='t-16 tab3'>จ้างและผู้รับจ้างตกลงรับจ้างเหมาบริการ {dataResult.HiringAgreement}
...
ทั้งนี้ ผู้รับจ้างไม่มีสิทธิเรียกร้องค่าเสียหายหรือค่าใช้จ่ายใดๆ ทั้งสิ้น
    ...
    <p class='t-16 tab4'>ผู้ว่าจ้างตกลงจ่ายและผู้รับจ้างตกลงรับเงินค่าจ้างจำนวนเงิน  {dataResult.HiringAmount} บาท( {CommonDAO.NumberToThaiText(dataResult.HiringAmount ?? 0)} )
...
ซึ่งมีรายละเอียดของงานปรากฏตามเอกสารแนบท้ายบันทึกข้อตกลง และผู้ว่าจ้างได้ตรวจรับงานจ้างไว้โดยครบถ้วนแล้ว</p>
   <P class='t-16 tab4'>ทั้งนี้ หากเดือนใดมีการปฏิบัติงานไม่เต็มเดือนปฏิทิน ให้คิดค่าจ้างเหมาเป็นรายวัน ในอัตราวันละ {dataResult.DailyRate} บาท  ( {CommonDAO.NumberToThaiText(dataResult.DailyRate ?? 0)} ) </P>
...
รวมทั้งค่าใช้จ่ายอื่นใด (ถ้ามี) ที่ธนาคารเรียกเก็บ และยินยอมให้มีการหักเงินดังกล่าวจากจำนวนเงินโอนในงวด</P>
  ...
  <P class='t-16 tab3'><b>ข้อ ๔.กำหนดเวลาแล้วเสร็จและสิทธิของผู้ว่าจ้างในการบอกเลิกบันทึกข้อตกลง</b></P>
    <p class='t-16 tab4'>ผู้รับจ้างต้องเริ่มทำงานที่รับจ้างภายในวันที่  {dataResult.WorkStartDate.Value.ToString("dd/MM/yyyy")} และจะต้องทำงานให้แล้วเสร็จบริบูรณ์ภายในวันที่ {dataResult.WorkEndDate.Value.ToString("dd/MM/yyyy")}
