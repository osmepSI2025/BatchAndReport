...
.logo-table {{ width: 100%; border-collapse: collapse; margin-top: 40px; }}
    ...
    <div class='t-22 text-center'><b>จ้างเหมาบริการ {dataResult.ServiceName} </b></div>
    <div class='t-14 text-center'><b>บันทึกข้อตกลงเลขที่ {dataResult.Contract_Number}</b></div>
...
<p class='t-14 tab3'><b>ข้อ ๑.ข้อตกลงว่าจ้าง</b></p>
  <P class='t-14 tab3'>จ้างและผู้รับจ้างตกลงรับจ้างเหมาบริการ {dataResult.HiringAgreement}
ตามข้อกำหนดและเงื่อนไขของบันทึกข้อตกลงนี้รวมทั้งเอกสารแนบท้ายบันทึกข้อตกลง
    </P>
    <P class='t-14 tab3'><b>ข้อ ๒.เอกสารแนบท้ายบันทึกข้อตกลง</b>
</P>
    <P class='t-14 tab4'>เอกสารแนบท้ายบันทึกข้อตกลงดังต่อไปนี้ให้ถือเป็นส่วนหนึ่งของบันทึกข้อตกลงนี้
</P>
{htmlDocAtt}
 <P class='t-14 tab4'>ความใดในเอกสารแนบท้ายบันทึกข้อตกลงที่ขัดแย้งกับข้อความในบันทึกข้อตกลงนี้ให้
...
ทั้งนี้ ผู้รับจ้างไม่มีสิทธิเรียกร้องค่าเสียหายหรือค่าใช้จ่ายใดๆ ทั้งสิ้น
    ...
    <P class='t-14 tab3'><B>ข้อ ๓. ค่าจ้างและการจ่ายเงิน 
</B></P>
    <p class='t-14 tab4'>ผู้ว่าจ้างตกลงจ่ายและผู้รับจ้างตกลงรับเงินค่าจ้างจำนวนเงิน  {dataResult.HiringAmount} บาท( {CommonDAO.NumberToThaiText(dataResult.HiringAmount ?? 0)} )
...
ซึ่งมีรายละเอียดของงานปรากฏตามเอกสารแนบท้ายบันทึกข้อตกลง และผู้ว่าจ้างได้ตรวจรับงานจ้างไว้โดยครบถ้วนแล้ว</p>
   <P class='t-14 tab4'>ทั้งนี้ หากเดือนใดมีการปฏิบัติงานไม่เต็มเดือนปฏิทิน ให้คิดค่าจ้างเหมาเป็นรายวัน ในอัตราวันละ {dataResult.DailyRate} บาท  ( {CommonDAO.NumberToThaiText(dataResult.DailyRate ?? 0)} ) </P>
    <P class='t-14 tab4'>การจ่ายเงินตามเงื่อนไขแห่งสัญญานี้ ผู้ว่าจ้างจะโอนเงินเข้าบัญชีเงินฝากธนาคาร ของผู้รับจ้าง 
...
รวมทั้งค่าใช้จ่ายอื่นใด (ถ้ามี) ที่ธนาคารเรียกเก็บ และยินยอมให้มีการหักเงินดังกล่าวจากจำนวนเงินโอนในงวด</P>
  ...
  <P class='t-14 tab3'><b>ข้อ ๔.กำหนดเวลาแล้วเสร็จและสิทธิของผู้ว่าจ้างในการบอกเลิกบันทึกข้อตกลง</b></P>
    <p class='t-14 tab4'>ผู้รับจ้างต้องเริ่มทำงานที่รับจ้างภายในวันที่  {dataResult.WorkStartDate.Value.ToString("dd/MM/yyyy")} และจะต้องทำงานให้แล้วเสร็จบริบูรณ์ภายในวันที่ {dataResult.WorkEndDate.Value.ToString("dd/MM/yyyy")}
...
ผู้ว่าจ้างที่จะเรียกร้องค่าเสียหายจากผู้รับจ้าง</p>
    <p class='t-14 tab4'>การที่ผู้ว่าจ้างไม่ใช้สิทธิบอกเลิกบันทึกข้อตกลงดังกล่าวข้างต้นนั้น
ไม่เป็นเหตุให้ผู้รับจ้างพ้นจากความรับผิดตามบันทึกข้อตกลง</p>

<P class='t-14 tab3'><b>ข้อ ๕.การจ้างช่วง</b></P>
    <P class='t-14 tab4'>ผู้รับจ้างจะต้องไม่เอางานทั้งหมดหรือแต่บางส่วนของบันทึกข้อตกลงนี้ไปให้ผู้อื่นรับจ้างช่วงอีกทอดหนึ่ง
...
<P class='t-14 tab4'>กรณีผู้รับจ้างไปจ้างช่วงงานแต่บางส่วนโดยฝ่าฝืนความในวรรคหนึ่งผู้รับจ้างต้องชำระค่าปรับให้แก่ผู้ว่าจ้างเป็น 
...
<P class='t-14 tab3'><b>ข้อ ๖.ความรับผิดของผู้รับจ้าง</b></P>
<P class='t-14 tab4'>ผู้รับจ้างจะต้องรับผิดต่ออุบัติเหตุ ความเสียหาย หรือภยันตรายใดๆ อันเกิดจากการปฏิบัติงานของผู้รับจ้าง
และจะต้องรับผิดต่อความเสียหายจากการกระทำของลูกจ้างหรือตัวแทนของผู้รับจ้าง และจากการปฏิบัติงานของผู้รับจ้างช่วงด้วย (ถ้ามี)</P>
 <P class='t-14 tab4'>ความเสียหายใดๆ อันเกิดแก่งานที่ผู้รับจ้างได้ทำขึ้น แม้จะเกิดขึ้นเพราะเหตุสุดวิสัยก็ตาม 
...
<P class='t-14 tab4'>ผู้รับจ้างจะต้องรับผิดต่อบุคคลภายนอกในความเสียหายใดๆ อันเกิดจากการปฏิบัติงานของผู้รับจ้าง หรือลูกจ้าง 
...
โดยค่าใช้จ่ายของผู้รับจ้างเอง รวมทั้งผู้รับจ้างจะต้องชดใช้ค่าเสียหายนั้นๆ ตลอดจนค่าใช้จ่ายใดๆ อันเกิดจากการถูกเรียกร้อง หรือถูกฟ้องร้องให้แก่ผู้ว่าจ้างทันที
  ...
  <P class='t-14 tab3'><b>ข้อ ๗.	การตรวจรับงานจ้าง</b></P>
    <P class='t-14 tab4'> เมื่อผู้ว่าจ้างได้ตรวจรับงานจ้างที่ส่งมอบและเห็นว่าถูกต้องครบถ้วนตามบันทึกข้อตกลงแล้ว
ผู้ว่าจ้างจะออกหลักฐานการรับมอบเป็นหนังสือไว้ให้เพื่อผู้รับจ้างนำมาเป็นหลักฐานประกอบการขอรับเงินค่างานจ้างนั้น</P>
  <P class='t-14 tab4'>ถ้าผลของการตรวจรับงานจ้างปรากฏว่างานจ้างที่ผู้รับจ้างส่งมอบไม่ตรงตามบันทึกข้อตกลงผู้ว่าจ้างทรง 
...
และระยะเวลาที่เสียไปเพราะเหตุดังกล่าวผู้รับจ้างจะนำมาอ้างเป็นเหตุขอขยายเวลาส่งมอบงานจ้างตามบันทึกข้อตกลงหรือของด หรือลดค่าปรับไม่ได้</P>
   ...
   <P class='t-14 tab3'><b>ข้อ ๘.	รายละเอียดของงานจ้างคลาดเคลื่อน</b></P>
    <P class='t-14 tab4'>ผู้รับจ้างรับรองว่าได้ตรวจสอบและทำความเข้าใจในรายละเอียดของงานจ้างโดยถี่ถ้วนแล้ว 
...
โดยผู้รับจ้างจะคิดค่าจ้าง ค่าเสียหาย หรือค่าใช้จ่ายใดๆ เพิ่มขึ้นจากผู้ว่าจ้าง หรือขอขยายอายุบันทึกข้อตกลงไม่ได้</P>
  ...
  <P class='t-14 tab3'><b>ข้อ ๙.	ค่าปรับ</b></P>
    <P class='t-14 tab4'>หากผู้รับจ้างไม่สามารถทำงานให้แล้วเสร็จภายในเวลาที่กำหนดไว้ในบันทึกข้อตกลง
...
อันเกิดขึ้นจากการที่ผู้รับจ้างทำงานล่าช้าเฉพาะส่วนที่เกินกว่าจำนวนค่าปรับดังกล่าวได้อีกด้วย</P>
     <P class='t-14 tab4'>ในระหว่างที่ผู้ว่าจ้างยังมิได้บอกเลิกบันทึกข้อตกลงนั้น หากผู้ว่าจ้างเห็นว่าผู้รับจ้างจะไม่สามารถ 
...
<P class='t-14 tab3'><b>ข้อ ๑๐.สิทธิของผู้ว่าจ้างภายหลังบอกเลิกบันทึกข้อตกลง
</b></P>
    <P class='t-14 tab4'>ในกรณีที่ผู้ว่าจ้างบอกเลิกบันทึกข้อตกลง ผู้ว่าจ้างอาจทำงานนั้นเองหรือว่าจ้างผู้อื่นให้ทำงานนั้นต่อจน  
...
ให้แล้วเสร็จตามบันทึกข้อตกลง และผู้ว่าจ้างจะหักเอาจากจำนวนเงินใดๆ ที่จะจ่ายให้แก่ผู้รับจ้างก็ได้</P>
      ...
      <P class='t-14 tab3'><b>ข้อ ๑๑. อื่นๆ </b></P>
     <P class='t-14 tab4'>การจ้างเหมาบริการตามบันทึกข้อตกลงนี้ ไม่ทำให้ผู้รับจ้างมีฐานะเป็นลูกจ้างของผู้ว่าจ้างหรือมีความสัมพันธ์ 
ในฐานะเป็นลูกจ้างตามกฎหมายแรงงาน หรือกฎหมายว่าด้วยประกันสังคม
</P>
    <P class='t-14 tab4'>บันทึกข้อตกลงนี้ทำขึ้นเป็นบันทึกข้อตกลงอิเล็กทรอนิกส์ คู่ตกลงได้อ่าน เข้าใจเงื่อนไข และยอมรับเงื่อนไข และได้ยืนยันว่าเป็นผู้มีอำนาจลงนามในบันทึกข้อตกลง จึงได้ลงลายมืออิเล็กทรอนิกส์พร้อมทั้งประทับตรา (ถ้ามี) ในบันทึกข้อตกลงไว้ และต่างฝ่ายต่างยึดถือไว้ฝ่ายละหนึ่งฉบับในระบบของตน </P>
