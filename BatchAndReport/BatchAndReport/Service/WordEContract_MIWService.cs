...
จำนวนเงินในอัตราร้อยละ ๑๐ (สิบ) ของวงเงินของงานที่จ้างช่วงตามบันทึกข้อตกลง ทั้งนี้ ไม่ตัดสิทธิผู้ว่าจ้างในการบอกเลิก บันทึกข้อตกลง</P>
...
วันละ {CommonDAO.ConvertCurrencyToThaiNumerals(dataResult.DailyFineRate??0)} บาท ( {CommonDAO.NumberToThaiText(dataResult.DailyFineRate ?? 0)} ) นับถัดจากวันที่ครบกำหนดเวลาแล้วเสร็จของงานตามบันทึกข้อตกลง 
