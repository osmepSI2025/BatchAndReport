...
<body>
    ...
    <div class='t-16 text-center'><B>สัญญารับเงินอุดหนุน</B></div>
    <div class='t-16 text-center'><B>เพื่อสนับสนุนและยกระดับศักยภาพผู้ประกอบการวิสาหกิจขนาดกลางและขนาดย่อม</B></div>
    <div class='t-16 text-center'><B>ผ่านระบบผู้ให้บริการทางธุรกิจ ปี {DateTime.Now.Year}</B></div>
</br>
    <div class=' t-14 text-right'>ทะเบียนผู้รับเงินอุดหนุนเลขที่ {result.TaxID}</div>
    <div class=' t-14 text-right'>เลขที่สัญญา {result.Contract_Number}</div>
</br>
    <p class='t-14 tab3'>สัญญาฉบับนี้ทำขึ้น ณ {result.SignAddress} เมื่อ {signDate} ระหว่าง</P>
    <p class='t-14 tab3'><B>สำนักงานส่งเสริมวิสาหกิจขนาดกลางและขนาดย่อม</B> โดย {result.SignatoryName} ผู้มีอำนาจกระทำการแทนสำนักงานฯ ซึ่งต่อไปในสัญญานี้เรียกว่า “ผู้ให้เงินอุดหนุน” ฝ่ายหนึ่ง กับ</P>
    <p class='t-14 tab3'><B>ผู้ประกอบการวิสาหกิจขนาดกลางและขนาดย่อม</B> ราย {result.RegType} ซึ่งจดทะเบียนเป็น {result.RegType} เลขประจำตัวผู้เสียภาษี {result.TaxID} 
    ...
    <p class='t-14 tab3'>ทั้งสองฝ่ายได้ตกลงทำสัญญากัน มีข้อความดังต่อไปนี้</P>
    <p class='t-14 tab3'>ข้อ 1 ผู้ให้เงินอุดหนุนตกลงให้เงินอุดหนุนและผู้รับเงินอุดหนุนตกลงรับเงินอุดหนุน  
จำนวน {result.GrantAmount?.ToString("N2") ?? "0.00"} บาท ({stringGrantAmount})
ตั้งแต่ {stringGrantStartDate} ถึงวันที่ {stringGrantEndDate}
โดยให้ผู้รับการอุดหนุนเข้ารับการพัฒนา เพื่อใช้จ่ายในการ {result.SpendingPurpose}
...
สัญญาฉบับนี้
    ...
    <p class='t-14 tab3'>ข้อ ๒ ผู้รับเงินอุดหนุนจะต้องสำรองเงินจ่ายไปก่อน แล้วจึงนำต้นฉบับใบเสร็จรับเงินมาเบิก
...
<p class='t-14 tab3'>ในการให้ความช่วยเหลือ อุดหนุน วิสาหกิจขนาดกลางและขนาดย่อม ผ่านผู้ให้บริการทาง
...
<p class='t-14 tab3'>ข้อ ๓ เมื่อผู้รับเงินอุดหนุนดำเนินกิจกรรมเข้ารับการพัฒนาเสร็จสมบูรณ์แล้วตามแผนการ
...
ฉบับนี้ ภายใน ๓๐ (สามสิบ) วันทำการ นับจากวันที่สิ้นสุดสัญญา</P>
    <p class='t-14 tab3'>ข้อ ๔ ผู้รับเงินอุดหนุนยินยอมรับผิดชอบค่าใช้จ่ายส่วนเกินจากการสนับสนุนตามการให้ความ ช่วยเหลือในโครงการนี้ที่ได้กำหนดไว้ รวมทั้งรับผิดชอบภาษีมูลค่าเพิ่ม และภาษีอื่น ๆ (ถ้ามี) ที่เกิดจาก ค่าใช้จ่ายที่ขอรับการอุดหนุน</P>
    <p class='t-14 tab3'>ข้อ ๕ เงินที่ผู้รับเงินอุดหนุนได้รับจากโครงการนี้ เป็นเงินที่รวมภาษี และค่าธรรมเนียมต่างๆ ไว้ทั้งหมดแล้ว และถือเป็นรายได้ของวิสาหกิจขนาดกลางและขนาดย่อม ซึ่งจะต้องถูกหักภาษี ณ ที่จ่าย และ ต้องเสียภาษีตามที่กฎหมายกำหนด และหากวิสาหกิจขนาดกลางและขนาดย่อมเป็นผู้ซึ่งจดทะเบียน ภาษีมูลค่าเพิ่ม จะต้องมีการแสดงรายการคำนวณภาษีมูลค่าเพิ่มไว้ให้ชัดเจนปรากฏไว้ในใบสำคัญการรับเงิน หรือใบเสร็จรับเงิน หรือใบกำกับภาษี ที่ยื่นให้ผู้ให้เงินอุดหนุน โดยวิสาหกิจขนาดกลางและขนาดย่อมมีหน้าที่ จะต้องนำเงินที่ได้รับดังกล่าว ไปประกอบการคำนวณรายได้เพื่อเสียภาษีเงินได้ในปีที่เกิดรายได้ด้วย </P>
    <p class='t-14 tab3'>ข้อ ๖ กรณีการโอนเงินให้แก่ผู้รับเงินอุดหนุน ผู้ให้เงินอุดหนุนจะใช้วิธีการโอนเงินผ่านระบบ อิเล็กทรอนิกส์ และหากมีค่าธรรมเนียมการโอนเงิน ผู้รับเงินอุดหนุนจะเป็นผู้รับผิดชอบค่าธรรมเนียมในการ โอนเงินดังกล่าว</P>
    <p class='t-14 tab3'>ข้อ ๗ ผู้รับเงินอุดหนุนจะเปลี่ยนแปลงข้อเสนอการพัฒนาและวงเงินอุดหนุนตามที่ได้รับ
...
ก่อนวันสิ้นสุด สัญญาไม่น้อยกว่า ๓๐ (สามสิบ) วันทำการ</P>
    <p class='t-14 tab3'>ข้อ ๘ ผู้รับเงินอุดหนุนจะต้องใช้จ่ายเงินอุดหนุนเพื่อดำเนินการตามข้อเสนอการพัฒนา ซึ่งได้รับการอนุมัติ ให้เป็นไปตามวัตถุประสงค์และกิจกรรมตามข้อเสนอการพัฒนาเท่านั้น โดยผู้รับเงินอุดหนุน ตกลงยินยอมให้ผู้ให้เงินอุดหนุนตรวจสอบผลการปฏิบัติงาน และการใช้จ่ายเงินอุดหนุนที่ได้รับ และผู้รับเงิน อุดหนุนมีหน้าที่ต้องรายงานผลการปฏิบัติงานและการใช้จ่ายเงินอุดหนุนที่รับตามแบบและภายในเวลาที่ กำหนด </P>

    <p class='t-14 tab3'>ข้อ ๙ กรณีที่มีการตรวจพบในภายหลังว่าผู้รับเงินอุดหนุนขาดคุณสมบัติในการรับเงินอุดหนุน 
...
ร้อยละ 5 (ห้า) ต่อปี นับแต่วันที่ได้รับเงินอุดหนุนจนกว่าจะชดใช้เงินคืนจนครบถ้วนเสร็จสิ้น </P>
    ...
    <p class='t-14 tab3'>ข้อ ๑๐ ในกรณีผู้รับเงินอุดหนุนไม่ปฏิบัติตามสัญญาข้อหนึ่งข้อใด ผู้ให้เงินอุดหนุนจะมีหนัง
...
ได้ทันที โดย มีหนังสือบอกเลิกสัญญาแจ้งให้ผู้รับเงินอุดหนุนทราบ</P>
    <p class='t-14 tab3'>ข้อ ๑๑ ในกรณีที่มีการบอกเลิกสัญญาตามข้อ ๑๐ ผู้รับเงินอุดหนุนจะต้องชดใช้เงินอุดหนุน
...
อุดหนุน ผู้ให้เงิน อุดหนุนมีสิทธิที่จะเรียกค่าเสียหายจากผู้รับเงินอุดหนุนอีกด้วย</P>
    <p class='t-14 tab3'>ข้อ ๑๒ ผู้รับเงินอุดหนุนต้องปฏิบัติตามเงื่อนไขที่กำหนดไว้ในระเบียบและประกาศแนบท้าย สัญญานี้</P>

    <p class='t-14 tab3'>ข้อ ๑๓ ที่อยู่ของผู้รับเงินอุดหนุนที่ปรากฏในสัญญานี้ ให้ถือว่าเป็นภูมิลำเนาของผู้รับเงิน
...
รับเงินอุดหนุนจะ ได้รับหนังสือ คำบอกกล่าวทวงถาม จดหมาย หรือเอกสารนั้นไว้หรือไม่ก็ตาม</P>
    <p class='t-14 tab3'>ถ้าผู้รับเงินอุดหนุนเปลี่ยนแปลงสถานที่อยู่ หรือไปรษณีย์อิเล็กทรอนิกส์ (E-mail) ผู้รับเงิน
...
ปรากฏในสัญญานี้ ให้ถือว่าผู้รับเงินอุดหนุนได้ทราบข้อความในเอกสารดังกล่าวโดยชอบตามวรรคหนึ่งแล้ว</P>
    <p class='t-14 tab3'>สัญญานี้ทำขึ้นเป็นสัญญาอิเล็กทรอนิกส์ คู่สัญญาได้อ่าน เข้าใจเงื่อนไข และยอมรับเงื่อนไข และได้ยืนยันว่าเป็นผู้มีอำนาจลงนามในสัญญาจึงได้ลงลายมืออิเล็กทรอนิกส์พร้อมทั้งประทับตรา (ถ้ามี) ในสัญญาไว้ และต่างฝ่ายต่างยึดถือไว้ฝ่ายละหนึ่งฉบับในระบบของตน</P>

</br>
</br>
<div class='t-14'>
{signatoryTableHtml}
    <P class='t-14 tab3'>ข้าพเจ้าขอรับรองว่า ทั้งสองฝ่ายได้ลงนามในสัญญาโดยวิธีการอิเล็กทรอนิกส์ เพื่อแสดงเจตนาของคู่สัญญาแล้ว ข้าพเจ้าจึงได้ลงลายมือชื่ออิเล็กทรอนิกส์รับรองเป็นพยานในสัญญาพร้อมนี้
</P>
