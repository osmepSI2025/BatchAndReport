...
เลขประจำตัวผู้เสียภาษี {CommonDAO.ConvertStringArabicToThaiNumerals(result.TaxID)} 
        ...
        ไปรษณีย์อิเล็กทรอนิกส์(E-mail) {CommonDAO.ConvertStringArabicToThaiNumerals(result.RegEmail)} โดย {CommonDAO.ConvertStringArabicToThaiNumerals(result.Contract_Number)} บัตรประจำตัวประชาชนเลขที่ {CommonDAO.ConvertStringArabicToThaiNumerals(result.RegIdenID)}
