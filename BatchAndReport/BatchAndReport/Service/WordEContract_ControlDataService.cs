...
public class WordEContract_ControlDataService
{
    ...
    public byte[] OnGetWordContact_ControlDataService()
    {
        ...
        using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            body.AppendChild(WordServiceSetting.CenteredBoldParagraph("..........…(ระบุชื่อคู่สัญญา)….............", "36"));


            // --- 3. Main contract body ---

            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("ข้อตกลงการเป็นผู้ควบคุมข้อมูลส่วนบุคคลร่วม (“ข้อตกลง”) ฉบับนี้ ทำขึ้นเมื่อวันที่ (ระบุวันที่ลงนาม) ณ สำนักงานส่งเสริมวิสาหกิจขนาดกลางและขนาดย่อม", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("โดยที่ สำนักงานส่งเสริมวิสาหกิจขนาดกลางและขนาดย่อม ซึ่งต่อไปในข้อตกลงฉบับนี้เรียกว่า “สสว.” ฝ่ายหนึ่ง ได้ตกลงใน (ระบุชื่อบันทึกข้อตกลงความร่วมมือ/สัญญา) ฉบับลงวันที่  (ระบุวันที่ลงนาม) ซึ่งต่อไปในข้อตกลงฉบับนี้เรียกว่า “สัญญาหลัก” กับ  (ชื่อคู่สัญญา)  ซึ่งต่อไปในข้อตกลงฉบับนี้เรียกว่า “(ชื่อเรียกคู่สัญญา)” อีกฝ่ายหนึ่ง รวมทั้งสองฝ่ายว่า “คู่สัญญา”", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("1. เพื่อ......................................................................................................", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("2. เพื่อ......................................................................................................", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("3. เพื่อ......................................................................................................", null, "32"));
        ...
        new TableRow(
          new TableCell(
            ...
            WordServiceSetting.CenteredParagraph(
              "(ระบุรายการ “กิจกรรม” การประมวลผลข้อมูลส่วนบุคคลที่ สสว. ดำเนินการภายใต้ขอบเขตของสัญญาหลัก เช่นการเก็บข้อมูลจากเอกสารลงทะเบียน, การยืนยันตัวตน เป็นต้น", "32")
          ),
          new TableCell(
            new TableCellProperties(new TableCellWidth { Type = TableWidthUnitValues.Dxa, Width = "3000" }),
            WordServiceSetting.CenteredParagraph(
              "(ระบุ “ฐานกฎหมาย” การประมวลผลข้อมูลส่วนบุคคลที่ สสว. ดำเนินการตามรายการกิจกรรม เช่น การยืนยันตัวตนของผู้ประกอบการผ่านทาง SMS ใช้ฐานสัญญาในการประมวลผลข้อมูลส่วนบุคคล)", "32")
          ),
          new TableCell(
            new TableCellProperties(new TableCellWidth { Type = TableWidthUnitValues.Dxa, Width = "3000" }),
            WordServiceSetting.CenteredParagraph(
              "(ระบุรายการข้อมูลส่วนบุคคลที่ สสว. ใช้เพื่อประมวลผลตามกิจกรรมที่ระบุ เช่น ชื่อ นามสกุล วันเกิด เบอร์โทรศัพท์ ไปรษณีย์อิเล็กทรอนิกส์ เป็นต้น", "32")
          )
        )
      );
            body.AppendChild(tableActivitySME);
            body.AppendChild(WordServiceSetting.EmptyParagraph());
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("(2) กิจกรรมการประมวลผลข้อมูลส่วนบุคคลย่อยซึ่งดำเนินการโดย (ชื่อคู่สัญญา)", null, "32", true));
        ...
        new TableRow(
          new TableCell(
            new TableCellProperties(new TableCellWidth { Type = TableWidthUnitValues.Dxa, Width = "3000" }),
            WordServiceSetting.CenteredParagraph(
              "(ระบุรายการ “กิจกรรม” การประมวลผลข้อมูลส่วนบุคคลที่คู่สัญญาอีกฝ่าย ดำเนินการภายใต้ขอบเขตของสัญญาหลัก เช่น การเก็บข้อมูลจากเอกสารลงทะเบียน, การเชื่อมโยงข้อมูล, การยืนยันตัวตน เป็นต้น)", "32")
          ),
          new TableCell(
            new TableCellProperties(new TableCellWidth { Type = TableWidthUnitValues.Dxa, Width = "3000" }),
            WordServiceSetting.CenteredParagraph(
              "(ระบุ “ฐานกฎหมาย” การประมวลผลข้อมูลส่วนบุคคลที่ คู่สัญญาอีกฝ่ายดำเนินการตามรายการกิจกรรม เช่น การยืนยันตัวตนของผู้ประกอบการผ่านทาง SMS ใช้ฐานสัญญาในการประมวลผลข้อมูลส่วนบุคคล)", "32")
          ),
          new TableCell(
            new TableCellProperties(new TableCellWidth { Type = TableWidthUnitValues.Dxa, Width = "3000" }),
            WordServiceSetting.CenteredParagraph(
              "(ระบุรายการข้อมูลส่วนบุคคลที่คู่สัญญาอีกฝ่ายใช้เพื่อประมวลผลตามกิจกรรมที่ระบุ เช่น ชื่อ นามสกุล วันเกิด เบอร์โทรศัพท์ ไปรษณีย์อิเล็กทรอนิกส์ เป็นต้น)", "32")
          )
        )
      );
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("2.1 คู่สัญญารับรองว่าจะควบคุมดูแลให้เจ้าหน้าที่ พนักงาน และ/หรือลูกจ้าง ตัวแทนหรือบุคคลใด ๆ ที่ปฏิบัติหน้าที่ในการประมวลผลข้อมูลส่วนบุคคลภายใต้ข้อตกลงฉบับนี้รักษาความลับและปฏิบัติตามกฎหมายคุ้มครองข้อมูลส่วนบุคคลอย่างเคร่งครัด และดำเนินการประมวลผลข้อมูลส่วนบุคคลเพื่อวัตถุประสงค์ตามข้อตกลงฉบับนี้เท่านั้น โดยจะไม่ทำซ้ำ คัดลอก ทำสำเนา บันทึกภาพข้อมูลส่วนบุคคลไม่ว่าทั้งหมดหรือแต่บางส่วนเป็นอันขาด เว้นแต่ เป็นไปตามเงื่อนไขของสัญญาหลัก หรือกฎหมายที่เกี่ยวข้องจะระบุหรือบัญญัติไว้เป็นประการอื่น", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("2.4 คู่สัญญาแต่ละฝ่ายมีหน้าที่ต้องแจ้งรายละเอียดของการประมวลผลข้อมูลส่วนบุคคลแก่เจ้าของข้อมูลส่วนบุคคลซึ่งถูกประมวลผลข้อมูลก่อนหรือขณะเก็บรวบรวมข้อมูลส่วนบุคคล ทั้งนี้รายการรายละเอียดที่ต้องแจ้งให้เป็นไปตามที่กำหนดในมาตรา 23 แห่งพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562", null, "32"));
            ...
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ผู้แทน :...(ระบุชื่อ-นามสกุลผู้แทน)....", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ติดต่อได้ที่ :......(ระบุช่องทางติดต่อผู้แทน)......", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("เจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล : (ระบุชื่อ-นามสกุลเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล)", null, "32"));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ติดต่อได้ที่ :..(ระบุช่องทางติดต่อเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล)...", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_2Tabs("(2)...…(ชื่อคู่สัญญา)…......", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ติดต่อได้ที่ : (ระบุช่องทางติดต่อผู้แทน).....", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("เจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล (ถ้ามี) :..(ระบุชื่อ-นามสกุลเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล)...", null, "32", true));
            body.AppendChild(WordServiceSetting.NormalParagraphWith_3Tabs("ติดต่อได้ที่ :...(ระบุช่องทางติดต่อเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล)....", null, "32", true));
            ...
            var signatureTable = new Table(
                ...
                new TableRow(
                    ...
                    new TableCell(
                        new TableCellProperties(new TableCellWidth { Type = TableWidthUnitValues.Pct, Width = "50" }),
                        WordServiceSetting.CenteredBoldColoredParagraph("(ระบุชื่อคู่สัญญา)", "#ff0000")
                    )
                )
            );
