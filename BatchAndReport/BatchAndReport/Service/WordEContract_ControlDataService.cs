...
<div class='tab3 t-16'>วัตถุประสงค์</div>
{(purplist != null && purplist.Count > 0
    ? string.Join("", purplist.Select(p => $"<div class='tab4 t-16'>{p.Objective_Description}</div>"))
    : "<div class='tab3 t-16'>- ไม่มีข้อมูลวัตถุประสงค์ -</div>")}
