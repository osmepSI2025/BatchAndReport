...
</br>ปวงที่เป็นของผู้ให้ข้อมูล รวมถึงที่อยู่ในความครอบครองหรือควบคุมดูแลของผู้ให้ข้อมูล และไม่เป็นที่รับรู้ของ
</br>สาธารณชนโดยทั่วไปไม่ว่าจะในรูปแบบที่จับต้องได้หรือไม่ก็ตาม หรือสื่อแบบใดไม่ว่าจะถูกดัดแปลงแก้ไขโดย
</br>ผู้รับข้อมูลหรือไม่ และไม่ว่าจะเปิดเผยเมื่อใดและอย่างไร ให้ถือว่าเป็นความลับโดยข้อมูลที่เป็นความลับอาจ
</br>หมายความรวมถึง ข้อมูลเชิงกลยุทธ์ของผู้ให้ข้อมูล แผนธุรกิจ ข้อมูลทางการเงิน ข้อมูลลูกจ้าง ข้อมูลผู้
</br>ประกอบการ และข้อมูลส่วนบุคคลที่ผู้ให้ข้อมูลได้เก็บ รวบรวม ใช้ ข้อมูลที่เป็นความลับที่ผู้ให้ข้อมูล หรือในนามของผู้ให้ข้อมูลที่เปิดเผยแก่ผู้รับข้อมูล ซึ่งหมายความรวมถึงข้อมูลที่ผู้ให้ข้อมูลให้แก่ผู้รับข้อมูล ดังนี้
    </p>
...
</br>ถ้วนและอย่างเคร่งครัด ผู้รับข้อมูลจะต้องไม่เปิดเผยทำสำเนาหรือทำการอื่นใดทำนองเดียวกันแก่บุคคลอื่น
</br>ไม่ว่าทั้งหมดหรือบางส่วน เว้นแต่ได้รับอนุญาตเป็นหนังสือจากผู้ให้ข้อมูล</p>

   <p class='tab3 t-16'>๓.๒ ผู้รับข้อมูลต้องใช้ข้อมูลที่เป็นความลับเพื่อการอันเกี่ยวกับหรือสัมพันธ์กับการดำเนินงาน
</br>ที่มีอยู่ระหว่างผู้ให้ข้อมูลกับผู้รับข้อมูล โดยผู้รับข้อมูลต้องแจ้งให้ผู้ให้ข้อมูลทราบโดยทันทีที่พบการใช้หรือ
</br>การเปิดเผยข้อมูลที่เป็นความลับโดยไม่ได้รับอนุญาตหรือการละเมิดหรือฝ่าฝืนข้อกำหนดตามสัญญานี้ อีกทั้ง
</br>ผู้รับข้อมูลจะต้องให้ความร่วมมือกับผู้ให้ข้อมูลอย่างเต็มที่ในการเรียกคืนซึ่งการครอบครองข้อมูลที่เป็นความ
</br>ลับการป้องกันการใช้ข้อมูลที่เป็นความลับโดยไม่ได้รับอนุญาตและการระงับยับยั้งการเผยแพร่ข้อมูลที่เป็น
</br>ความลับออกสู่สาธารณะ</p>
   <p class='tab3 t-16'>๓.๓ ผู้รับข้อมูลต้องจัดให้มีและคงไว้ซึ่งมาตรการรักษาความปลอดภัยสำหรับการจัดเก็บและ
</br>ประมวลผลข้อมูลที่มีความเหมาะสมในมาตรการเชิงองค์กร มาตรการเชิงเทคนิค และมาตรการเชิงกายภาพ
</br>โดยคำนึงถึงลักษณะ ขอบเขต และวัตถุประสงค์ของการดำเนินการตามวัตถุประสงค์ที่ของสัญญาฉบับนี้เป็น
</br>สำคัญ เพื่อป้องกันมิให้ข้อมูลที่เป็นความลับถูกนำไปใช้โดยมิได้รับอนุญาตหรือถูกเปิดเผยแก่บุคคลอื่น โดย
</br>ผู้รับข้อมูลต้องใช้มาตรการการเก็บรักษาข้อมูลที่เป็นความลับในระดับเดียวกันกับที่ผู้รับข้อมูลใช้กับข้อมูลที่
</br>เป็นความลับของตนเองซึ่งต้องไม่น้อยกว่าการดูแลที่สมควร</p>
   <p class='tab3 t-16'>๓.๔ ผู้รับข้อมูลต้องแจ้งให้บุคลากร พนักงาน ลูกจ้าง ที่ปรึกษาของผู้รับข้อมูลและ/หรือบุคคล
</br>ภายนอกที่ต้องเกี่ยวข้องกับข้อมูลที่เป็นความลับนั้น ทราบถึงความเป็นความลับและข้อจำกัดสิทธิในการใช้
</br>และการเปิดเผยข้อมูลที่เป็นความลับ และผู้รับข้อมูลต้องดำเนินการให้บุคคลดังกล่าวต้องผูกพันด้วยสัญญา
</br>หรือข้อตกลงเป็นหนังสือในการรักษาข้อมูลที่เป็นความลับ โดยมีข้อกำหนดเช่นเดียวกับหรือไม่น้อยกว่า
</br>ข้อกำหนดและเงื่อนไขในสัญญาฉบับนี้ด้วย</p>
...
</br>สือแจ้งผู้ให้ข้อมูลได้รับทราบถึงข้อกำหนดหรือคำสั่งดังกล่าว โดยแสดงเอกสารข้อกำหนด หมายศาลและ/
</br>หรือหมายค้นอย่างเป็นทางการต่อผู้ให้ข้อมูลก่อนที่จะดำเนินการเปิดเผยข้อมูลดังกล่าว และในการเปิดเผย
</br>ข้อมูลดังกล่าวผู้รับข้อมูลจะต้องดำเนินการตามขั้นตอนทางกฎหมายเพื่อขอให้คุ้มครองข้อมูลดังกล่าวไม่ให้
</br>ถูกเปิดเผยต่อสาธารณะด้วย</p>
   <p class='tab4 t-16'>(๕) ผู้รับข้อมูลได้รับความยินยอมเป็นลายลักษณ์อักษรให้เปิดเผยข้อมูลจากผู้ให้ข้อมูล
</br>ก่อนที่ผู้รับข้อมูลจะเปิด เผยข้อมูลนั้น</p>
   <p class='tab4 t-16'>(๖) ผู้รับข้อมูลได้รับข้อมูลที่เป็นความลับจากบุคคลที่สามที่ไม่อยู่ภายใต้ข้อกำหนดใน
</br>เรื่องการรักษาความลับ หรือข้อจำกัดในเรื่องสิทธิ</p>
   <p class='tab3 t-16'>๓.๖ ผู้รับข้อมูลต้องไม่ทำซ้ำข้อมูลที่เป็นความลับแม้เพียงส่วนหนึ่งส่วนใดหรือทั้งหมด
</br>เว้นแต่การทำซ้ำเพื่อการใช้ข้อมูลที่เป็นความลับให้บรรลุผลตามวัตถุประสงค์ที่กำหนดไว้ในสัญญานี้ และ
</br>ไม่ทำวิศวกรรมย้อนกลับ หรือถอดรหัสข้อมูลที่เป็นความลับ ต้นแบบ หรือสิ่งอื่นใดที่บรรจุข้อมูลที่เป็น
</br>ความลับ รวมทั้งไม่เคลื่อนย้าย พิมพ์ทับ หรือทำให้เสียรูปซึ่งสัญลักษณ์ที่แสดงเครื่องหมายสิทธิบัตร
</br>อนุสิทธิบัตร ลิขสิทธิ์ เครื่องหมายการค้า ตราสัญลักษณ์ และเครื่องหมายอื่นใดที่แสดงกรรมสิทธิ์ของ
</br>ต้นแบบหรือสำเนาของข้อมูลที่เป็นความลับที่ได้รับมาจากผู้ให้ข้อมูล</p>
...
</br> หรือโดยอ้อม) ให้แก่ผู้รับข้อมูลที่ได้รับความลับซึ่งสิทธิบัตร ลิขสิทธิ์ การออกแบบ เครื่องหมายการค้าตรา
</br>สัญลักษณ์ รูปประดิษฐ์อื่นใดชื่อทางการค้า ความลับทางการค้า ไม่ว่าจดทะเบียนไว้ตามกฎหมายหรือไม่ก็ตาม
</br>หรือ สิทธิอื่น ๆ ของผู้ให้ข้อมูล ซึ่งอาจปรากฏอยู่หรือนำมาทำซ้ำไว้ในเอกสารข้อมูลที่เป็นความลับทั้งนี้ ผู้รับ
</br>ข้อมูลหรือบุคคลอื่นใดที่เกี่ยวข้องกับผู้รับข้อมูลและเกี่ยวข้องกับข้อมูลที่เป็นความลับดังกล่าวจะไม่ยื่นขอรับ
</br>สิทธิและ/หรือขอจดทะเบียนเกี่ยวกับทรัพย์สินทางปัญญาใด ๆ ตลอดจนไม่นำไปใช้โดยไม่ได้รับการอนุญาต
</br>เป็นลายลักษณ์อักษรจากผู้ให้ข้อมูลเกี่ยวกับรายละเอียดข้อมูลที่เป็นความลับหรือส่วนหนึ่งส่วนใดของราย
</br>ละเอียดดังกล่าว</p>
...
</br>ข้อมูลจะต้องส่งมอบข้อมูลที่เป็นความลับและสำเนาของข้อมูลที่เป็นความลับที่ผู้รับข้อมูลได้รับไว้คืนให้แก่ผู้ให้
</br>ข้อมูล เว้นแต่ผู้ให้ข้อมูลเห็นว่าไม่ต้องนำส่งคืนแต่ต้องเลิกใช้ข้อมูลที่เป็นความลับ และทำการลบหรือทำลาย
</br>ข้อมูลที่เป็นความลับทั้งถูกจัดเก็บไว้ในคอมพิวเตอร์หรืออุปกรณ์อื่นใดที่ใช้จัดเก็บข้อมูล (ถ้ามี) หรือดำเนิน
</br>การอื่นตามที่ได้รับการแจ้งเป็นลายลักษณ์อักษรจากผู้ให้ข้อมูล</p>
...
</br>นอกที่ได้รับข้อมูลที่เป็นความลับจากผู้รับข้อมูลฝ่าฝืนข้อกำหนดตามสัญญานี้และก่อให้เกิดความเสียหายแก่ผู้
</br>ให้ข้อมูล และ/หรือบุคคลอื่นผู้รับข้อมูลจะต้องชดใช้ค่าเสียหายให้แก่ผู้ให้ข้อมูล และ/หรือบุคคลที่ได้รับความ
</br>เสียหายสำหรับความเสียหายเช่นว่านั้น ทั้งนี้ ผู้รับข้อมูลจะต้องแจ้งแก่ผู้ให้ข้อมูลทราบเป็นลายลักษณ์อักษร
</br>ภายใน ๗ วันนับตั้งแต่มีการละเมิดข้อมูลที่เป็นความลับเกิดขึ้น</p>

   <p class='tab4 t-16'>๖.๒ ผู้รับข้อมูลรับทราบว่าการเปิดเผยหรือการใช้ข้อมูลที่เป็นความลับโดยฝ่าฝืนข้อ
</br>กำหนดตามสัญญานี้จะก่อให้เกิดความเสียหายแก่ผู้ให้ข้อมูลในจำนวนที่ไม่สามารถประเมินได้ดังนั้นผู้รับ
</br>ข้อมูลยินยอมให้ผู้ให้ข้อมูลใช้สิทธิที่จะร้องขอต่อศาลเพื่อให้มีคำสั่งให้ผู้รับข้อมูลหยุดการกระทำใดๆที่เป็น
</br>การฝ่าฝืนข้อกำหนดตามสัญญานี้ และ/หรือใช้วิธีคุ้มครองชั่วคราวใดๆ ตามที่ผู้ให้ข้อมูลเห็นว่าเหมาะสม
</br>ได้โดยผู้รับข้อมูลจะเป็นผู้รับผิดชอบค่าใช้จ่ายต่าง ๆ ที่เกิดขึ้นทั้งหมดจากการดำเนินการดังกล่าว</p>
   <p class='tab3 t-16'>๖.๓ กรณีที่ผู้ให้ข้อมูลสงสัยว่าผู้รับข้อมูลฝ่าฝืนข้อกำหนดตามสัญญานี้ ผู้รับข้อมูลจะต้องเป็น
</br>ฝ่ายพิสูจน์ว่าผู้รับข้อมูลไม่ได้ฝ่าฝืนข้อกำหนดตามสัญญานี้</p>
...
</br>วันที่ทำสัญญาฉบับนี้</p>
   <p class='tab3 t-16'>เมื่อครบกำหนดระยะเวลาตามวรรคหนึ่ง หรือเมื่อมีการบอกเลิกสัญญา หรือผู้ให้ข้อมูล
</br>ได้แจ้งให้ผู้รับข้อมูลดำเนินการทำลายข้อมูลดังกล่าว ผู้รับข้อมูลจะต้องดำเนินการทำลายข้อมูล ภายใน ๗
</br>วันนับแต่ได้รับหนังสือร้องขอจากผู้ให้ข้อมูล ทั้งนี้ ผู้รับข้อมูลจะต้องไม่มีการสงวนไว้ซึ่งสำเนาใด ๆ</p>
...
</br>และลงนามโดยคู่สัญญาหรือผู้มีอำนาจลงนามผูกพันนิติบุคคลและประทับตราสำคัญของนิติบุคคล (ถ้ามี) ของคู่สัญญา แล้วแต่กรณี</p>
   <p class='tab3 t-16'>๘.๒ กรณีที่ผู้รับข้อมูลได้โอนกิจการ รวมกิจการ หรือควบกิจการ หรือดำเนินการอื่น ๆ ใน
</br>ลักษณะที่มีการเปลี่ยนแปลงของวัตถุประสงค์ในการดำเนินกิจการของผู้รับข้อมูลผู้รับข้อมูลจะต้องแจ้งให้ผู้ให้
</br>ข้อมูลทราบภายใน ๕ วันทำการ นับแต่ได้เกิดเหตุดังกล่าวขึ้น</p>

    <!-- Clause 9 -->
   <p class='tab3 t-16'>ข้อ ๙ การบังคับใช้</p>
   <p class='tab3 t-16'>๙.๑ ในกรณีที่ปรากฏภายหลังว่าส่วนใดส่วนหนึ่งในสัญญาฉบับนี้เป็นโมฆะให้ถือว่าข้อกำหนด
</br>ส่วนที่เป็นโมฆะไม่มีผลบังคับในสัญญานี้ และข้อกำหนดที่เหลืออยู่ในสัญญาฉบับนี้ยังคงใช้บังคับและมีผลอยู่
</br>อย่างสมบูรณ์</p>
   <p class='tab3 t-16'>๙.๒ สัญญาฉบับนี้อยู่ภายใต้การบังคับและตีความตามกฎหมายของประเทศไทย ให้ศาลของ
</br>ประเทศไทยมีอำนาจในกรณีที่มีข้อพิพาทใด ๆ อันเกิดขึ้นจากสัญญาฉบับนี้</p>
   <p class='tab3 t-16'>สัญญานี้ทำขึ้นเป็นสองฉบับ มีข้อความถูกต้องตรงกัน คู่สัญญาได้อ่าน และเข้าใจข้อความใน
</br>สัญญาโดยละเอียดตลอดแล้ว เห็นว่าตรงตามเจตนารมณ์ทุกประการ จึงได้ลงลายมือชื่อพร้อมทั้งประทับตรา
</br>สำคัญผูกพันนิติบุคคล (ถ้ามี) ไว้เป็นสำคัญ ณ วัน เดือน ปี ที่ระบุข้างต้น และคู่สัญญาต่างฝ่ายต่าง
