...
namespace BatchAndReport.Pages.Report
{
    ...
    new Paragraph(
        ...
        private static Paragraph NormalParagraphWith_2Tabs(string text, JustificationValues? align = null, string fontZise = "28", bool bold = false)
        {
            if (fontZise == null)
            {
                fontZise = "28";
        ...
        public IActionResult OnGetWordContactBorrowMoney()
        {
            ...
            using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
            {
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 1. วัตถุประสงค์และวงเงินกู้",null,"28",true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 2. การเบิกจ่ายเงินกู้", null, "28", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 3. ดอกเบี้ย", null, "28", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 4. การชำระคืนเงินต้นหรือชำระหนี้อื่นใด ให้แก่ผู้ให้กู้",null,"28",true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 5.การผิดสัญญา", null, "28", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 6. การเปิดเผยข้อมูล", null, "28", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 7. อื่นๆ", null, "28", true));
        ...
        public IActionResult OnGetWordContactToDoThing()
        {
            ...
            using (var wordDoc = WordprocessingDocument.Create(stream, DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
            {
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 1ข้อตกลงว่าจ้าง", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 2\tเอกสารอันเป็นส่วนหนึ่งของสัญญา", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 3\tหลักประกันการปฏิบัติตามสัญญา", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 4   ค่าจ้างและการจ่ายเงิน ", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("(14)ข้อ 5 เงินค่าจ้างล่วงหน้า", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 6   กำหนดเวลาแล้วเสร็จและสิทธิของผู้ว่าจ้างในการบอกเลิกสัญญา", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("(15)ข้อ 7 ความรับผิดชอบในความชำรุดบกพร่องของงานจ้าง", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 8\tการจ้างช่วง", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 9\tความรับผิดของผู้รับจ้าง", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 10\tการจ่ายเงินแก่ลูกจ้าง", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 11\tการตรวจรับงานจ้าง", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 12\tรายละเอียดของงานจ้างคลาดเคลื่อน", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 13\tค่าปรับ", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 14\tสิทธิของผู้ว่าจ้างภายหลังบอกเลิกสัญญา", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 15\tการบังคับค่าปรับ ค่าเสียหาย และค่าใช้จ่าย", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 16\tการงดหรือลดค่าปรับ หรือการขยายเวลาปฏิบัติงานตามสัญญา", null, "32", true));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("ข้อ 17\tการใช้เรือไทย", null, "32",true));
                ...
                //body.AppendChild(NormalParagraphWith_3Tabs("xx", null, "32"));
                //body.AppendChild(NormalParagraphWith_3Tabs("xx", null, "32"));
                //body.AppendChild(NormalParagraphWith_3Tabs("xx", null, "32"));
                //body.AppendChild(NormalParagraphWith_3Tabs("xx", null, "32"));
                //body.AppendChild(NormalParagraphWith_3Tabs("xx", null, "32"));
                ...
                body.AppendChild(NormalParagraphWith_2Tabs("xx", null, "32"));
                body.AppendChild(NormalParagraphWith_2Tabs("ข้าพเจ้า………………………………………………………………………………………………………………………………………….\r\nขอรับรองว่าสถานภาพการสมรสของข้าพเจ้าปัจจุบันมีสถานะ\r\n"));
                body.AppendChild(NormalParagraphWith_2Tabs("“ข้าพเจ้าขอรับรองว่าสถานภาพการสมรสที่แจ้งในหนังสือฉบับนี้เป็นความจริงทุกประการหากไม่เป็นความจริงแล้ว ความเสียหายใด ๆ ที่จะเกิดกับผู้ให้การอุดหนุน ข้าพเจ้ายินยอมรับผิดชดใช้ให้แก่ผู้ให้การอุดหนุนทั้งสิ้น”"));
                body.AppendChild(RightParagraph("ลงชื่อ.............................................................รับรอง"));
                body.AppendChild(RightParagraph("(............................................................)"));
                body.AppendChild(RightParagraph("ลงชื่อ....................................................พยาน"));
                body.AppendChild(RightParagraph("(............................................................)"));
